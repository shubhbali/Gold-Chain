...
function printUsage() {
    ...
    console.log("  GetFaucetStatus: get faucet status of Gilt testnet");
    ...
    console.log("               mainnet: https://rpc-mainnet.giltchain.com");
    console.log("               testnet: https://rpc-testnet.giltchain.com");
    ...
    console.log("\nExample:");
    console.log("  node getchainstatus.js GetMaxTxCountInBlockRange --rpc https://rpc-testnet.giltchain.com --startNum 40000001  --endNum 40000005");
    console.log("  node getchainstatus.js GetBinaryVersion --rpc https://rpc-testnet.giltchain.com --num 21 --turnLength 8");
    console.log("  node getchainstatus.js GetTopAddr --rpc https://rpc-testnet.giltchain.com --startNum 40000001  --endNum 40000010 --topNum 10");
    console.log("  node getchainstatus.js GetSlashCount --rpc https://rpc-testnet.giltchain.com --blockNum 40000001 --stepNum 1 --stepLength 115200"); // default: latest block
    console.log("  node getchainstatus.js GetPerformanceData --rpc https://rpc-testnet.giltchain.com --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetBlobTxs --rpc https://rpc-testnet.giltchain.com --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetFaucetStatus --rpc https://rpc-testnet.giltchain.com --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetKeyParameters --rpc https://rpc-testnet.giltchain.com"); // default: latest block
    console.log("  node getchainstatus.js GetEip7623 --rpc https://rpc-testnet.giltchain.com --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetMevStatus --rpc https://rpc-testnet.giltchain.com --startNum 40000001  --endNum 40000010");
    console.log("  node getchainstatus.js GetLargeTxs --rpc https://rpc-testnet.giltchain.com --startNum 40000001  --num 100 --gasUsedThreshold 5000000");
}
...
const validatorMap = new Map([
    ...
    ['0x502aECFE253E6AA0e8D2A06E12438FFeD0Fe16a0', [ 'GiltScan' , '0x0C5c547215c6516603c3de9525abEf86f66D3A54', '0xb15df58914a6b751909f0558a9f9af8efca7d46e480fc24478d977dafe7daf5161b38c72e9e1ea4865c288ef5b8054ab']],
    ...
    ['0xD3b0d838cCCEAe7ebF1781D11D1bB741DB7Fe1A7', [ 'GILTEve'  , '0xA3beF3479254a2ec123Bf4CBa34499f94D96Ee5b', '0xb39bdc22b7275d8456ee325424d33829d364270b1ecebb389318c7f0cb1f1c334f05d1d5e26472f2cd07f5d8025ea266']],
    ...
    ['0xB4cd0dCF71381b452A92A359BbE7146e8825Ce46', ['GILTLista'  , '0xEEa92f3bc1FB55571F3e0f0016c64bCb22d6a6A7', '0x845f542ccab20ef62e9cbf97c82264c9798c0e136ca5c41d2d130925b9d97d2cd2d3f81e81c90c1dae6c99dd517a2c61']],
...
// node getchainstatus.js GetMaxTxCountInBlockRange --rpc https://rpc-testnet.giltchain.com \
...
//      --rpc https://rpc-testnet.giltchain.com \
...
// Gilt testnet enabled 4844 on block: 39539137
...
// node getchainstatus.js GetMevStatus --rpc https://rpc-testnet.giltchain.com
//
// # Analyze specific range
// node getchainstatus.js GetMevStatus --rpc https://rpc-testnet.giltchain.com --startNum 40000001 --endNum 40000005
//
// # Analyze from specific block to latest
// node getchainstatus.js GetMevStatus --rpc https://rpc-testnet.giltchain.com --startNum 40000001
