...
# or
# python reorg_analyzer.py gilt.log
# or 
# python reorg_analyzer.py gilt.log.2024-10-3*
import re
import os
import argparse
...
validator_addr2monikey = {
    ...
    "0x502aECFE253E6AA0e8D2A06E12438FFeD0Fe16a0": "GiltScan",
    ...
    "0xD3b0d838cCCEAe7ebF1781D11D1bB741DB7Fe1A7": "GILTEve",
...
def main():
    parser = argparse.ArgumentParser(description='Analyze Gilt Chain node logs for reorgs.')
