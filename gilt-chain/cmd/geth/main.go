...
var (
	...
	nodeFlags = slices.Concat([]cli.Flag{
		...
		utils.BridgeHeimdallURLFlag,
		utils.BridgeStateReceiverFlag,
		utils.BridgeStateSyncTimeoutFlag,
		utils.BridgeStateSyncDelayFlag,
		utils.USBFlag,
		...
		// utils.ChainHistoryFlag, // disabled in Gilt Chain
...
func init() {
	...
	app.Commands = []*cli.Command{
		...
		dumpGenesisCommand,
		dumpRootHashCommand,
		// pruneHistoryCommand, // disabled in Gilt Chain
		downloadEraCommand,
		// See accountcmd.go:
		accountCommand,
		walletCommand,
...
func prepare(ctx *cli.Context) {
	...
	case ctx.IsSet(utils.ChapelFlag.Name):
		log.Info("Starting Gilt Chain on Testnet testnet...")
	}
