...
Generate ownership proof for the selected BLS account from the BLS wallet. The proof is used to prove ownership of the BLS account when creating a validator on Gilt Chain after Feynman upgrade.`,
					},
				},
			},
		},
