# Gold Chain Dual-Token Implementation Steps

This document is the execution guide for the Gold Chain upgrade.
...
2. Wire updated contract bytecode in `gilt/core/systemcontracts/upgrade.go`.
3. Ensure network profile consistency (mainnet/testnet/rialto targets used by project).
