...
//go:embed checkpoints_gilt_testnet.json
var checkpointsGILTTestnetJSON []byte

//go:embed checkpoints_gilt_mainnet.json
var checkpointsGILTMainnetJSON []byte
...
var checkpoints = []checkpointList{
	...
	decodeCheckpoints(checkpointsGILTTestnetJSON),
	decodeCheckpoints(checkpointsGILTMainnetJSON),
}
