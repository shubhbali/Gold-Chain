...
type BlobTxSidecar struct {
	// NOTE(Gilt Chain): PeerDAS support (EIP-7594) is disabled.
...
func (btx *blobTxWithBlobsV1) assign(sc *BlobTxSidecar) error {
	// NOTE(Gilt Chain): Upstream geth supports both Version 0 and 1 sidecars.
	// Gilt Chain only supports Version 0, as EIP-7594 (cell proofs) is not enabled yet.
