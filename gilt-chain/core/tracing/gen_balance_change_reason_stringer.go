...
func _() {
	...
	_ = x[BalanceDecreaseGILTDistributeReward-210]
	_ = x[BalanceIncreaseGILTDistributeReward-211]
}
...
const (
	...
	_BalanceChangeReason_name_1 = "BalanceDecreaseGILTDistributeRewardBalanceIncreaseGILTDistributeReward"
)
