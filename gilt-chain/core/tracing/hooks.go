...
const (
	...
	// Gilt Chain specific balance changes

	// BalanceDecreaseGILTDistributeReward is a balance change that decreases system address' balance and happens
	// when Gilt Chain is distributing rewards to validator.
	BalanceDecreaseGILTDistributeReward BalanceChangeReason = 210
	// BalanceIncreaseGILTDistributeReward is a balance change that increases the block validator's balance and
	// happens when Gilt Chain is distributing rewards to validator.
	BalanceIncreaseGILTDistributeReward BalanceChangeReason = 211
)
