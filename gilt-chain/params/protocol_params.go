...
const (
	...
	InitialBaseFeeForGILT           = 0          // Initial base fee for EIP-1559 blocks on Gilt Chain mainnet
...
var (
	...
	MinBlocksForBlobRequests           uint64 = uint64(float64(MinTimeDurationForBlobRequests) / 0.45) // ref: legacy BEP-524 timing table.
