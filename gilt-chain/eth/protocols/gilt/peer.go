...
// Peer is a collection of relevant information we have about a `gilt` peer.
type Peer struct {
	...
	*p2p.Peer                   // The embedded P2P package peer
	rw        p2p.MsgReadWriter // Input/output streams for gilt
...
// Version retrieves the peer's negotiated `gilt` protocol version.
