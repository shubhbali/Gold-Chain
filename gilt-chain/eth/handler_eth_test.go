...
func TestWaitGiltExtensionTimout68(t *testing.T) { testWaitGiltExtensionTimout(t, eth.ETH68) }

func testWaitGiltExtensionTimout(t *testing.T, protocol uint) {
	t.Parallel()
...
func testSendTransactions(t *testing.T, protocol uint) {
	...
	if err := sink.Handshake(1, handler.chain, eth.BlockRangeUpdatePacket{}, td, nil); err != nil {
		t.Fatalf("failed to run protocol handshake")
	}
