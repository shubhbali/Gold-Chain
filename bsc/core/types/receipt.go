...
func (r *Receipt) decodeTyped(b []byte) error {
	...
	switch b[0] {
	case DynamicFeeTxType, AccessListTxType, BlobTxType, SetCodeTxType, NativeTokenTxType:
		var data receiptRLP
...
func (rs Receipts) EncodeIndex(i int, w *bytes.Buffer) {
	...
	w.WriteByte(r.Type)
	switch r.Type {
	case AccessListTxType, DynamicFeeTxType, BlobTxType, SetCodeTxType, NativeTokenTxType:
		rlp.Encode(w, data)
	default:
