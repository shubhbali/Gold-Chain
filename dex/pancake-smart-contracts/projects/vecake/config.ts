...
export default {
  ...
  MasterChefV2: {
    ...
    goldchain: envAddr("NEXT_PUBLIC_GOLD_CHAIN_MASTERCHEF_ADDRESS"),
  },
  CakeToken: {
  ...
  ProxyForCakePoolFactory: {
    mainnet: "0x03E80d537dca71E826eac6fe74FBb0DB607A2727",
    testnet: "0x4f68968aC090D43966e3CE926aD64a40fE2b767B",
    goldchain: envAddr("GOLD_CHAIN_PROXY_FOR_CAKE_POOL_FACTORY"),
  },
  VECake: {
    mainnet: "0x5692DB8177a81A6c6afc8084C2976C9933EC1bAB",
    testnet: "0x4879fcB447E7F4c7843A6D15dF5526061304dcFb",
    goldchain: envAddr("GOLD_CHAIN_VECAKE_ADDRESS"),
  },
  cakePoolPID: {
    mainnet: 0,
    testnet: 2,
    goldchain: Number(process.env.GOLD_CHAIN_CAKE_POOL_PID || "0"),
  },
};
