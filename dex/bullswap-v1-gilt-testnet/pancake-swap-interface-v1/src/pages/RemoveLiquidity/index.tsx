                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            <StyledInternalLink
                              to={`/remove/${
                                currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'GILT' : currencyIdA
                              }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'GILT' : currencyIdB}`}
                            >
                              {TranslateString(1190, 'Receive GILT')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
