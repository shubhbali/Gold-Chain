...
const GOLD_CHAIN_MULTICALL_ADDRESS =
  (process.env.NEXT_PUBLIC_GOLD_CHAIN_MULTICALL_ADDRESS ||
    process.env.NEXT_PUBLIC_GOLD_CHAIN_MULTICALL3_ADDRESS ||
    '0xcA11bde05977b3631167028862bE2a173976CA11') as Address

export const MULTICALL_ADDRESS: { [key in ChainId]?: Address } = {
  [ChainId.ZKSYNC]: '0x95071cBD09184083E7F732a710c2e30c9882Fd5f',
  [ChainId.GILT]: '0x39eecaE833c944ebb94942Fa44CaE46e87a8Da17',
  ...
  [GOLD_CHAIN]: GOLD_CHAIN_MULTICALL_ADDRESS,
...
export const MULTICALL3_ADDRESSES: {
  ...
  [ChainId.GILT]: MULTICALL3_ADDRESS,
