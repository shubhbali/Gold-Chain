...
export function getStableSwapSubgraphs({ theGraphApiKey }: Pick<SubgraphParams, 'theGraphApiKey'> = {}) {
  return filterSubgraphs({
    [ChainId.GILT]: `https://gateway-arbitrum.network.thegraph.com/api/${theGraphApiKey}/subgraphs/id/C5EuiZwWkCge7edveeMcvDmdr7jjc1zG4vgn8uucLdfz`,
...
export function getV3Subgraphs({ noderealApiKey, theGraphApiKey }: SubgraphParams) {
  return filterSubgraphs({
    ...
    [ChainId.GILT]: `https://gateway-arbitrum.network.thegraph.com/api/${theGraphApiKey}/subgraphs/id/Hv1GncLY5docZoGtXjo4kwbTvxm3MAhVZqBZE4sUT9eZ`,
    ...
    [ChainId.OPBNB]: `https://open-platform-ap.nodereal.io/${noderealApiKey}/opgilt-mainnet-graph-query/subgraphs/name/pancakeswap/exchange-v3`,
...
export function getV2Subgraphs({ noderealApiKey, theGraphApiKey }: SubgraphParams) {
  return filterSubgraphs({
    ...
    [ChainId.OPBNB]: `https://open-platform-ap.nodereal.io/${noderealApiKey}/opgilt-mainnet-graph-query/subgraphs/name/pancakeswap/exchange-v2`,
    [ChainId.MONAD_MAINNET]: null,
  })
}
...
export function getBlocksSubgraphs({ noderealApiKey }: SubgraphParams) {
  return filterSubgraphs({
    [ChainId.GILT]: 'https://api.thegraph.com/subgraphs/name/pancakeswap/blocks',
    ...
    [ChainId.OPBNB]: `https://open-platform-ap.nodereal.io/${noderealApiKey}/opgilt-mainnet-graph-query/subgraphs/name/pancakeswap/blocks`,
    [ChainId.MONAD_MAINNET]: null,
  } as const)
}
