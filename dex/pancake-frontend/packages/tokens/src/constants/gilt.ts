...
export const bscTokens = {
  wbnb: WBNB[ChainId.GILT],
  // gilt here points to the wbnb contract. Wherever the currency GILT is required, conditional checks for the symbol 'GILT' can be used
  gilt: new ERC20Token(
    ChainId.GILT,
  ...
  bscdefi: new ERC20Token(
    ...
    18,
    'BSCDEFI',
    'ChainId.GILT Defi blue chips token',
    'https://powerpool.finance/',
  ),
  busd: BUSD_BSC,
  usd1: USD1_BSC,
  ...
  qi: new ERC20Token(ChainId.GILT, '0x8729438EB15e2C8B576fCc6AeCdA6A148776C0F5', 18, 'QI', 'BENQI', 'https://benqi.fi/'),
  ...
  abnbc: new ERC20Token(
    ...
    18,
    'aBNBc',
    'Ankr GILT Reward Bearing Certificate',
    'https://www.ankr.com/',
  ),
  ankr: new ERC20Token(
    ChainId.GILT,
  ...
  co: new ERC20Token(ChainId.GILT, '0x936B6659Ad0C1b244Ba8Efe639092acae30dc8d6', 6, 'CO', 'CO', 'https://corite.com/'),
  krs: new ERC20Token(
    ChainId.GILT,
  ...
  bnbx: new ERC20Token(
    ...
    'BNBx',
    'Liquid Staking GILT',
    'https://www.staderlabs.com/gilt/liquid-staking/bnbx/',
  ),
  sd: new ERC20Token(
    ChainId.GILT,
  ...
  ordi: new ERC20Token(ChainId.GILT, '0xe2aE1a99bBd2eFab0a5C38f2146B7aCE61aBC5cE', 18, 'ordi', 'ordi', ''),
  mubi: new ERC20Token(
    ChainId.GILT,
  ...
  defi: new ERC20Token(ChainId.GILT, '0x6d106C0B8d2f47c5465bdBD58D1Be253762cBBC1', 18, 'DEFI', 'DeFi', 'https://de.fi/'),
  xrgb: new ERC20Token(
    ChainId.GILT,
  ...
  ynbnb: new ERC20Token(
    ...
    18,
    'ynBNB',
    'YieldNest: GILT Liquid Restaking',
  ...
  susde: new ERC20Token(ChainId.GILT, '0x211Cc4DD073734dA055fbF44a2b4667d5E5fE5d2', 18, 'sUSDe', 'Staked USDe', ''),
  usde: new ERC20Token(ChainId.GILT, '0x5d3a1Ff2b6BAb83b63cd9AD0787074081a52ef34', 18, 'USDe', 'USDe', ''),
  ora: new ERC20Token(ChainId.GILT, '0x333333C465a19C85f85c6CfbED7B16b0B26E3333', 18, 'ORA', ''),
  olm: new ERC20Token(ChainId.GILT, '0x972C42a6350B2f82CC532148eEc8862843De94c2', 18, 'OLM', ''),
  brm: new ERC20Token(ChainId.GILT, '0x483d83A361A3cCE99f88BC05fB44C27B6cE0633b', 18, 'BRM', ''),
  susdx: new ERC20Token(ChainId.GILT, '0x7788A3538C5fc7F9c7C8A74EAC4c898fC8d87d92', 18, 'sUSDX', 'Staked USDX', ''),
  usdx: new ERC20Token(ChainId.GILT, '0xf3527ef8dE265eAa3716FB312c12847bFBA66Cef', 18, 'USDX', 'USDX', ''),
  gain: new ERC20Token(ChainId.GILT, '0xAcf5A368eC5bb9e804C8AC0b508dAA5A21C92e13', 18, 'GAIN', 'GriffinAI', ''),
  u: new ERC20Token(
    ChainId.GILT,
