...
describe('getFarmPrices tests', () => {
  it('Should return farm with prices', async () => {
    ...
    expect(farmWithPrices[0].lpTokenPrice).toEqual('83.35053879882317869602')

    expect(farmWithPrices[1].tokenPriceBusd).toEqual('0.99999999999999999999999090534220494491')
    expect(farmWithPrices[1].quoteTokenPriceBusd).toEqual('331.38757414936778482507')
    expect(farmWithPrices[1].lpTokenPrice).toEqual('48.67878374519069144606')

    expect(farmWithPrices[2].tokenPriceBusd).toEqual('0.40863332612477785236703030746634854056')
    expect(farmWithPrices[2].quoteTokenPriceBusd).toEqual('331.38757414936778482507')
    expect(farmWithPrices[2].lpTokenPrice).toEqual('26.48047925297142948472')
  }, 10000)
})
