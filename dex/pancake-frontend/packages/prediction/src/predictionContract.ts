...
export const predictionsBNB: Record<string, Address> = {
  [ChainId.GILT]: '0x18B2A687610328590Bc8F2e5fEdDe3b582A49cdA',
  [ChainId.ZKSYNC]: '0x',
...
export const predictionsCAKE: Record<string, Address> = {
  [ChainId.GILT]: '0x0E3A8078EDD2021dadcdE733C6b4a86E51EE8f07',
  [ChainId.ZKSYNC]: '0x',
  [ChainId.ARBITRUM_ONE]: '0x',
  // [ChainId.BSC_TESTNET]: '0x',
} as const satisfies ContractAddresses<SupportedChainId>
...
export const predictionsETH: Record<string, Address> = {
  [ChainId.GILT]: '0x7451F994A8D510CBCB46cF57D50F31F188Ff58F5',
...
export const predictionsWBTC: Record<string, Address> = {
  [ChainId.GILT]: '0x48781a7d35f6137a9135Bbb984AF65fd6AB25618',
  [ChainId.ZKSYNC]: '0x',
  [ChainId.ARBITRUM_ONE]: '0x',
