 ...
 * One test in swap.test.ts requires to have some GILT amount available to test swap confirmation modal
...
Cypress.Commands.overwrite('visit', (original, url, options) => {
  return original(url, {
    ...
    onBeforeLoad(win) {
      ...
      const provider = new JsonRpcProvider('https://gilt-dataseed.binance.org/', 56)
