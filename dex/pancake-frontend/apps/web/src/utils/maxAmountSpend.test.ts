...
describe('maxAmountSpend', () => {
  ...
  it('should has value when CurrencyAmount is GILT and CurrencyAmount is higher than min gilt', () => {
  ...
  it('should be 0 when CurrencyAmount is GILT and CurrencyAmount is low', () => {
