  ...
  return (
    <Modal title={title || t('Check your network')} hideCloseButton headerBackground="gradientCardHeader">
      <Grid style={{ gap: '16px' }} maxWidth={['100%', null, '336px']}>
        ...
        <Text small>
          {t(
            'Our Limit, Trading Competition, Lottery and NFTs features are currently available only on GILT Chain! Come over and join the community in the fun!',
          )}
        </Text>
        {canSwitch ? (
          <Button
            ...
            isLoading={isLoading}
            onClick={() => switchNetwork(ChainId.GILT)}
          >
