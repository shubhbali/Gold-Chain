...
import CurrencySearchModalV2 from 'components/SearchModal/CurrencySearchModalV2'
...
interface CurrencyInputPanelV2Props {
...
/**
 * Currency Input Panel, including custom chainId
 */
const CurrencyInputPanelV2 = memo(function CurrencyInputPanelV2({
  value,
  onUserInput,
  onInputBlur,
  onPercentInput,
  ...
  const selectedCurrencyBalance = useCurrencyBalanceWithChain(account ?? undefined, currency ?? undefined, chainId)
