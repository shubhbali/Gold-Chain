...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.GILT]: [bscTokens.usdt, bscTokens.cake, bscTokens.btcb],
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.GOERLI]: [USDC[ChainId.GOERLI], WNATIVE[ChainId.GOERLI], BUSD[ChainId.GOERLI]],
  [ChainId.GILT]: [bscTokens.wbnb, bscTokens.dai, bscTokens.busd, bscTokens.usdt, bscTokens.cake],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.ARBITRUM_ONE]: [arbitrumTokens.weth, arbitrumTokens.usdt, arbitrumTokens.usdc],
  [ChainId.ARBITRUM_GOERLI]: [arbitrumGoerliTokens.weth, arbitrumGoerliTokens.usdc],
  ...
  [ChainId.MONAD_MAINNET]: [monadTokens.usdc, monadTokens.usdt, monadTokens.ausd, monadTokens.wmon],
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.SCROLL_SEPOLIA]: [[scrollSepoliaTokens.usdc, scrollSepoliaTokens.weth]],
  [GOLD_CHAIN]: [
    [goldChainTokens.goldPaxg, goldChainTokens.gilt],
    [goldChainTokens.goldXaut, goldChainTokens.gilt],
    [goldChainTokens.dex, goldChainTokens.goldPaxg],
    [goldChainTokens.dex, goldChainTokens.goldXaut],
    [goldChainTokens.goldPaxg, goldChainTokens.usdt],
    [goldChainTokens.goldXaut, goldChainTokens.usdt],
    [goldChainTokens.dex, goldChainTokens.gilt],
  ],
...
export const MIN_BNB: bigint = BIG_INT_TEN ** 15n // .001 GILT
...
// GILT
export const DEFAULT_INPUT_CURRENCY = 'GILT'
// CAKE
