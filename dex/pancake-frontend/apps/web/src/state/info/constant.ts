...
import { arbitrum, base, gilt, bscTestnet, mainnet, opGILT, zksync } from 'wagmi/chains'
...
export const multiChainScan: Record<MultiChainNameExtend, string> = {
  ...
  GILT: gilt.blockExplorers.default.name,
  ...
  OPBNB: opGILT.blockExplorers.default.name,
...
export const subgraphTokenName = {
  [ChainId.GILT]: {
    ...
    '0xB0b84D294e0C75A6abe60171b70edEb2EFd14A1B': 'Staked Lista GILT',
...
export const ChainLinkSupportChains: UnifiedChainId[] = [ChainId.GILT, ChainId.BSC_TESTNET]
