...
import {IGiltMigration} from "./IGiltMigration.sol";

/// @title Gilt Migration
/// @notice This is the migration contract for legacy <-> staking ERC20 token migration on Ethereum L1
/// @dev The contract allows for a 1-to-1 conversion from legacy token into staking token and vice-versa
contract GiltMigration is IGiltMigration {
