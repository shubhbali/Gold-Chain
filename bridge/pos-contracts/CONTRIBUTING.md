...
This repo provides a deployer template library for consistency between scripts and unit tests. For more information on how to use the template, check [here](https://github.com/chatzoneai-spec/contract-deployer-template#readme).
...
- child_pos: Child PoS network profile
- child_testnet: Child PoS testnet profile
- child_zkevm: Child zkEVM profile
- child_zkevm_testnet: Child zkEVM testnet profile
