    ...
    IStateReceiver
{
    ...
    mapping(address => uint256) public goldChildTokenRouteCount;
    ...
    function mapToken(address rootToken, address childToken)
        ...
        only(MAPPER_ROLE)
    {
        _mapToken(rootToken, childToken, bytes32(0));
    }

    function mapTokenWithType(
        address rootToken,
        address childToken,
        bytes32 tokenType
        ...
        only(STATE_SYNCER_ROLE)
    {
        ...
        if (syncType == DEPOSIT) {
            ...
            (address rootToken, address childToken, bytes32 tokenType) = abi.decode(
                syncData,
    ...
    function cleanMapToken(
        ...
        if (
            ...
            if (goldChildTokenRouteCount[childToken] > 0) {
                goldChildTokenRouteCount[childToken] = goldChildTokenRouteCount[childToken] - 1;
            }
    ...
    function _mapToken(
        ...
        if (tokenType == GOLD_ERC1155_TOKEN_TYPE) {
            require(
                childToRootToken[childToken] == address(0),
                "ChildChainManager: CHILD_TOKEN_IN_USE"
            );
            if (rootToChildToken[rootToken] != childToken) {
                goldChildTokenRouteCount[childToken] = goldChildTokenRouteCount[childToken] + 1;
            }
            rootToChildToken[rootToken] = childToken;
        ...
        require(
            goldChildTokenRouteCount[childToken] == 0,
            "ChildChainManager: CHILD_TOKEN_IN_USE"
        );
