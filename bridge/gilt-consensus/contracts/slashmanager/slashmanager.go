...
// GiltConsensusId is a free data retrieval call binding the contract method 0xfbc3dd36.
//
// Solidity: function giltconsensusId() view returns(bytes32)
func (_Slashmanager *SlashmanagerCaller) GiltConsensusId(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Slashmanager.contract.Call(opts, &out, "giltconsensusId")
	if err != nil {
...
//
// Solidity: function giltconsensusId() view returns(bytes32)
func (_Slashmanager *SlashmanagerSession) GiltConsensusId() ([32]byte, error) {
	return _Slashmanager.Contract.GiltConsensusId(&_Slashmanager.CallOpts)
}

// GiltConsensusId is a free data retrieval call binding the contract method 0xfbc3dd36.
//
// Solidity: function giltconsensusId() view returns(bytes32)
func (_Slashmanager *SlashmanagerCallerSession) GiltConsensusId() ([32]byte, error) {
	return _Slashmanager.Contract.GiltConsensusId(&_Slashmanager.CallOpts)
}
...
// SetGiltConsensusId is a paid mutator transaction binding the contract method 0xea0688b3.
//
// Solidity: function setGiltConsensusId(string _giltconsensusId) returns()
func (_Slashmanager *SlashmanagerTransactor) SetGiltConsensusId(opts *bind.TransactOpts, _giltconsensusId string) (*types.Transaction, error) {
	return _Slashmanager.contract.Transact(opts, "setGiltConsensusId", _giltconsensusId)
}

// SetGiltConsensusId is a paid mutator transaction binding the contract method 0xea0688b3.
//
// Solidity: function setGiltConsensusId(string _giltconsensusId) returns()
func (_Slashmanager *SlashmanagerSession) SetGiltConsensusId(_giltconsensusId string) (*types.Transaction, error) {
	return _Slashmanager.Contract.SetGiltConsensusId(&_Slashmanager.TransactOpts, _giltconsensusId)
}

// SetGiltConsensusId is a paid mutator transaction binding the contract method 0xea0688b3.
//
// Solidity: function setGiltConsensusId(string _giltconsensusId) returns()
func (_Slashmanager *SlashmanagerTransactorSession) SetGiltConsensusId(_giltconsensusId string) (*types.Transaction, error) {
	return _Slashmanager.Contract.SetGiltConsensusId(&_Slashmanager.TransactOpts, _giltconsensusId)
}
