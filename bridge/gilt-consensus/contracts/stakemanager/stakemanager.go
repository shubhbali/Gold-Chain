...
// MinGiltConsensusFee is a free data retrieval call binding the contract method 0xfba58f34.
//
// Solidity: function minGiltConsensusFee() view returns(uint256)
func (_Stakemanager *StakemanagerCaller) MinGiltConsensusFee(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Stakemanager.contract.Call(opts, &out, "minGiltConsensusFee")
	if err != nil {
		return *new(*big.Int), err
	}
...
//
// Solidity: function minGiltConsensusFee() view returns(uint256)
func (_Stakemanager *StakemanagerSession) MinGiltConsensusFee() (*big.Int, error) {
	return _Stakemanager.Contract.MinGiltConsensusFee(&_Stakemanager.CallOpts)
}

// MinGiltConsensusFee is a free data retrieval call binding the contract method 0xfba58f34.
//
// Solidity: function minGiltConsensusFee() view returns(uint256)
func (_Stakemanager *StakemanagerCallerSession) MinGiltConsensusFee() (*big.Int, error) {
	return _Stakemanager.Contract.MinGiltConsensusFee(&_Stakemanager.CallOpts)
}
...
// TotalGiltConsensusFee is a free data retrieval call binding the contract method 0x9a8a6243.
//
// Solidity: function totalGiltConsensusFee() view returns(uint256)
func (_Stakemanager *StakemanagerCaller) TotalGiltConsensusFee(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Stakemanager.contract.Call(opts, &out, "totalGiltConsensusFee")
	if err != nil {
		return *new(*big.Int), err
	}
...
//
// Solidity: function totalGiltConsensusFee() view returns(uint256)
func (_Stakemanager *StakemanagerSession) TotalGiltConsensusFee() (*big.Int, error) {
	return _Stakemanager.Contract.TotalGiltConsensusFee(&_Stakemanager.CallOpts)
}

// TotalGiltConsensusFee is a free data retrieval call binding the contract method 0x9a8a6243.
//
// Solidity: function totalGiltConsensusFee() view returns(uint256)
func (_Stakemanager *StakemanagerCallerSession) TotalGiltConsensusFee() (*big.Int, error) {
	return _Stakemanager.Contract.TotalGiltConsensusFee(&_Stakemanager.CallOpts)
}
...
//
// Solidity: function confirmAuctionBid(uint256 validatorId, uint256 giltconsensusFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactor) ConfirmAuctionBid(opts *bind.TransactOpts, validatorId *big.Int, giltconsensusFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "confirmAuctionBid", validatorId, giltconsensusFee, acceptDelegation, signerPubkey)
}

// ConfirmAuctionBid is a paid mutator transaction binding the contract method 0xc8b194a2.
//
// Solidity: function confirmAuctionBid(uint256 validatorId, uint256 giltconsensusFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerSession) ConfirmAuctionBid(validatorId *big.Int, giltconsensusFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.ConfirmAuctionBid(&_Stakemanager.TransactOpts, validatorId, giltconsensusFee, acceptDelegation, signerPubkey)
}

// ConfirmAuctionBid is a paid mutator transaction binding the contract method 0xc8b194a2.
//
// Solidity: function confirmAuctionBid(uint256 validatorId, uint256 giltconsensusFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactorSession) ConfirmAuctionBid(validatorId *big.Int, giltconsensusFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.ConfirmAuctionBid(&_Stakemanager.TransactOpts, validatorId, giltconsensusFee, acceptDelegation, signerPubkey)
}
...
//
// Solidity: function stake(uint256 amount, uint256 giltconsensusFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactor) Stake(opts *bind.TransactOpts, amount *big.Int, giltconsensusFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "stake", amount, giltconsensusFee, acceptDelegation, signerPubkey)
}

// Stake is a paid mutator transaction binding the contract method 0x028c4c67.
//
// Solidity: function stake(uint256 amount, uint256 giltconsensusFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerSession) Stake(amount *big.Int, giltconsensusFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.Stake(&_Stakemanager.TransactOpts, amount, giltconsensusFee, acceptDelegation, signerPubkey)
}

// Stake is a paid mutator transaction binding the contract method 0x028c4c67.
//
// Solidity: function stake(uint256 amount, uint256 giltconsensusFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactorSession) Stake(amount *big.Int, giltconsensusFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.Stake(&_Stakemanager.TransactOpts, amount, giltconsensusFee, acceptDelegation, signerPubkey)
}

// StakeFor is a paid mutator transaction binding the contract method 0x4fdd20f1.
//
// Solidity: function stakeFor(address user, uint256 amount, uint256 giltconsensusFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactor) StakeFor(opts *bind.TransactOpts, user common.Address, amount *big.Int, giltconsensusFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "stakeFor", user, amount, giltconsensusFee, acceptDelegation, signerPubkey)
}

// StakeFor is a paid mutator transaction binding the contract method 0x4fdd20f1.
//
// Solidity: function stakeFor(address user, uint256 amount, uint256 giltconsensusFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerSession) StakeFor(user common.Address, amount *big.Int, giltconsensusFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.StakeFor(&_Stakemanager.TransactOpts, user, amount, giltconsensusFee, acceptDelegation, signerPubkey)
}

// StakeFor is a paid mutator transaction binding the contract method 0x4fdd20f1.
//
// Solidity: function stakeFor(address user, uint256 amount, uint256 giltconsensusFee, bool acceptDelegation, bytes signerPubkey) returns()
func (_Stakemanager *StakemanagerTransactorSession) StakeFor(user common.Address, amount *big.Int, giltconsensusFee *big.Int, acceptDelegation bool, signerPubkey []byte) (*types.Transaction, error) {
	return _Stakemanager.Contract.StakeFor(&_Stakemanager.TransactOpts, user, amount, giltconsensusFee, acceptDelegation, signerPubkey)
}
...
//
// Solidity: function topUpForFee(address user, uint256 giltconsensusFee) returns()
func (_Stakemanager *StakemanagerTransactor) TopUpForFee(opts *bind.TransactOpts, user common.Address, giltconsensusFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "topUpForFee", user, giltconsensusFee)
}

// TopUpForFee is a paid mutator transaction binding the contract method 0x63656798.
//
// Solidity: function topUpForFee(address user, uint256 giltconsensusFee) returns()
func (_Stakemanager *StakemanagerSession) TopUpForFee(user common.Address, giltconsensusFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.TopUpForFee(&_Stakemanager.TransactOpts, user, giltconsensusFee)
}

// TopUpForFee is a paid mutator transaction binding the contract method 0x63656798.
//
// Solidity: function topUpForFee(address user, uint256 giltconsensusFee) returns()
func (_Stakemanager *StakemanagerTransactorSession) TopUpForFee(user common.Address, giltconsensusFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.TopUpForFee(&_Stakemanager.TransactOpts, user, giltconsensusFee)
}
...
//
// Solidity: function updateMinAmounts(uint256 _minDeposit, uint256 _minGiltConsensusFee) returns()
func (_Stakemanager *StakemanagerTransactor) UpdateMinAmounts(opts *bind.TransactOpts, _minDeposit *big.Int, _minGiltConsensusFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.contract.Transact(opts, "updateMinAmounts", _minDeposit, _minGiltConsensusFee)
}

// UpdateMinAmounts is a paid mutator transaction binding the contract method 0xb1d23f02.
//
// Solidity: function updateMinAmounts(uint256 _minDeposit, uint256 _minGiltConsensusFee) returns()
func (_Stakemanager *StakemanagerSession) UpdateMinAmounts(_minDeposit *big.Int, _minGiltConsensusFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.UpdateMinAmounts(&_Stakemanager.TransactOpts, _minDeposit, _minGiltConsensusFee)
}

// UpdateMinAmounts is a paid mutator transaction binding the contract method 0xb1d23f02.
//
// Solidity: function updateMinAmounts(uint256 _minDeposit, uint256 _minGiltConsensusFee) returns()
func (_Stakemanager *StakemanagerTransactorSession) UpdateMinAmounts(_minDeposit *big.Int, _minGiltConsensusFee *big.Int) (*types.Transaction, error) {
	return _Stakemanager.Contract.UpdateMinAmounts(&_Stakemanager.TransactOpts, _minDeposit, _minGiltConsensusFee)
}
