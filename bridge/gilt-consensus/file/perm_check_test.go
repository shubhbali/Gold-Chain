...
import (
	...
	types "github.com/giltchain/gilt-consensus/types/error"
)
...
func TestPermCheck(t *testing.T) {
	...
	tc := []struct {
		...
		{
			filePath:  "/tmp/giltconsensus_test/test.json",
			perm:      0o777,
			validPerm: 0o600,
			expErr:    types.InvalidPermissionsError{File: "/tmp/giltconsensus_test/test.json", Perm: 0o600},
