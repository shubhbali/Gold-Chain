# GiltConsensus v1 → v2 Migration Guide

This directory contains migration guides for upgrading GiltConsensus from v1 to v2.
...
Use this if you run GiltConsensus using Docker, Kubernetes, or other containerized environments.
...
Use this if your GiltConsensus v1 runs as a `systemd` service.
