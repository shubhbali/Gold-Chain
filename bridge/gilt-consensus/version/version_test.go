...
func TestInfoString(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			info: version.Info{
				Name:       "giltconsensus",
				ServerName: "giltconsd",
				ClientName: "giltconsd",
				Version:    "v1.0.0",
		...
		},
		{
			...
			info: version.Info{
				Name:       "giltconsensus-test",
				ServerName: "giltconsd-test",
				ClientName: "giltconsd-test",
...
func TestDefaultVersionVariables(t *testing.T) {
	...
	t.Run("ServerName", func(t *testing.T) {
		...
		require.Equal(t, "giltconsd", version.ServerName)
	})

	t.Run("ClientName", func(t *testing.T) {
		// ClientName should have a default value
		require.Equal(t, "giltconsd", version.ClientName)
	})
