...
import "github.com/giltchain/gilt-consensus/bridge/util"

const (
	dummyCometBFTNode      = "http://localhost:26657"
	dummyGiltConsensusServerUrl = "https://dummy-giltconsensus-api-testnet.gilt.technology"

	chainManagerParamsUrl      = dummyGiltConsensusServerUrl + util.ChainManagerParamsURL
	...
	getAccountUrl      = dummyGiltConsensusServerUrl + "/auth/accounts/9FB29AAC15B9A4B7F17C3385939B007540F4D791"
	getAccountUrl2     = dummyGiltConsensusServerUrl + "/auth/accounts/3F17F1962B36E491B30A40B2405849E597BA5FB5"
	getAccountResponse = `
	{
	"type": "auth/Account",
	"value": {
	...
	isOldTxUrl      = dummyGiltConsensusServerUrl + "/clerk/is-old-tx?logindex=0&txhash=0x6d428739815d7c84cf89db055158861b089e0fd649676a0243a2a2d204c1d854"
	isOldTxResponse = `
	{
		"result": false
	}`

	checkpointCountUrl      = dummyGiltConsensusServerUrl + util.CountCheckpointURL
	...
	getValidatorSetUrl      = dummyGiltConsensusServerUrl + "/stake/validators-set"
