...
func init() {
	...
	proto.RegisterType((*QueryStakeIsOldTxRequest)(nil), "giltconsensusv2.stake.QueryStakeIsOldTxRequest")
	proto.RegisterType((*QueryStakeIsOldTxResponse)(nil), "giltconsensusv2.stake.QueryStakeIsOldTxResponse")
...
func init() { proto.RegisterFile("giltconsensusv2/stake/query.proto", fileDescriptor_64a607450adf12fe) }
...
func (c *queryClient) IsStakeTxOld(ctx context.Context, in *QueryStakeIsOldTxRequest, opts ...grpc.CallOption) (*QueryStakeIsOldTxResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/giltconsensusv2.stake.Query/IsStakeTxOld", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_IsStakeTxOld_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/giltconsensusv2.stake.Query/IsStakeTxOld",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
