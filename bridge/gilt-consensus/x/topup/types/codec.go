...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	legacy.RegisterAminoMsg(cdc, &MsgTopupTx{}, "giltconsensusv2/topup/MsgTopupTx")
	legacy.RegisterAminoMsg(cdc, &MsgWithdrawFeeTx{}, "giltconsensusv2/topup/MsgWithdrawFeeTx")
}
