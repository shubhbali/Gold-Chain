...
import (
	...
	protoutil "github.com/giltchain/polyproto/utils"
)

// MockGiltApiClient is a mock implementation of proto.GiltApiClient
type MockGiltApiClient struct {
	mock.Mock
}

func (m *MockGiltApiClient) GetRootHash(ctx context.Context, req *proto.GetRootHashRequest, _ ...grpc.CallOption) (*proto.GetRootHashResponse, error) {
...
func (m *MockGiltApiClient) GetVoteOnHash(ctx context.Context, req *proto.GetVoteOnHashRequest, _ ...grpc.CallOption) (*proto.GetVoteOnHashResponse, error) {
	args := m.Called(ctx, req)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockGiltApiClient) HeaderByNumber(ctx context.Context, req *proto.GetHeaderByNumberRequest, _ ...grpc.CallOption) (*proto.GetHeaderByNumberResponse, error) {
	args := m.Called(ctx, req)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockGiltApiClient) BlockByNumber(ctx context.Context, req *proto.GetBlockByNumberRequest, _ ...grpc.CallOption) (*proto.GetBlockByNumberResponse, error) {
	args := m.Called(ctx, req)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockGiltApiClient) TransactionReceipt(ctx context.Context, req *proto.ReceiptRequest, _ ...grpc.CallOption) (*proto.ReceiptResponse, error) {
	args := m.Called(ctx, req)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockGiltApiClient) BorBlockReceipt(ctx context.Context, req *proto.ReceiptRequest, _ ...grpc.CallOption) (*proto.ReceiptResponse, error) {
	args := m.Called(ctx, req)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *MockGiltApiClient) GetStartBlockGiltConsensusSpanID(ctx context.Context, req *proto.GetStartBlockGiltConsensusSpanIDRequest, _ ...grpc.CallOption) (*proto.GetStartBlockGiltConsensusSpanIDResponse, error) {
	args := m.Called(ctx, req)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
	return args.Get(0).(*proto.GetStartBlockGiltConsensusSpanIDResponse), args.Error(1)
}
...
func TestGetRootHash(t *testing.T) {
	...
	t.Run("successful root hash retrieval", func(t *testing.T) {
		...
		mockClient := new(MockGiltApiClient)
		grpcClient := &GiltGRPCClient{client: mockClient}
...
func TestGiltBlockReceipt(t *testing.T) {
	t.Parallel()

	t.Run("successful gilt block receipt retrieval", func(t *testing.T) {
		t.Parallel()
		...
		receipt, err := grpcClient.GiltBlockReceipt(context.Background(), txHash)
		require.NoError(t, err)
		require.NotNil(t, receipt)
	...
	t.Run("error retrieving gilt block receipt", func(t *testing.T) {
		t.Parallel()
		...
		mockClient.On("BorBlockReceipt", mock.Anything, mock.Anything).
			Return(nil, errors.New("gilt receipt error"))

		receipt, err := grpcClient.GiltBlockReceipt(context.Background(), txHash)
		require.Error(t, err)
		require.Contains(t, err.Error(), "gilt receipt error")
		require.NotNil(t, receipt)
