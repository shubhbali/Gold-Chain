...
func (c *GiltGRPCClient) GetRootHash(ctx context.Context, startBlock uint64, endBlock uint64) (string, error) {
	req := &proto.GetRootHashRequest{
		StartBlockNumber: startBlock,
		EndBlockNumber:   endBlock,
	}

	log.Info("Fetching gilt root hash")
	...
	log.Info("Fetched gilt root hash")

	return res.RootHash, nil
}

func (c *GiltGRPCClient) GetVoteOnHash(ctx context.Context, startBlock uint64, endBlock uint64, rootHash string, milestoneId string) (bool, error) {
...
func (c *GiltGRPCClient) HeaderByNumber(ctx context.Context, blockID int64) (*ethTypes.Header, error) {
...
func (c *GiltGRPCClient) BlockByNumber(ctx context.Context, blockID int64) (*ethTypes.Block, error) {
	if blockID > math.MaxInt64 {
		return nil, fmt.Errorf("blockID too large: %d", blockID)
	}
...
func (c *GiltGRPCClient) TransactionReceipt(ctx context.Context, txHash common.Hash) (*ethTypes.Receipt, error) {
...
func (c *GiltGRPCClient) GiltBlockReceipt(ctx context.Context, txHash common.Hash) (*ethTypes.Receipt, error) {
	req := &proto.ReceiptRequest{
		Hash: protoutil.ConvertHashToH256(txHash),
	}

	log.Info("Fetching gilt block receipt")
	...
	log.Info("Fetched gilt block receipt")
