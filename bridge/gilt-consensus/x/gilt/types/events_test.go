...
func TestAttributesKeyLatestGiltSpanId(t *testing.T) {
	require.Equal(t, "latest-gilt-span-id", types.AttributesKeyLatestGiltSpanId)
	require.NotEmpty(t, types.AttributesKeyLatestGiltSpanId)
}

func TestAttributeValueCategory(t *testing.T) {
	require.Equal(t, types.ModuleName, types.AttributeValueCategory)
	require.Equal(t, "gilt", types.AttributeValueCategory)
}
...
func TestAttributeKeysUniqueness(t *testing.T) {
	...
	attributeKeys := []string{
		...
		types.AttributesKeyLatestGiltSpanId,
	}
...
func TestGiltAttributes(t *testing.T) {
	// Test gilt-specific attributes
	require.Contains(t, types.AttributesKeyLatestGiltSpanId, "gilt")
}
