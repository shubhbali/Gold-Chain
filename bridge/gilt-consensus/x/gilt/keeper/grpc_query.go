...
func (q queryServer) GetLatestSpan(ctx context.Context, _ *types.QueryLatestSpanRequest) (*types.QueryLatestSpanResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetLatestSpanMethod, start, &err)
...
func (q queryServer) GetNextSpan(ctx context.Context, req *types.QueryNextSpanRequest) (*types.QueryNextSpanResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetNextSpanMethod, start, &err)
	...
	if req.GiltChainId != lastSpan.GiltChainId {
...
func (q queryServer) GetNextSpanSeed(ctx context.Context, req *types.QueryNextSpanSeedRequest) (*types.QueryNextSpanSeedResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetNextSpanSeedMethod, start, &err)
...
// GetGiltParams returns the gilt module parameters
func (q queryServer) GetGiltParams(ctx context.Context, _ *types.QueryParamsRequest) (*types.QueryParamsResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetGiltParamsMethod, start, &err)
...
func (q queryServer) GetSpanById(ctx context.Context, req *types.QuerySpanByIdRequest) (*types.QuerySpanByIdResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetSpanByIdMethod, start, &err)
...
func (q queryServer) GetSpanList(ctx context.Context, req *types.QuerySpanListRequest) (*types.QuerySpanListResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetSpanListMethod, start, &err)
...
func (q queryServer) GetProducerVotesByValidatorId(ctx context.Context, req *types.QueryProducerVotesByValidatorIdRequest) (*types.QueryProducerVotesByValidatorIdResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetProducerVotesByValidatorIdMethod, start, &err)
...
func (q queryServer) GetProducerVotes(ctx context.Context, _ *types.QueryProducerVotesRequest) (*types.QueryProducerVotesResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetProducerVotesMethod, start, &err)
...
func (q queryServer) GetProducerPlannedDowntime(ctx context.Context, req *types.QueryProducerPlannedDowntimeRequest) (*types.QueryProducerPlannedDowntimeResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetProducerPlannedDowntimeMethod, start, &err)
...
func recordGiltQueryMetric(method string, start time.Time, err *error) {
	success := *err == nil
	api.RecordAPICallWithStart(api.GiltSubsystem, method, api.QueryType, success, start)
}
...
func (q queryServer) GetValidatorPerformanceScore(ctx context.Context, _ *types.QueryValidatorPerformanceScoreRequest) (*types.QueryValidatorPerformanceScoreResponse, error) {
	var err error
	start := time.Now()
	defer recordGiltQueryMetric(api.GetValidatorPerformanceScoreMethod, start, &err)
