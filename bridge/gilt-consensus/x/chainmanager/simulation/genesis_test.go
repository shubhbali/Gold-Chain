...
import (
	...
	"github.com/giltchain/gilt-consensus/x/chainmanager/simulation"
...
func TestRandomizedGenState(t *testing.T) {
	...
	require.Equal(t, "646203300", cmGenesis.Params.ChainParams.GiltChainId)
	require.Equal(t, "giltconsensus-646203300", cmGenesis.Params.ChainParams.GiltConsensusChainId)
	require.Equal(t, "0x00000000000000000000000041f27Cc6F3875D04", cmGenesis.Params.ChainParams.SlashManagerAddress)
	require.Equal(t, "0x00000000000000000000000068255aaf95e94627", cmGenesis.Params.ChainParams.RootChainAddress)
