...
import (
	...
	"github.com/giltchain/gilt-consensus/x/chainmanager/keeper"
...
func (s *KeeperTestSuite) TestParamsGetterSetter() {
	...
	expParams.GiltChainTxConfirmations = 256
	expParams.MainChainTxConfirmations = 512
	expParams.ChainParams.GiltChainId = "1337"
	expParams.ChainParams.GiltConsensusChainId = "giltconsensus-1337"
