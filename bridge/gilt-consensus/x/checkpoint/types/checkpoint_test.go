...
func TestCreateCheckpoint(t *testing.T) {
	...
	t.Run("creates valid checkpoint from parameters", func(t *testing.T) {
		...
		checkpoint := types.CreateCheckpoint(id, startBlock, endBlock, rootHash, proposer, giltChainId, timestamp)
		...
		require.Equal(t, giltChainId, checkpoint.GiltChainId)
	...
	t.Run("creates checkpoint with empty root hash", func(t *testing.T) {
		...
		checkpoint := types.CreateCheckpoint(id, 1000, 2000, rootHash, proposer, giltChainId, timestamp)
	...
	t.Run("creates checkpoint with different gilt chain ids", func(t *testing.T) {
		t.Parallel()
		...
		for i, chainId := range chainIds {
			...
			require.Equal(t, chainId, checkpoint.GiltChainId)
		}
	})
}
...
func TestSortCheckpoints(t *testing.T) {
	...
	t.Run("sorts checkpoints by timestamp ascending", func(t *testing.T) {
		...
		cp1 := types.CreateCheckpoint(1, 1000, 2000, rootHash, proposer, giltChainId, 3000)
		cp2 := types.CreateCheckpoint(2, 3000, 4000, rootHash, proposer, giltChainId, 1000)
		cp3 := types.CreateCheckpoint(3, 5000, 6000, rootHash, proposer, giltChainId, 2000)
	...
	t.Run("handles single checkpoint", func(t *testing.T) {
		...
		cp := types.CreateCheckpoint(1, 1000, 2000, rootHash, proposer, giltChainId, 1234)
	...
	t.Run("maintains order for already sorted checkpoints", func(t *testing.T) {
		...
		cp1 := types.CreateCheckpoint(1, 1000, 2000, rootHash, proposer, giltChainId, 1000)
		cp2 := types.CreateCheckpoint(2, 3000, 4000, rootHash, proposer, giltChainId, 2000)
		cp3 := types.CreateCheckpoint(3, 5000, 6000, rootHash, proposer, giltChainId, 3000)
	...
	t.Run("sorts checkpoints with same timestamp", func(t *testing.T) {
		...
		cp1 := types.CreateCheckpoint(1, 1000, 2000, rootHash, proposer, giltChainId, timestamp)
		cp2 := types.CreateCheckpoint(2, 3000, 4000, rootHash, proposer, giltChainId, timestamp)
