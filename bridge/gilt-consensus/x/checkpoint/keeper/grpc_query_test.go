...
import (
	...
	chSim "github.com/giltchain/gilt-consensus/x/checkpoint/testutil"
...
func (s *KeeperTestSuite) TestQueryNextCheckpoint() {
	...
	require.Equal(checkpointBlock.GiltChainId, res.Checkpoint.GiltChainId)
}
