...
func (g GroupInfo) ValidateBasic() error {
	...
	_, err := sdk.AccAddressFromHex(g.Admin)
	if err != nil {
...
func (g GroupPolicyInfo) ValidateBasic() error {
	...
	_, err = sdk.AccAddressFromHex(g.Address)
	if err != nil {
...
func (g GroupMember) ValidateBasic() error {
	...
	if _, err := sdk.AccAddressFromHex(g.Member.Address); err != nil {
...
func (v Vote) ValidateBasic() error {
	_, err := sdk.AccAddressFromHex(v.Voter)
	if err != nil {
