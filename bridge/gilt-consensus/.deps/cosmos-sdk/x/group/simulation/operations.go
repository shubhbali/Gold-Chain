...
func SimulateMsgUpdateGroupPolicyDecisionPolicy(
	...
	return func(
		...
		groupPolicyHex, err := sdk.AccAddressFromHex(groupPolicyAddr)
		if err != nil {
		...
		msg, err := group.NewMsgUpdateGroupPolicyDecisionPolicy(acc.Address, groupPolicyHex, &group.ThresholdDecisionPolicy{
			Threshold: fmt.Sprintf("%d", simtypes.RandIntBetween(r, 1, 10)),
			Windows: &group.DecisionPolicyWindows{
