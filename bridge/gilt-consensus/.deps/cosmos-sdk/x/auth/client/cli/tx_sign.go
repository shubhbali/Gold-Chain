...
`,
	...
	// HV2: multisig disabled in GiltConsensus
...
func makeSignBatchCmd() func(cmd *cobra.Command, args []string) error {
	return func(cmd *cobra.Command, args []string) error {
		...
		// HV2: multisig disabled in GiltConsensus: enforcing `ms = ""` to reduce differences with upstream
		ms = ""
...
func signTx(cmd *cobra.Command, clientCtx client.Context, txF tx.Factory, newTx sdk.Tx) error {
	...
	// HV2: multisig disabled in GiltConsensus: enforcing `multisig = ""` to reduce differences with upstream
	multisig = ""
