...
func (s *CLITestSuite) TestNewMsgCreateVestingAccountCmd() {
	...
	cmd := cli.NewMsgCreateVestingAccountCmd(address.NewHexCodec())
...
func (s *CLITestSuite) TestNewMsgCreatePermanentLockedAccountCmd() {
	accounts := testutil.CreateKeyringAccounts(s.T(), s.kr, 1)
	cmd := cli.NewMsgCreatePermanentLockedAccountCmd(address.NewHexCodec())
	cmd.SetOutput(io.Discard)
...
func (s *CLITestSuite) TestNewMsgCreatePeriodicVestingAccountCmd() {
	accounts := testutil.CreateKeyringAccounts(s.T(), s.kr, 1)
	cmd := cli.NewMsgCreatePeriodicVestingAccountCmd(address.NewHexCodec())
	cmd.SetOutput(io.Discard)
