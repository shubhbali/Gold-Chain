...
```bash
giltconsd tx vesting create-periodic-vesting-account [to_address] [periods_json_file] [flags]
```

Example:

```bash
giltconsd tx vesting create-periodic-vesting-account cosmos1.. periods.json
```
...
```bash
giltconsd tx vesting create-vesting-account [to_address] [amount] [end_time] [flags]
```

Example:

```bash
giltconsd tx vesting create-vesting-account cosmos1.. 100stake 2592000
```
