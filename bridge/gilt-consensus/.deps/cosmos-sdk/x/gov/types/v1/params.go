...
var (
	CoinDecimals                     = new(big.Int).Exp(big.NewInt(10), big.NewInt(18), nil)                     // HV2: defined in giltconsensus
	DefaultMinDepositTokens          = sdkmath.NewIntFromBigInt(new(big.Int).Mul(big.NewInt(100), CoinDecimals)) // // HV2: defined in giltconsensus
...
func DefaultParams() Params {
	return NewParams(
		sdk.NewCoins(sdk.NewCoin(authtypes.FeeToken, DefaultMinDepositTokens)), // HV2: defined in giltconsensus
