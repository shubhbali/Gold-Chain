...
// HV2: giltconsensus uses validator-id to identify the validator (voter, depositors, proposer...)
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			// HV2: disabled in giltconsensus as we do not support WeighedVoteOptions
			return fmt.Errorf("weighted-vote are currently not supported in giltconsensus")
