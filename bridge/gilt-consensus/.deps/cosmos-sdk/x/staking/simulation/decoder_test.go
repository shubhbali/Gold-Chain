...
func TestDecodeStore(t *testing.T) {
	...
	ubd := types.NewUnbondingDelegation(delAddr1, valAddr1, 15, bondTime, math.OneInt(), 1, address.NewHexCodec(), address.NewHexCodec())
	red := types.NewRedelegation(delAddr1, valAddr1, valAddr1, 12, bondTime, math.OneInt(), math.LegacyOneDec(), 0, address.NewHexCodec(), address.NewHexCodec())
