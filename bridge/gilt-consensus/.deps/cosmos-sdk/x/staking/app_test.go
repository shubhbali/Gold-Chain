...
func TestStakingMsgs(t *testing.T) {
	...
	_, _, err = simtestutil.SignCheckDeliver(t, txConfig, app.BaseApp, nil, []sdk.Msg{createValidatorMsg}, "", []uint64{0}, []uint64{0}, true, true, priv1)
	require.NoError(t, err)
	...
	_, _, err = simtestutil.SignCheckDeliver(t, txConfig, app.BaseApp, nil, []sdk.Msg{editValidatorMsg}, "", []uint64{0}, []uint64{1}, true, true, priv1)
	require.NoError(t, err)
	...
	_, _, err = simtestutil.SignCheckDeliver(t, txConfig, app.BaseApp, nil, []sdk.Msg{delegateMsg}, "", []uint64{1}, []uint64{0}, true, true, priv2)
	require.NoError(t, err)
	...
	_, _, err = simtestutil.SignCheckDeliver(t, txConfig, app.BaseApp, nil, []sdk.Msg{beginUnbondingMsg}, "", []uint64{1}, []uint64{1}, true, true, priv2)
	require.NoError(t, err)
