...
type BorApiClient interface {
	...
	GetStartBlockGiltConsensusSpanID(ctx context.Context, in *GetStartBlockGiltConsensusSpanIDRequest, opts ...grpc.CallOption) (*GetStartBlockGiltConsensusSpanIDResponse, error)
}
...
func (c *borApiClient) GetRootHash(ctx context.Context, in *GetRootHashRequest, opts ...grpc.CallOption) (*GetRootHashResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gilt.BorApi/GetRootHash", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *borApiClient) GetVoteOnHash(ctx context.Context, in *GetVoteOnHashRequest, opts ...grpc.CallOption) (*GetVoteOnHashResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gilt.BorApi/GetVoteOnHash", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *borApiClient) HeaderByNumber(ctx context.Context, in *GetHeaderByNumberRequest, opts ...grpc.CallOption) (*GetHeaderByNumberResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gilt.BorApi/HeaderByNumber", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *borApiClient) BlockByNumber(ctx context.Context, in *GetBlockByNumberRequest, opts ...grpc.CallOption) (*GetBlockByNumberResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gilt.BorApi/BlockByNumber", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *borApiClient) TransactionReceipt(ctx context.Context, in *ReceiptRequest, opts ...grpc.CallOption) (*ReceiptResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gilt.BorApi/TransactionReceipt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *borApiClient) BorBlockReceipt(ctx context.Context, in *ReceiptRequest, opts ...grpc.CallOption) (*ReceiptResponse, error) {
	out := new(ReceiptResponse)
	err := c.cc.Invoke(ctx, "/gilt.BorApi/BorBlockReceipt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *borApiClient) GetStartBlockGiltConsensusSpanID(ctx context.Context, in *GetStartBlockGiltConsensusSpanIDRequest, opts ...grpc.CallOption) (*GetStartBlockGiltConsensusSpanIDResponse, error) {
	out := new(GetStartBlockGiltConsensusSpanIDResponse)
	err := c.cc.Invoke(ctx, "/gilt.BorApi/GetStartBlockGiltConsensusSpanID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BorApiServer interface {
	...
	GetStartBlockGiltConsensusSpanID(context.Context, *GetStartBlockGiltConsensusSpanIDRequest) (*GetStartBlockGiltConsensusSpanIDResponse, error)
...
func (UnimplementedBorApiServer) GetStartBlockGiltConsensusSpanID(context.Context, *GetStartBlockGiltConsensusSpanIDRequest) (*GetStartBlockGiltConsensusSpanIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetStartBlockGiltConsensusSpanID not implemented")
}
...
func _BorApi_GetRootHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gilt.BorApi/GetRootHash",
	}
...
func _BorApi_GetVoteOnHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gilt.BorApi/GetVoteOnHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BorApi_HeaderByNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gilt.BorApi/HeaderByNumber",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BorApi_BlockByNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gilt.BorApi/BlockByNumber",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BorApi_TransactionReceipt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gilt.BorApi/TransactionReceipt",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BorApi_BorBlockReceipt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gilt.BorApi/BorBlockReceipt",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BorApi_GetStartBlockGiltConsensusSpanID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStartBlockGiltConsensusSpanIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BorApiServer).GetStartBlockGiltConsensusSpanID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gilt.BorApi/GetStartBlockGiltConsensusSpanID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BorApiServer).GetStartBlockGiltConsensusSpanID(ctx, req.(*GetStartBlockGiltConsensusSpanIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BorApi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStartBlockGiltConsensusSpanID",
			Handler:    _BorApi_GetStartBlockGiltConsensusSpanID_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "gilt/gilt.proto",
}
