...
func PrometheusMetrics(namespace string, labelsAndValues ...string) *Metrics {
	...
	return &Metrics{
		...
		BlobParts: prometheus.NewCounterFrom(stdprometheus.CounterOpts{
			Namespace: namespace,
			Subsystem: MetricsSubsystem,
			Name:      "blob_parts",
			Help:      "Number of blob parts transmitted by each peer.",
		}, append(labels, "peer_id")).With(labelsAndValues...),
		...
		DuplicateBlobPart: prometheus.NewCounterFrom(stdprometheus.CounterOpts{
			Namespace: namespace,
			Subsystem: MetricsSubsystem,
			Name:      "duplicate_blob_part",
			Help:      "Number of times we received a duplicate blob part",
		}, labels).With(labelsAndValues...),
		...
		BlobGossipPartsReceived: prometheus.NewCounterFrom(stdprometheus.CounterOpts{
			Namespace: namespace,
			Subsystem: MetricsSubsystem,
			Name:      "blob_gossip_parts_received",
			Help:      "Number of blob parts received by the node, separated by whether the part was relevant to the blob the node is trying to gather or not.",
		}, append(labels, "matches_current")).With(labelsAndValues...),
