...
type Vote struct {
	...
	NonRpExtension          []byte `protobuf:"bytes,11,opt,name=non_rp_extension,json=nonRpExtension,proto3" json:"non_rp_extension,omitempty"`
	NonRpExtensionSignature []byte `protobuf:"bytes,12,opt,name=non_rp_extension_signature,json=nonRpExtensionSignature,proto3" json:"non_rp_extension_signature,omitempty"`
}
...
func (m *Vote) GetNonRpExtension() []byte {
	if m != nil {
...
func (m *Vote) GetNonRpExtensionSignature() []byte {
	if m != nil {
...
type ExtendedCommitSig struct {
	...
	// Vote extension data (Non-replay-protected version)
	NrpExtension []byte `protobuf:"bytes,7,opt,name=nrp_extension,json=nrpExtension,proto3" json:"nrp_extension,omitempty"`
	// Signature of the non-replay-protected extension
	NrpExtensionSignature []byte `protobuf:"bytes,8,opt,name=nrp_extension_signature,json=nrpExtensionSignature,proto3" json:"nrp_extension_signature,omitempty"`
}
...
func (m *ExtendedCommitSig) GetNrpExtension() []byte {
	if m != nil {
		return m.NrpExtension
	}
	return nil
}

func (m *ExtendedCommitSig) GetNrpExtensionSignature() []byte {
	if m != nil {
		return m.NrpExtensionSignature
	}
	return nil
}
...
var fileDescriptor_d3a6e55e2345de56 = []byte{
	...
	,
}
...
func (m *ExtendedCommitSig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.NrpExtensionSignature) > 0 {
		i -= len(m.NrpExtensionSignature)
		copy(dAtA[i:], m.NrpExtensionSignature)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.NrpExtensionSignature)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.NrpExtension) > 0 {
		i -= len(m.NrpExtension)
		copy(dAtA[i:], m.NrpExtension)
		i = encodeVarintTypes(dAtA, i, uint64(len(m.NrpExtension)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.ExtensionSignature) > 0 {
...
func (m *ExtendedCommitSig) Size() (n int) {
	...
	l = len(m.NrpExtension)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	l = len(m.NrpExtensionSignature)
	if l > 0 {
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
...
func (m *ExtendedCommitSig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NrpExtension", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NrpExtension = append(m.NrpExtension[:0], dAtA[iNdEx:postIndex]...)
			if m.NrpExtension == nil {
				m.NrpExtension = []byte{}
			}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NrpExtensionSignature", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NrpExtensionSignature = append(m.NrpExtensionSignature[:0], dAtA[iNdEx:postIndex]...)
			if m.NrpExtensionSignature == nil {
				m.NrpExtensionSignature = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
