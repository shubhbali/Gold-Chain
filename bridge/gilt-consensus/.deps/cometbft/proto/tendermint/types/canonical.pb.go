...
// CanonicalBlobID is a canonical representation of a BlobID, which gets
// serialized and signed.
type CanonicalBlobID struct {
	Hash          []byte                 `protobuf:"bytes,1,opt,name=hash,proto3" json:"hash,omitempty"`
	PartSetHeader CanonicalPartSetHeader `protobuf:"bytes,2,opt,name=part_set_header,json=partSetHeader,proto3" json:"part_set_header"`
}

func (m *CanonicalBlobID) Reset()         { *m = CanonicalBlobID{} }
func (m *CanonicalBlobID) String() string { return proto.CompactTextString(m) }
func (*CanonicalBlobID) ProtoMessage()    {}
func (*CanonicalBlobID) Descriptor() ([]byte, []int) {
	return fileDescriptor_8d1a1a84ff7267ed, []int{1}
}
func (m *CanonicalBlobID) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CanonicalBlobID) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CanonicalBlobID.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CanonicalBlobID) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CanonicalBlobID.Merge(m, src)
}
func (m *CanonicalBlobID) XXX_Size() int {
	return m.Size()
}
func (m *CanonicalBlobID) XXX_DiscardUnknown() {
	xxx_messageInfo_CanonicalBlobID.DiscardUnknown(m)
}

var xxx_messageInfo_CanonicalBlobID proto.InternalMessageInfo

func (m *CanonicalBlobID) GetHash() []byte {
	if m != nil {
		return m.Hash
	}
	return nil
...
func (m *CanonicalBlobID) GetPartSetHeader() CanonicalPartSetHeader {
	if m != nil {
		return m.PartSetHeader
	}
	return CanonicalPartSetHeader{}
...
type CanonicalProposal struct {
	...
	BlobID    *CanonicalBlobID  `protobuf:"bytes,8,opt,name=blob_id,json=blobId,proto3" json:"blob_id,omitempty"`
}
...
func (m *CanonicalProposal) GetBlobID() *CanonicalBlobID {
	if m != nil {
		return m.BlobID
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CanonicalBlobID)(nil), "tendermint.types.CanonicalBlobID")
...
var fileDescriptor_8d1a1a84ff7267ed = []byte{
	...
	,
}
...
func (m *CanonicalBlobID) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CanonicalBlobID) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CanonicalBlobID) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CanonicalBlobID) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *CanonicalBlobID) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CanonicalBlobID: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CanonicalBlobID: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
