...
func TestConsensusParamsValidation(t *testing.T) {
	testCases := []struct {
		...
		// test block params
		0: {makeParams(1, 0, 1, 2, 0, valEd25519, 0), true},
		1: {makeParams(0, 0, 1, 2, 0, valEd25519, 0), false},
		2: {makeParams(47*1024*1024, 0, 1, 2, 0, valEd25519, 0), true},
		3: {makeParams(10, 0, 1, 2, 0, valEd25519, 0), true},
		4: {makeParams(100*1024*1024, 0, 1, 2, 0, valEd25519, 0), true},
		5: {makeParams(101*1024*1024, 0, 1, 2, 0, valEd25519, 0), false},
		6: {makeParams(1024*1024*1024, 0, 1, 2, 0, valEd25519, 0), false},
		// test evidence params
		7:  {makeParams(1, 0, 1, 0, 0, valEd25519, 0), false},
		8:  {makeParams(1, 0, 1, 2, 2, valEd25519, 0), false},
		9:  {makeParams(1000, 1, 1, 2, 1, valEd25519, 0), true},
		10: {makeParams(1, 0, 1, -1, 0, valEd25519, 0), false},
		// test no pubkey type provided
		11: {makeParams(1, 0, 1, 2, 0, []string{}, 0), false},
		// test invalid pubkey type provided
		12: {makeParams(1, 0, 1, 2, 0, []string{"potatoes make good pubkeys"}, 0), false},
		...
		19: {makeParams(1, 0, 800*1024+1, 2, 0, valEd25519, 0), false},
		20: {makeParams(1, 0, 801*1024, 2, 0, valEd25519, 0), false},
		21: {makeParams(1, 0, 1024*1024, 2, 0, valEd25519, 0), false},
		22: {makeParams(1, 0, -1, 2, 0, valEd25519, 0), true},
		23: {makeParams(1, 0, -2, 2, 0, valEd25519, 0), false},
	}
...
func TestConsensusParamsHash(t *testing.T) {
	params := []ConsensusParams{
		makeParams(4, 2, 1, 3, 1, valEd25519, 0),
		makeParams(1, 4, 1, 3, 1, valEd25519, 0),
		makeParams(1, 2, 1, 4, 1, valEd25519, 0),
		makeParams(2, 5, 1, 7, 1, valEd25519, 0),
		makeParams(1, 7, 1, 6, 1, valEd25519, 0),
		makeParams(9, 5, 1, 4, 1, valEd25519, 0),
		makeParams(7, 8, 1, 9, 1, valEd25519, 0),
		makeParams(4, 6, 1, 5, 1, valEd25519, 0),
	}
...
func TestConsensusParamsUpdate_AppVersion(t *testing.T) {
	params := makeParams(1, 2, 1, 3, 0, valEd25519, 0)
...
func TestConsensusParamsUpdate_VoteExtensionsEnableHeight(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(*testing.T) {
			initialParams := makeParams(1, 0, 1, 2, 0, valEd25519, tc.from)
...
func TestProto(t *testing.T) {
	params := []ConsensusParams{
		makeParams(4, 2, 1, 3, 1, valEd25519, 1),
		makeParams(1, 4, 1, 3, 1, valEd25519, 1),
		makeParams(1, 2, 1, 4, 1, valEd25519, 1),
		makeParams(2, 5, 1, 7, 1, valEd25519, 1),
		makeParams(1, 7, 1, 6, 1, valEd25519, 1),
		makeParams(9, 5, 1, 4, 1, valEd25519, 1),
		makeParams(7, 8, 1, 9, 1, valEd25519, 1),
		makeParams(4, 6, 1, 5, 1, valEd25519, 1),
	}
