...
replace (
	cosmossdk.io/api => github.com/GiltChain/cosmos-sdk/api v0.7.4
	cosmossdk.io/core => github.com/GiltChain/cosmos-sdk/core v0.11.0
	cosmossdk.io/errors => github.com/GiltChain/cosmos-sdk/errors v1.0.1
