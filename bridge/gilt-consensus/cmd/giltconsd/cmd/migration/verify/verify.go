...
import (
	...
	hmTypes "github.com/giltchain/gilt-consensus/x/stake/types"
)
...
func verifyBalances(ctx types.Context, app *giltconsensusApp.GiltConsensusApp, hv1Genesis map[string]interface{}) error {
...
func verifyValidators(ctx types.Context, app *giltconsensusApp.GiltConsensusApp, hv1Genesis map[string]interface{}) error {
...
func verifyCheckpoints(ctx types.Context, app *giltconsensusApp.GiltConsensusApp, hv1Genesis map[string]interface{}) error {
...
func verifyTopup(ctx types.Context, app *giltconsensusApp.GiltConsensusApp, hv1Genesis map[string]interface{}) error {
...
func verifyClerkEventRecords(ctx types.Context, app *giltconsensusApp.GiltConsensusApp, hv1Genesis map[string]interface{}) error {
...
func getGenesisAppState(hv2GenesisPath string) (giltconsensusApp.GenesisState, error) {
