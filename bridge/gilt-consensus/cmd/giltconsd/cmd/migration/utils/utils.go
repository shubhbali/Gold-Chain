...
import (
	...
	v034gov "github.com/giltchain/gilt-consensus/cmd/giltconsd/cmd/migration/gov/v034"
...
func MigrateAuthAccounts(authData map[string]interface{}) ([]*codecTypes.Any, error) {
	...
	for i, account := range accounts {
		...
		if moduleName != "" {
			// We skip module accounts, because giltconsensus v2 will initialize them from zero anyway
			continue
		}
