...
const (
	Query_GetCurrentValidatorSet_FullMethodName      = "/giltconsensusv2.stake.Query/GetCurrentValidatorSet"
	Query_GetSignerByAddress_FullMethodName          = "/giltconsensusv2.stake.Query/GetSignerByAddress"
