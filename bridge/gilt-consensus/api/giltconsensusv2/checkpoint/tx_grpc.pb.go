...
const (
	Msg_Checkpoint_FullMethodName      = "/giltconsensusv2.checkpoint.Msg/Checkpoint"
	Msg_CheckpointAck_FullMethodName   = "/giltconsensusv2.checkpoint.Msg/CheckpointAck"
	Msg_CheckpointNoAck_FullMethodName = "/giltconsensusv2.checkpoint.Msg/CheckpointNoAck"
	Msg_UpdateParams_FullMethodName    = "/giltconsensusv2.checkpoint.Msg/UpdateParams"
)
...
func (c *msgClient) Checkpoint(ctx context.Context, in *MsgCheckpoint, opts ...grpc.CallOption) (*MsgCheckpointResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_Checkpoint_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CheckpointAck(ctx context.Context, in *MsgCpAck, opts ...grpc.CallOption) (*MsgCpAckResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_CheckpointAck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CheckpointNoAck(ctx context.Context, in *MsgCpNoAck, opts ...grpc.CallOption) (*MsgCheckpointNoAckResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_CheckpointNoAck_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
