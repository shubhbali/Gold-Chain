...
const (
	Msg_HandleMsgEventRecord_FullMethodName = "/giltconsensusv2.clerk.Msg/HandleMsgEventRecord"
)
...
//
// Msg defines the gRPC message service for the clerk module.
...
func (c *msgClient) HandleMsgEventRecord(ctx context.Context, in *MsgEventRecord, opts ...grpc.CallOption) (*MsgEventRecordResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_HandleMsgEventRecord_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
