...
const (
	Query_IsTopupTxOld_FullMethodName                = "/giltconsensusv2.topup.Query/IsTopupTxOld"
	Query_GetTopupTxSequence_FullMethodName          = "/giltconsensusv2.topup.Query/GetTopupTxSequence"
	Query_GetDividendAccountByAddress_FullMethodName = "/giltconsensusv2.topup.Query/GetDividendAccountByAddress"
	Query_GetDividendAccountRootHash_FullMethodName  = "/giltconsensusv2.topup.Query/GetDividendAccountRootHash"
	Query_VerifyAccountProofByAddress_FullMethodName = "/giltconsensusv2.topup.Query/VerifyAccountProofByAddress"
	Query_GetAccountProofByAddress_FullMethodName    = "/giltconsensusv2.topup.Query/GetAccountProofByAddress"
)
...
func (c *queryClient) IsTopupTxOld(ctx context.Context, in *QueryTopupSequenceRequest, opts ...grpc.CallOption) (*QueryIsTopupTxOldResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_IsTopupTxOld_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetTopupTxSequence(ctx context.Context, in *QueryTopupSequenceRequest, opts ...grpc.CallOption) (*QueryTopupSequenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetTopupTxSequence_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetDividendAccountByAddress(ctx context.Context, in *QueryDividendAccountRequest, opts ...grpc.CallOption) (*QueryDividendAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetDividendAccountByAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetDividendAccountRootHash(ctx context.Context, in *QueryDividendAccountRootHashRequest, opts ...grpc.CallOption) (*QueryDividendAccountRootHashResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetDividendAccountRootHash_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) VerifyAccountProofByAddress(ctx context.Context, in *QueryVerifyAccountProofRequest, opts ...grpc.CallOption) (*QueryVerifyAccountProofResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_VerifyAccountProofByAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GetAccountProofByAddress(ctx context.Context, in *QueryAccountProofRequest, opts ...grpc.CallOption) (*QueryAccountProofResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_GetAccountProofByAddress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
