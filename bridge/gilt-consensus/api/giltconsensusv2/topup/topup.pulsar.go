...
func init() {
	...
	md_AccountProof = File_giltconsensusv2_topup_topup_proto.Messages().ByName("AccountProof")
...
func (x *AccountProof) slowProtoReflect() protoreflect.Message {
	mi := &file_giltconsensusv2_topup_topup_proto_msgTypes[0]
...
func (x *fastReflection_AccountProof) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "giltconsensusv2.topup.AccountProof.address":
		return x.Address != ""
	case "giltconsensusv2.topup.AccountProof.account_proof":
		return len(x.AccountProof) != 0
	case "giltconsensusv2.topup.AccountProof.index":
		return x.Index != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: giltconsensusv2.topup.AccountProof"))
		}
		panic(fmt.Errorf("message giltconsensusv2.topup.AccountProof does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AccountProof) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message giltconsensusv2.topup.AccountProof does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AccountProof) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "giltconsensusv2.topup.AccountProof.address":
		panic(fmt.Errorf("field address of message giltconsensusv2.topup.AccountProof is not mutable"))
	case "giltconsensusv2.topup.AccountProof.account_proof":
		panic(fmt.Errorf("field account_proof of message giltconsensusv2.topup.AccountProof is not mutable"))
	case "giltconsensusv2.topup.AccountProof.index":
		panic(fmt.Errorf("field index of message giltconsensusv2.topup.AccountProof is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: giltconsensusv2.topup.AccountProof"))
		}
...
func (x *fastReflection_AccountProof) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in giltconsensusv2.topup.AccountProof", d.FullName()))
	}
	panic("unreachable")
}
...
func (*AccountProof) Descriptor() ([]byte, []int) {
	return file_giltconsensusv2_topup_topup_proto_rawDescGZIP(), []int{0}
}
...
var File_giltconsensusv2_topup_topup_proto protoreflect.FileDescriptor

var file_giltconsensusv2_topup_topup_proto_rawDesc = []byte{
	...
	0x6e, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8b, 0x01, 0x0a, 0x0c, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x6f, 0x66, 0x12, 0x32, 0x0a, 0x07, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x42, 0x18, 0xd2, 0xb4, 0x2d, 0x14,
	0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x53, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x2a, 0x0a,
	0x0d, 0x61, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0c, 0x42, 0x05, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x0c, 0x61, 0x63, 0x63,
	...
	0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x42, 0xdb, 0x01, 0x0a, 0x19, 0x63, 0x6f, 0x6d, 0x2e, 0x67,
	0x69, 0x6c, 0x74, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x76, 0x32, 0x2e, 0x74,
	0x6f, 0x70, 0x75, 0x70, 0x42, 0x0a, 0x54, 0x6f, 0x70, 0x75, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_giltconsensusv2_topup_topup_proto_rawDescOnce sync.Once
	file_giltconsensusv2_topup_topup_proto_rawDescData = file_giltconsensusv2_topup_topup_proto_rawDesc
)

func file_giltconsensusv2_topup_topup_proto_rawDescGZIP() []byte {
	file_giltconsensusv2_topup_topup_proto_rawDescOnce.Do(func() {
		file_giltconsensusv2_topup_topup_proto_rawDescData = protoimpl.X.CompressGZIP(file_giltconsensusv2_topup_topup_proto_rawDescData)
	})
	return file_giltconsensusv2_topup_topup_proto_rawDescData
}

var file_giltconsensusv2_topup_topup_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_giltconsensusv2_topup_topup_proto_goTypes = []interface{}{
	(*AccountProof)(nil), // 0: giltconsensusv2.topup.AccountProof
}
var file_giltconsensusv2_topup_topup_proto_depIdxs = []int32{
...
func init() { file_giltconsensusv2_topup_topup_proto_init() }
func file_giltconsensusv2_topup_topup_proto_init() {
	if File_giltconsensusv2_topup_topup_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_giltconsensusv2_topup_topup_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_giltconsensusv2_topup_topup_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_giltconsensusv2_topup_topup_proto_goTypes,
		DependencyIndexes: file_giltconsensusv2_topup_topup_proto_depIdxs,
		MessageInfos:      file_giltconsensusv2_topup_topup_proto_msgTypes,
	}.Build()
	File_giltconsensusv2_topup_topup_proto = out.File
	file_giltconsensusv2_topup_topup_proto_rawDesc = nil
	file_giltconsensusv2_topup_topup_proto_goTypes = nil
	file_giltconsensusv2_topup_topup_proto_depIdxs = nil
}
