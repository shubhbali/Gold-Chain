...
const (
	Msg_ProposeSpan_FullMethodName         = "/giltconsensusv2.gilt.Msg/ProposeSpan"
	Msg_UpdateParams_FullMethodName        = "/giltconsensusv2.gilt.Msg/UpdateParams"
	Msg_BackfillSpans_FullMethodName       = "/giltconsensusv2.gilt.Msg/BackfillSpans"
	Msg_VoteProducers_FullMethodName       = "/giltconsensusv2.gilt.Msg/VoteProducers"
	Msg_SetProducerDowntime_FullMethodName = "/giltconsensusv2.gilt.Msg/SetProducerDowntime"
)
...
//
// Msg defines the gRPC message service for the gilt module.
...
func (c *msgClient) ProposeSpan(ctx context.Context, in *MsgProposeSpan, opts ...grpc.CallOption) (*MsgProposeSpanResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_ProposeSpan_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BackfillSpans(ctx context.Context, in *MsgBackfillSpans, opts ...grpc.CallOption) (*MsgBackfillSpansResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_BackfillSpans_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) VoteProducers(ctx context.Context, in *MsgVoteProducers, opts ...grpc.CallOption) (*MsgVoteProducersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_VoteProducers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SetProducerDowntime(ctx context.Context, in *MsgSetProducerDowntime, opts ...grpc.CallOption) (*MsgSetProducerDowntimeResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_SetProducerDowntime_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
