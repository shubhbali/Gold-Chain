...
// GetGiltConsensusServerEndpoint returns giltconsensus server endpoint
func GetGiltConsensusServerEndpoint(endpoint string) string {
...
func GetInitialBlockHeight(chainID string) uint64 {
	...
	case gilttestnetChainID:
		return gilttestnetInitialBlockHeight
	default:
