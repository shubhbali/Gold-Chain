...
# RPC endpoint for gilt chain
gilt_rpc_url = "{{ .Custom.GiltRPCUrl }}"

# GRPC flag for gilt chain
gilt_grpc_flag = "{{ .Custom.GiltGRPCFlag }}"

# GRPC endpoint for gilt chain
gilt_grpc_url = "{{ .Custom.GiltGRPCUrl }}"

# RPC endpoint for cometBFT
comet_bft_rpc_url = "{{ .Custom.CometBFTRPCUrl }}"

# Gilt Sub Graph URL for self-heal mechanism (optional)
...
# Maximum number of goroutines before giltconsensus health check fails (0 = disabled)
max_goroutine_threshold = "{{ .Custom.MaxGoRoutineThreshold }}"

# Maximum number of goroutines before giltconsensus health check warns (0 = disabled)
warn_goroutine_threshold = "{{ .Custom.WarnGoRoutineThreshold }}"

# Minimum number of peers before giltconsensus health check fails (0 = disabled)
min_peer_threshold = "{{ .Custom.MinPeerThreshold }}"

# Minimum number of peers before giltconsensus health check warns (0 = disabled)
