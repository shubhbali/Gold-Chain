...
import (
	...
	erc20 "github.com/giltchain/gilt-consensus/contracts/erc20"

	mock "github.com/stretchr/testify/mock"

	rootchain "github.com/giltchain/gilt-consensus/contracts/rootchain"

	slashmanager "github.com/giltchain/gilt-consensus/contracts/slashmanager"

	stakemanager "github.com/giltchain/gilt-consensus/contracts/stakemanager"

	staketypes "github.com/giltchain/gilt-consensus/x/stake/types"

	stakinginfo "github.com/giltchain/gilt-consensus/contracts/stakinginfo"

	statereceiver "github.com/giltchain/gilt-consensus/contracts/statereceiver"

	statesender "github.com/giltchain/gilt-consensus/contracts/statesender"

	types "github.com/ethereum/go-ethereum/core/types"

	validatorset "github.com/giltchain/gilt-consensus/contracts/validatorset"
)
...
// GetGiltChainBlock provides a mock function with given fields: _a0, _a1
func (_m *IContractCaller) GetGiltChainBlock(_a0 context.Context, _a1 *big.Int) (*types.Header, error) {
	ret := _m.Called(_a0, _a1)

	if len(ret) == 0 {
		panic("no return value specified for GetGiltChainBlock")
	}
...
// GetGiltChainBlockAuthor provides a mock function with given fields: _a0
func (_m *IContractCaller) GetGiltChainBlockAuthor(_a0 *big.Int) (*common.Address, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for GetGiltChainBlockAuthor")
	}
...
func (_m *IContractCaller) GetGiltChainBlockTd(ctx context.Context, blockHash common.Hash) (uint64, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetGiltChainBlockTd")
	}
...
// GetGiltTxReceipt provides a mock function with given fields: _a0
func (_m *IContractCaller) GetGiltTxReceipt(_a0 common.Hash) (*types.Receipt, error) {
	ret := _m.Called(_a0)

	if len(ret) == 0 {
		panic("no return value specified for GetGiltTxReceipt")
	}
