...
func TestSetFeeDefaults(t *testing.T) {
	...
	tests := []test{
		...
		// gilt: skipping as it's not relevant to gilt
		/*
			{
...
func (b *backendMock) GetGiltBlockReceipt(ctx context.Context, hash common.Hash) (*types.Receipt, error) {
	//nolint:nilnil
	return nil, nil
}

func (b *backendMock) GetGiltBlockLogs(ctx context.Context, hash common.Hash) ([]*types.Log, error) {
	// nolint:nilnil
	return nil, nil
}

func (b *backendMock) GetGiltBlockTransaction(ctx context.Context, txHash common.Hash) (*types.Transaction, common.Hash, uint64, uint64, error) {
	return nil, common.Hash{}, 0, 0, nil
}

func (b *backendMock) GetGiltBlockTransactionWithBlockHash(ctx context.Context, txHash common.Hash, blockHash common.Hash) (*types.Transaction, common.Hash, uint64, uint64, error) {
	return nil, common.Hash{}, 0, 0, nil
}
