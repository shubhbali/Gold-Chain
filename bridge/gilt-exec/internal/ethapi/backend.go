...
type Backend interface {
	...
	GetGiltBlockReceipt(ctx context.Context, hash common.Hash) (*types.Receipt, error)
	GetGiltBlockLogs(ctx context.Context, hash common.Hash) ([]*types.Log, error)
	GetGiltBlockTransaction(ctx context.Context, txHash common.Hash) (*types.Transaction, common.Hash, uint64, uint64, error)
