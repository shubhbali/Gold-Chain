...
func (c *PeersCommand) MarkDown() string {
	items := []string{
		...
		"- [```peers list```](./peers_list.md): Lists the connected peers to the Gilt client.",
...
func (c *PeersCommand) Help() string {
	return `Usage: gilt peers <subcommand>
  ...
  Add a new peer by enode:
    ...
    $ gilt peers add <enode>

  Remove a connected peer by enode:

    $ gilt peers remove <enode>

  Display information about a peer:

    $ gilt peers status <peer id>`
}
