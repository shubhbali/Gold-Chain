...
var file_internal_cli_server_proto_server_proto_depIdxs = []int32{
	...
	6,  // 13: proto.Gilt.PeersAdd:input_type -> proto.PeersAddRequest
	8,  // 14: proto.Gilt.PeersRemove:input_type -> proto.PeersRemoveRequest
	10, // 15: proto.Gilt.PeersList:input_type -> proto.PeersListRequest
	12, // 16: proto.Gilt.PeersStatus:input_type -> proto.PeersStatusRequest
	15, // 17: proto.Gilt.ChainSetHead:input_type -> proto.ChainSetHeadRequest
	17, // 18: proto.Gilt.Status:input_type -> proto.StatusRequest
	3,  // 19: proto.Gilt.ChainWatch:input_type -> proto.ChainWatchRequest
	20, // 20: proto.Gilt.DebugPprof:input_type -> proto.DebugPprofRequest
	21, // 21: proto.Gilt.DebugBlock:input_type -> proto.DebugBlockRequest
	7,  // 22: proto.Gilt.PeersAdd:output_type -> proto.PeersAddResponse
	9,  // 23: proto.Gilt.PeersRemove:output_type -> proto.PeersRemoveResponse
	11, // 24: proto.Gilt.PeersList:output_type -> proto.PeersListResponse
	13, // 25: proto.Gilt.PeersStatus:output_type -> proto.PeersStatusResponse
	16, // 26: proto.Gilt.ChainSetHead:output_type -> proto.ChainSetHeadResponse
	18, // 27: proto.Gilt.Status:output_type -> proto.StatusResponse
	4,  // 28: proto.Gilt.ChainWatch:output_type -> proto.ChainWatchResponse
	22, // 29: proto.Gilt.DebugPprof:output_type -> proto.DebugFileResponse
	22, // 30: proto.Gilt.DebugBlock:output_type -> proto.DebugFileResponse
