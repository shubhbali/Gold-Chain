...
func (c *DumpconfigCommand) MarkDown() string {
	items := []string{
		"# Dumpconfig",
		"The ```gilt dumpconfig <your-favourite-flags>``` command will export the user provided flags into a configuration file",
	}
...
func (c *DumpconfigCommand) Help() string {
	return `Usage: gilt dumpconfig <your-favourite-flags>
...
func (c *DumpconfigCommand) Run(args []string) int {
	...
	userConfig.Chain = ""
	userConfig.Identity = ""
	userConfig.DataDir = "/var/lib/gilt-exec"
