...
var (
	...
	GiltTestnetLegacyFlag = &cli.BoolFlag{
		Name:   "gilt-gilttestnet-legacy",
		Usage:  "Deprecated alias for --gilt-gilttestnet",
		Hidden: true,
	}
	GiltTestnetFlag = &cli.BoolFlag{
		Name:  "gilt-gilttestnet",
		Usage: "Gilt testnet network: pre-configured proof-of-stake test network",
	}
	...
	GiltLogsFlag = &cli.BoolFlag{
		Name:  "gilt.logs",
		Usage: "Enable gilt logs retrieval",
	}
...
func RegisterFilterAPI(stack *node.Node, backend ethapi.Backend, ethcfg *ethconfig.Config) *filters.FilterSystem {
	...
	filterAPI := filters.NewFilterAPI(filterSystem, ethcfg.GiltLogs)
	stack.RegisterAPIs([]rpc.API{{
		Namespace: "eth",
		Service:   filters.NewFilterAPI(filterSystem, ethcfg.GiltLogs),
	}})
