...
var flagMap = map[string][]string{
	...
	"mainnet":                          {"BoolFlag", "No"},
	"goerli":                           {"BoolFlag", "No"},
	"gilt-gilttestnet-legacy":           {"BoolFlag", "No"},
	"gilt-gilttestnet":                  {"BoolFlag", "No"},
	"gilt-mainnet":                      {"BoolFlag", "No"},
	"sepolia":                          {"BoolFlag", "No"},
...
var nameTagMap = map[string]string{
	...
	"0-snapshot":              "snapshot",
	"\"gilt.logs\"":            "gilt.logs",
	"url":                     "gilt.giltconsensus",
	"timeout":                 "gilt.giltconsensustimeout",
	"\"gilt.without\"":         "gilt.withoutgiltconsensus",
	"grpc-address":            "gilt.giltconsensusgRPC",
	"\"gilt.rungiltconsensus\"":     "gilt.rungiltconsensus",
	"\"gilt.rungiltconsensusargs\"": "gilt.rungiltconsensusargs",
	...
	"lightkdf":                "lightkdf",
	"disable-gilt-wallet":      "disable-gilt-wallet",
	"addr":                    "grpc.addr",
	"dev":                     "dev",
	"period":                  "dev.period",
}
