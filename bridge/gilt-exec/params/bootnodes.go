...
// GiltTestnetLegacyBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// GiltTestnet test network.
var GiltTestnetLegacyBootnodes = []string{
...
// GiltTestnetBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// GiltTestnet test network.
var GiltTestnetBootnodes = []string{
...
// GiltMainnetBootnodes are the enode URLs of the P2P bootstrap nodes running on the
// main Gilt network.
var GiltMainnetBootnodes = []string{
...
func KnownDNSNetwork(genesis common.Hash, protocol string) string {
	...
	case GoerliGenesisHash:
		net = "goerli"
	case GiltTestnetLegacyGenesisHash:
		net = "gilttestnet"
	case GiltMainnetGenesisHash:
		net = "gilt-mainnet"
	case GiltTestnetGenesisHash:
		net = "gilttestnet"
