...
func NewEVMBlockContext(header *types.Header, chain ChainContext, author *common.Address) vm.BlockContext {
	...
	if author == nil {
		if chain.Config().Gilt != nil && chain.Config().Gilt.IsRio(header.Number) {
			beneficiary = common.HexToAddress(chain.Config().Gilt.CalculateCoinbase(header.Number.Uint64()))
