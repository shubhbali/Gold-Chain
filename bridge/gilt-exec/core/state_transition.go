...
func (st *stateTransition) preCheck() error {
	...
	isMadhugiri := st.evm.ChainConfig().Gilt != nil && st.evm.ChainConfig().Gilt.IsMadhugiri(st.evm.Context.BlockNumber)
...
func (st *stateTransition) execute() (*ExecutionResult, error) {
	...
	if rules.IsLondon {
		burntContractAddress = common.HexToAddress(st.evm.ChainConfig().Gilt.CalculateBurntContract(st.evm.Context.BlockNumber.Uint64()))
