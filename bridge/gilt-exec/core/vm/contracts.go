...
var PrecompiledContractsOsaka = PrecompiledContracts{
	...
	common.BytesToAddress([]byte{0x08}): &bn256PairingIstanbul{},
	common.BytesToAddress([]byte{0x09}): &blake2F{},
	// Note: Make sure to remove this (kzg) from gilt if we ever enable Osaka as is.
...
// contracts used in the Madhugiri release (gilt HF).
...
// contracts used in the MadhugiriPro release (gilt HF).
...
// contracts used in the Lisovo release (gilt HF).
...
// contracts used in the LisovoPro release (gilt HF).
