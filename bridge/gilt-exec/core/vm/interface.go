...
type StateDB interface {
	...
	SetBalance(common.Address, *uint256.Int, tracing.BalanceChangeReason) uint256.Int // Needed for gilt consensus
	...
	// Inner returns the underlying state instance. Needed for gilt consensus.
	Inner() *state.StateDB
}
