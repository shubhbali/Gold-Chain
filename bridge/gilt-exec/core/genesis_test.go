...
func testSetupGenesis(t *testing.T, scheme string) {
	...
	tests := []struct {
		...
		// gilt: hoodi expects a non-nil withdrawals hash
		/*
			{
...
func TestGenesisHashes(t *testing.T) {
	for i, c := range []struct {
		...
		{DefaultGiltMainnetGenesisBlock(), params.GiltMainnetGenesisHash},
		{DefaultGiltTestnetGenesisBlock(), params.GiltTestnetGenesisHash},
		{DefaultGiltTestnetLegacyGenesisBlock(), params.GiltTestnetLegacyGenesisHash},
	} {
		// Test via MustCommit
		db := rawdb.NewMemoryDatabase()
...
func TestVerkleGenesisCommit(t *testing.T) {
	t.Skip("verkle trie is not yet supported in gilt")
