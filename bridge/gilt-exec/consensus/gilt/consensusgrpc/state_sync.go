...
func (h *GiltConsensusGRPCClient) StateSyncEvents(ctx context.Context, fromID uint64, to int64) ([]*clerk.EventRecordWithTime, error) {
	...
	start := time.Now()
	ctx = giltconsensus.WithRequestType(globalCtx, giltconsensus.StateSyncRequest)
