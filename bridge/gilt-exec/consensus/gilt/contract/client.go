...
func (gc *GenesisContractsClient) LastStateId(state *state.StateDB, number uint64, hash common.Hash) (*big.Int, error) {
	...
	// GILT: Do a 'CallWithState' so that we can fetch the last state ID from a given (incoming)
