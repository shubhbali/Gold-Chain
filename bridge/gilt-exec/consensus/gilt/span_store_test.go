...
func (h *MockGiltConsensusClient) GetSpan(ctx context.Context, spanID uint64) (*types.Span, error) {
...
func (h *MockGiltConsensusClient) GetLatestSpan(ctx context.Context) (*types.Span, error) {
	return h.GetSpan(ctx, 2)
}

func (h *MockGiltConsensusClient) FetchStatus(ctx context.Context) (*ctypes.SyncInfo, error) {
	return &ctypes.SyncInfo{CatchingUp: false}, nil
}

func TestSpanStore_SpanById(t *testing.T) {
	spanStore := NewSpanStore(&MockGiltConsensusClient{}, nil, "1337")
...
func (h *MockGiltConsensusClient) StateSyncEvents(ctx context.Context, fromID uint64, to int64) ([]*clerk.EventRecordWithTime, error) {
	panic("implement me")
}

func (h *MockGiltConsensusClient) FetchCheckpoint(ctx context.Context, number int64) (*checkpoint.Checkpoint, error) {
	panic("implement me")
}

func (h *MockGiltConsensusClient) FetchCheckpointCount(ctx context.Context) (int64, error) {
	panic("implement me")
}

func (h *MockGiltConsensusClient) FetchMilestone(ctx context.Context) (*milestone.Milestone, error) {
	panic("implement me")
}

func (h *MockGiltConsensusClient) FetchMilestoneCount(ctx context.Context) (int64, error) {
	panic("implement me")
}

func (h *MockGiltConsensusClient) Close() {
	panic("implement me")
}

// MockOverlappingGiltConsensusClient simulates overlapping spans for testing
type MockOverlappingGiltConsensusClient struct {
	failGetLatestSpan bool
	latestSpanID      *uint64
}

func (h *MockOverlappingGiltConsensusClient) GetSpan(ctx context.Context, spanID uint64) (*types.Span, error) {
	// Create mock validators for testing
	validators := []*stakeTypes.Validator{
		{
			ValId:            1,
...
func (h *MockOverlappingGiltConsensusClient) GetLatestSpan(ctx context.Context) (*types.Span, error) {
...
// Implement interface methods for MockOverlappingGiltConsensusClient
func (h *MockOverlappingGiltConsensusClient) StateSyncEvents(ctx context.Context, fromID uint64, to int64) ([]*clerk.EventRecordWithTime, error) {
	panic("implement me")
}
func (h *MockOverlappingGiltConsensusClient) FetchCheckpoint(ctx context.Context, number int64) (*checkpoint.Checkpoint, error) {
	panic("implement me")
}
func (h *MockOverlappingGiltConsensusClient) FetchCheckpointCount(ctx context.Context) (int64, error) {
	panic("implement me")
}
func (h *MockOverlappingGiltConsensusClient) FetchMilestone(ctx context.Context) (*milestone.Milestone, error) {
	panic("implement me")
}
func (h *MockOverlappingGiltConsensusClient) FetchMilestoneCount(ctx context.Context) (int64, error) {
	panic("implement me")
}
func (h *MockOverlappingGiltConsensusClient) FetchNoAckMilestone(ctx context.Context, milestoneID string) error {
	panic("implement me")
}
func (h *MockOverlappingGiltConsensusClient) FetchLastNoAckMilestone(ctx context.Context) (string, error) {
	panic("implement me")
}
func (h *MockOverlappingGiltConsensusClient) FetchMilestoneID(ctx context.Context, milestoneID string) error {
	panic("implement me")
}
func (h *MockOverlappingGiltConsensusClient) Close() {
	panic("implement me")
}

func (h *MockOverlappingGiltConsensusClient) FetchStatus(ctx context.Context) (*ctypes.SyncInfo, error) {
	return &ctypes.SyncInfo{CatchingUp: false}, nil
}

func TestSpanStore_SpanByBlockNumber_OverlappingSpans(t *testing.T) {
	spanStore := NewSpanStore(&MockOverlappingGiltConsensusClient{}, nil, "1337")
	defer spanStore.Close()
	ctx := t.Context()
...
func TestSpanStore_GetFutureSpan(t *testing.T) {
	...
	type testCase struct {
		...
		mockClientSetup   func() IGiltConsensusClient
	...
	testCases := []testCase{
		{
			...
			latestKnownSpanID: 2,
			mockClientSetup: func() IGiltConsensusClient {
				return &MockOverlappingGiltConsensusClient{} // latest is 6
			},
			expectedSpanID: 4,
		},
		{
			...
			latestKnownSpanID: 0,
			mockClientSetup: func() IGiltConsensusClient {
				return &MockOverlappingGiltConsensusClient{}
			},
		...
		},
		{
			...
			latestKnownSpanID: 5,
			mockClientSetup: func() IGiltConsensusClient {
				return &MockOverlappingGiltConsensusClient{} // GetSpan(7) will fail by default, but we should return candidate
			},
			expectedSpanID: 6,
		},
		{
			...
			latestKnownSpanID: 6,
			mockClientSetup: func() IGiltConsensusClient {
				return &MockOverlappingGiltConsensusClient{latestSpanID: uintPtr(8)}
			},
			expectError:      true,
		...
		},
		{
			...
			latestKnownSpanID: 0,
			mockClientSetup: func() IGiltConsensusClient {
				return &MockOverlappingGiltConsensusClient{failGetLatestSpan: true}
			},
			expectError:      true,
		...
		},
		{
			...
			latestKnownSpanID: 6,
			mockClientSetup: func() IGiltConsensusClient {
				return &MockOverlappingGiltConsensusClient{} // latest span is 6
			},
			expectError:      true,
		...
		},
		{
			...
			latestKnownSpanID: 0,
			mockClientSetup: func() IGiltConsensusClient {
				return &MockOverlappingGiltConsensusClient{latestSpanID: uintPtr(0)}
			},
			expectError:      true,
...
func TestSpanStore_EstimateSpanId(t *testing.T) {
	spanStore := NewSpanStore(nil, nil, "1337") // GiltConsensus client and spanner not needed for this test
	defer spanStore.Close()

	// Mock lastUsedSpan for some test cases
	mockLastUsedSpan := func(id, startBlock, endBlock uint64) {
		spanStore.lastUsedSpan.Store(&giltTypes.Span{
			Id:         id,
	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.setupLastUsedSpan == nil {
				spanStore.lastUsedSpan = atomic.Pointer[giltTypes.Span]{}
			} else {
...
func TestGetMockSpan0(t *testing.T) {
	...
	t.Run("spanner_returns_error_from_giltconsensus", func(t *testing.T) {
		mockSpanner := NewMockSpanner(ctrl)
		expectedErr := fmt.Errorf("spanner error from giltconsensus")
...
func TestSpanStore_SetGiltConsensusClient(t *testing.T) {
	spanStore := NewSpanStore(nil, nil, "1337")
	defer spanStore.Close()

	require.Nil(t, spanStore.giltconsensusClient, "Initial giltconsensus client should be nil")

	mockClient := &MockGiltConsensusClient{}
	spanStore.setGiltConsensusClient(mockClient)

	require.Equal(t, mockClient, spanStore.giltconsensusClient, "GiltConsensus client not set correctly")
}
...
// dynamicGiltConsensusClient is a mock IGiltConsensusClient for testing waitForNewSpan.
// It allows dynamically changing the spans returned during a test.
type dynamicGiltConsensusClient struct {
	mu         sync.Mutex
...
func newDynamicGiltConsensusClient() *dynamicGiltConsensusClient {
	return &dynamicGiltConsensusClient{spans: make(map[uint64]*types.Span)}
}

func (d *dynamicGiltConsensusClient) GetSpan(ctx context.Context, spanID uint64) (*types.Span, error) {
	d.mu.Lock()
	defer d.mu.Unlock()
...
func (d *dynamicGiltConsensusClient) GetLatestSpan(ctx context.Context) (*types.Span, error) {
	d.mu.Lock()
	defer d.mu.Unlock()
...
func (d *dynamicGiltConsensusClient) setSpans(spans map[uint64]*types.Span, latestSpan *types.Span) {
	d.mu.Lock()
	defer d.mu.Unlock()
	d.spans = spans
...
func (d *dynamicGiltConsensusClient) setError(err error) {
	d.mu.Lock()
	defer d.mu.Unlock()
	d.fetchErr = err
}

func (d *dynamicGiltConsensusClient) StateSyncEvents(ctx context.Context, fromID uint64, to int64) ([]*clerk.EventRecordWithTime, error) {
	panic("not implemented")
}
func (d *dynamicGiltConsensusClient) FetchCheckpoint(ctx context.Context, number int64) (*checkpoint.Checkpoint, error) {
	panic("not implemented")
}
func (d *dynamicGiltConsensusClient) FetchCheckpointCount(ctx context.Context) (int64, error) {
	panic("not implemented")
}
func (d *dynamicGiltConsensusClient) FetchMilestone(ctx context.Context) (*milestone.Milestone, error) {
	panic("not implemented")
}
func (d *dynamicGiltConsensusClient) FetchMilestoneCount(ctx context.Context) (int64, error) {
	panic("not implemented")
}
func (d *dynamicGiltConsensusClient) FetchNoAckMilestone(ctx context.Context, milestoneID string) error {
	panic("not implemented")
}
func (d *dynamicGiltConsensusClient) FetchLastNoAckMilestone(ctx context.Context) (string, error) {
	panic("not implemented")
}
func (d *dynamicGiltConsensusClient) FetchMilestoneID(ctx context.Context, milestoneID string) error {
	panic("not implemented")
}
func (d *dynamicGiltConsensusClient) Close() {}

func (d *dynamicGiltConsensusClient) FetchStatus(ctx context.Context) (*ctypes.SyncInfo, error) {
	return &ctypes.SyncInfo{CatchingUp: false}, nil
}
...
// MockSyncStatusClient allows testing of waitUntilGiltConsensusIsSynced
...
func TestSpanStore_WaitUntilGiltConsensusIsSynced(t *testing.T) {
	t.Run("giltconsensus already synced", func(t *testing.T) {
		...
		// Call spanByBlockNumber which internally calls waitUntilGiltConsensusIsSynced
		...
		require.NoError(t, err)
		require.NotNil(t, span)
		require.Less(t, elapsed, 100*time.Millisecond, "Should not wait when giltconsensus is synced")
	})

	t.Run("giltconsensus catching up then synced", func(t *testing.T) {
		mockClient := &MockSyncStatusClient{}
		...
		// This should wait until giltconsensus is synced
		span, err := spanStore.spanByBlockNumber(t.Context(), 100)
		...
		require.NoError(t, err)
		require.NotNil(t, span)
		require.Greater(t, elapsed, 400*time.Millisecond, "Should wait for giltconsensus to sync")
	...
	t.Run("nil sync status then synced", func(t *testing.T) {
		...
		// This should wait until giltconsensus status is available and synced
		span, err := spanStore.spanByBlockNumber(t.Context(), 100)
		...
		require.NoError(t, err)
		require.NotNil(t, span)
		require.Greater(t, elapsed, 400*time.Millisecond, "Should wait for giltconsensus status")
		require.Less(t, elapsed, 800*time.Millisecond, "Should not wait too long")
	})
...
func TestSpanStore_WaitForNewSpan(t *testing.T) {
	...
	t.Run("success on first try", func(t *testing.T) {
		client := newDynamicGiltConsensusClient()
	...
	t.Run("error from giltconsensus", func(t *testing.T) {
		client := newDynamicGiltConsensusClient()
		expectedErr := fmt.Errorf("giltconsensus connection error")
...
// TimeoutGiltConsensusClient simulates a giltconsensus client that times out or hangs on requests
type TimeoutGiltConsensusClient struct {
	timeout        time.Duration
	shouldTimeout  atomic.Bool
	shouldHangSpan atomic.Bool
}

func (h *TimeoutGiltConsensusClient) GetSpan(ctx context.Context, spanID uint64) (*types.Span, error) {
...
func (h *TimeoutGiltConsensusClient) GetLatestSpan(ctx context.Context) (*types.Span, error) {
...
func (h *TimeoutGiltConsensusClient) FetchStatus(ctx context.Context) (*ctypes.SyncInfo, error) {
	if h.shouldTimeout.Load() {
		select {
		case <-ctx.Done():
			return nil, ctx.Err()
...
func (h *TimeoutGiltConsensusClient) StateSyncEvents(ctx context.Context, fromID uint64, to int64) ([]*clerk.EventRecordWithTime, error) {
	panic("not implemented")
}
func (h *TimeoutGiltConsensusClient) FetchCheckpoint(ctx context.Context, number int64) (*checkpoint.Checkpoint, error) {
	panic("not implemented")
}
func (h *TimeoutGiltConsensusClient) FetchCheckpointCount(ctx context.Context) (int64, error) {
	panic("not implemented")
}
func (h *TimeoutGiltConsensusClient) FetchMilestone(ctx context.Context) (*milestone.Milestone, error) {
	panic("not implemented")
}
func (h *TimeoutGiltConsensusClient) FetchMilestoneCount(ctx context.Context) (int64, error) {
	panic("not implemented")
}
func (h *TimeoutGiltConsensusClient) Close() {}

func TestSpanStore_GiltConsensusDownTimeout(t *testing.T) {
	t.Run("giltconsensusStatus set to nil on FetchStatus error", func(t *testing.T) {
		// Create a client that will fail on FetchStatus
		mockClient := &TimeoutGiltConsensusClient{
		...
		spanStore.giltconsensusStatus.Store(&ctypes.SyncInfo{CatchingUp: false})

		// Now call updateGiltConsensusStatus with a context that will cause FetchStatus to fail
		ctx, cancel := context.WithTimeout(t.Context(), 100*time.Millisecond)
		defer cancel()

		err := spanStore.updateGiltConsensusStatus(ctx)

		// Should return an error
		require.Error(t, err)

		// giltconsensusStatus should be set to nil after the error
		status := spanStore.giltconsensusStatus.Load()
		require.Nil(t, status, "giltconsensusStatus should be nil after FetchStatus error")
	})

	t.Run("background goroutine sets giltconsensusStatus to nil on persistent errors", func(t *testing.T) {
		...
		// giltconsensusStatus should be nil after the error
		status = spanStore.giltconsensusStatus.Load()
		require.Nil(t, status, "giltconsensusStatus should be nil after FetchStatus starts failing")
