...
func ApplyMessage(
	...
	validatorContract := common.HexToAddress(chainConfig.Gilt.ValidatorContract)
...
func ApplyGiltMessage(vmenv *vm.EVM, msg Callmsg) (*core.ExecutionResult, error) {
	initialGas := msg.Gas()
