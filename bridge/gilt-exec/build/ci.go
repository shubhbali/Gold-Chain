...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/giltchain/gilt-exec/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/giltchain/gilt-exec/internal/version.gitDate="+env.Date)
	}
