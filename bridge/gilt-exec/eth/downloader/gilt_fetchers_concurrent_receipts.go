...
func (q *receiptQueue) kind() queueKind { return receiptQueueKind }
...
func (q *receiptQueue) deliver(peer *peerConnection, packet *eth.Response) (int, error) {
	...
	receipts, getReceiptListHashes := eth.EncodeReceiptsAndPrepareHasher(packet.Res, q.queue.giltConfig)
