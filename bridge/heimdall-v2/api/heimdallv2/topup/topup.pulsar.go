...
func init() {
	...
	md_AccountProof = File_heimdallv2_topup_topup_proto.Messages().ByName("AccountProof")
...
func (x *AccountProof) slowProtoReflect() protoreflect.Message {
	mi := &file_heimdallv2_topup_topup_proto_msgTypes[0]
...
func (x *fastReflection_AccountProof) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "heimdallv2.topup.AccountProof.address":
		return x.Address != ""
	case "heimdallv2.topup.AccountProof.account_proof":
		return len(x.AccountProof) != 0
	case "heimdallv2.topup.AccountProof.index":
		return x.Index != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: heimdallv2.topup.AccountProof"))
		}
		panic(fmt.Errorf("message heimdallv2.topup.AccountProof does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_AccountProof) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message heimdallv2.topup.AccountProof does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_AccountProof) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "heimdallv2.topup.AccountProof.address":
		panic(fmt.Errorf("field address of message heimdallv2.topup.AccountProof is not mutable"))
	case "heimdallv2.topup.AccountProof.account_proof":
		panic(fmt.Errorf("field account_proof of message heimdallv2.topup.AccountProof is not mutable"))
	case "heimdallv2.topup.AccountProof.index":
		panic(fmt.Errorf("field index of message heimdallv2.topup.AccountProof is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: heimdallv2.topup.AccountProof"))
		}
...
func (x *fastReflection_AccountProof) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in heimdallv2.topup.AccountProof", d.FullName()))
	}
	panic("unreachable")
}
...
func (*AccountProof) Descriptor() ([]byte, []int) {
	return file_heimdallv2_topup_topup_proto_rawDescGZIP(), []int{0}
}
...
var file_heimdallv2_topup_topup_proto_rawDesc = []byte{
...
var (
	file_heimdallv2_topup_topup_proto_rawDescOnce sync.Once
	file_heimdallv2_topup_topup_proto_rawDescData = file_heimdallv2_topup_topup_proto_rawDesc
)

func file_heimdallv2_topup_topup_proto_rawDescGZIP() []byte {
	file_heimdallv2_topup_topup_proto_rawDescOnce.Do(func() {
		file_heimdallv2_topup_topup_proto_rawDescData = protoimpl.X.CompressGZIP(file_heimdallv2_topup_topup_proto_rawDescData)
	})
	return file_heimdallv2_topup_topup_proto_rawDescData
}

var file_heimdallv2_topup_topup_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_heimdallv2_topup_topup_proto_goTypes = []interface{}{
	(*AccountProof)(nil), // 0: heimdallv2.topup.AccountProof
}
var file_heimdallv2_topup_topup_proto_depIdxs = []int32{
...
func init() { file_heimdallv2_topup_topup_proto_init() }
func file_heimdallv2_topup_topup_proto_init() {
	if File_heimdallv2_topup_topup_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_heimdallv2_topup_topup_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_heimdallv2_topup_topup_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_heimdallv2_topup_topup_proto_goTypes,
		DependencyIndexes: file_heimdallv2_topup_topup_proto_depIdxs,
		MessageInfos:      file_heimdallv2_topup_topup_proto_msgTypes,
	}.Build()
	File_heimdallv2_topup_topup_proto = out.File
	file_heimdallv2_topup_topup_proto_rawDesc = nil
	file_heimdallv2_topup_topup_proto_goTypes = nil
	file_heimdallv2_topup_topup_proto_depIdxs = nil
}
