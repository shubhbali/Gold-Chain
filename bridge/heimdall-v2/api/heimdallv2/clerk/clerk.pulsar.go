...
var (
	...
	fd_EventRecord_bor_chain_id protoreflect.FieldDescriptor
...
func init() {
	...
	fd_EventRecord_bor_chain_id = md_EventRecord.Fields().ByName("bor_chain_id")
...
func (x *fastReflection_EventRecord) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.BorChainId != "" {
		...
		if !f(fd_EventRecord_bor_chain_id, value) {
			return
		}
	}
	if x.RecordTime != nil {
...
func (x *fastReflection_EventRecord) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "heimdallv2.clerk.EventRecord.id":
	...
	case "heimdallv2.clerk.EventRecord.bor_chain_id":
		return x.BorChainId != ""
...
func (x *fastReflection_EventRecord) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "heimdallv2.clerk.EventRecord.id":
		panic(fmt.Errorf("field id of message heimdallv2.clerk.EventRecord is not mutable"))
	case "heimdallv2.clerk.EventRecord.contract":
		panic(fmt.Errorf("field contract of message heimdallv2.clerk.EventRecord is not mutable"))
	case "heimdallv2.clerk.EventRecord.data":
		panic(fmt.Errorf("field data of message heimdallv2.clerk.EventRecord is not mutable"))
	case "heimdallv2.clerk.EventRecord.tx_hash":
	...
	case "heimdallv2.clerk.EventRecord.bor_chain_id":
		panic(fmt.Errorf("field bor_chain_id of message heimdallv2.clerk.EventRecord is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: heimdallv2.clerk.EventRecord"))
		}
...
var file_heimdallv2_clerk_clerk_proto_depIdxs = []int32{
	1, // 0: heimdallv2.clerk.EventRecord.record_time:type_name -> google.protobuf.Timestamp
