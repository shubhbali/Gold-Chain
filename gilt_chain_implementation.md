# Gilt Chain Implementation Strategy
...
12. Regenerate/update stake ABI used by `gilt-chain/consensus/parlia/abi.go`.
13. Update hardfork/system contract packaging in `gilt-chain/core/systemcontracts/upgrade.go`.
