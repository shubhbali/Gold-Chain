...
contract TendermintLightClient is ILightClient, System, IParamSubscriber {
    ...
    uint64 public constant INIT_HEIGHT = 110186855;
    uint64 public constant INIT_SYNCED_HEIGHT = 255787329;
    ...
    function init() external onlyNotInit {
        ...
        initialHeight = INIT_HEIGHT;
        latestHeight = INIT_SYNCED_HEIGHT;
        submitters[INIT_SYNCED_HEIGHT] = address(0x1);
        alreadyInit = true;
