...
import "./utils/interface/IGiltValidatorSetTool.sol";

contract ToolTest is Test {
    GiltValidatorSetTool public tool;

    function setUp() public {
        // deploy tool contract
        address toolAddr = deployCode("GiltValidatorSetTool.sol");
        tool = GiltValidatorSetTool(toolAddr);
        vm.label(toolAddr, "GiltValidatorSetTool");
    }
