...
interface StakeCredit {
    ...
    function lockedGILTs(address delegator, uint256 number) external view returns (uint256);
    ...
    function totalPooledGILTRecord(uint256) external view returns (uint256);
    function totalSupply() external view returns (uint256);
    function transfer(address to, uint256 amount) external returns (bool);
    function transferFrom(address from, address to, uint256 amount) external returns (bool);
    function unbond(address delegator, uint256 shares) external returns (uint256 giltAmount);
    ...
    function undelegate(address delegator, uint256 shares) external returns (uint256 giltAmount);
