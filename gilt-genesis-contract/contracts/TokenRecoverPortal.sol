...
contract TokenRecoverPortal is SystemV2, Initializable, ReentrancyGuardUpgradeable, Protectable {
    ...
    /**
     * For the Beacon Chain account whose funds are not transferred to GILT before BC fusion,
     * can still invoke this function to recover funds on the GILT network.
