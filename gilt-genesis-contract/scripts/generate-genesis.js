...
program.option(
  '--initLockedGILTOnTokenHub <initLockedGILTOnTokenHub>',
  'initLockedGILTOnTokenHub',
...
// compile files
Promise.all([
  readByteCode('validatorContract', 'out/GiltValidatorSet.sol/GiltValidatorSet.json'),
  ...
  readByteCode('governor', 'out/GiltGovernor.sol/GiltGovernor.json'),
  readByteCode('govToken', 'out/GovToken.sol/GovToken.json'),
  readByteCode('timelock', 'out/GiltTimelock.sol/GiltTimelock.json'),
  ...
  const data = {
    initLockedGILTOnTokenHub: program.initLockedGILTOnTokenHub,
