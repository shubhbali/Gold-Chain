...
def generate_system():
    ...
    replace_parameter(contract, "uint16 public constant giltChainID", f"0x{hex_chain_id}")
...
@main.command(help="Generate contracts for Gilt Chain mainnet")
def mainnet():
    ...
    source_chain_id = "Gilt-Chain-Mainnet"
...
@main.command(help="Generate contracts for Gilt Chain testnet")
def testnet():
    global network, chain_id, hex_chain_id
    network = "testnet"
    chain_id = 97
    ...
    source_chain_id = "Gilt-Chain-Testnet"
...
def dev(
    ...
    init_burn_ratio: Annotated[str, typer.Option(help="init burn ratio of validator set contract")] = "1000",
    source_chain_id: Annotated[
        str, typer.Option(help="source chain id of the token recover portal")] = "Gilt-Chain-Testnet",
    ...
    propose_start_threshold: Annotated[
        str, typer.Option(help="PROPOSE_START_GOVBNB_SUPPLY_THRESHOLD / PROPOSE_START_GILT_SUPPLY_THRESHOLD of Governor")
    ] = "10_000_000 ether",
