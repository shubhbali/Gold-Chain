...
//   protoc               v4.23.4
// source: v1/points-admin.proto

/* eslint-disable */
import {
  type GetUserBalancesResponse,
...
export interface PointsAdminService {
  ...
  AdminUpdateCustomReferralCode(
    request: AdminUpdateCustomReferralCodeRequest,
  ): Promise<AdminUpdateCustomReferralCodeResponse>;
  AdminGetCustomReferralCodes(
    request: AdminGetCustomReferralCodesRequest,
  ): Promise<AdminGetCustomReferralCodesResponse>;
}
