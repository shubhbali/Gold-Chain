...
//   protoc               v4.23.4
// source: v1/points-backend.proto
...
export interface RewardsConfig {
  ...
  streak_bonuses: { [key: string]: string };
  sent_transactions_activity_rewards: { [key: string]: string };
  verified_contracts_activity_rewards: { [key: string]: string };
  goldscan_usage_activity_rewards: { [key: string]: string };
