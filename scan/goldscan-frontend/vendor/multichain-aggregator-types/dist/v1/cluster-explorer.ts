...
import {
  type Chain,
  type ChainBlockNumber,
  type Domain,
  type Hash,
  type MarketplaceDapp,
  type Pagination,
  type ProtocolInfo,
  type TokenType,
} from "./multichain-aggregator";
...
export interface InteropMessage {
  ...
  message_type: string;
  method: string;
  decoded_payload?: { [key: string]: any } | undefined;
}

export enum InteropMessage_Status {
  PENDING = "PENDING",
  FAILED = "FAILED",
  SUCCESS = "SUCCESS",
  EXPIRED = "EXPIRED",
...
export interface AggregatedTokenInfo {
  ...
  chain_infos: { [key: string]: AggregatedTokenInfo_ChainInfo };
}
...
export interface AddressPortfolio {
  total_value: string;
  chain_values: { [key: string]: string };
}
...
export interface GetAddressResponse {
  hash: string;
  /** Map of chain id to chain-specific information. */
  chain_infos: { [key: string]: GetAddressResponse_ChainInfo };
  has_tokens: boolean;
