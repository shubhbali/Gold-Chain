...
import * as bens from '@goldchain-scan/bens-types';

import { route } from 'nextjs-routes';

import config from 'configs/app';
import { getProtocolExplorerBaseUrl } from 'lib/nameServices/protocol';
    ...
    <>
      ...
      <DetailedInfo.Container>
        ...
        { query.data?.tokens.map((token) => {
          const protocolBaseUrl = stripTrailingSlash(getProtocolExplorerBaseUrl(query.data.protocol));
          const isProtocolBaseChain = protocolBaseUrl === config.app.baseUrl;
          const entityProps = {
