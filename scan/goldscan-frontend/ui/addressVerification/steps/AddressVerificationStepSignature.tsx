...
const AddressVerificationStepSignature = ({ address, signingMessage, contractCreator, contractOwner, onContinue, noWeb3Provider }: Props) => {
  ...
  const contactUsLink = <span>contact us <Link href="mailto:help@goldscan.com" rel="noopener noreferrer">help@goldscan.com</Link></span>;
  ...
  return (
    <FormProvider { ...formApi }>
      <form noValidate onSubmit={ onSubmit }>
        ...
        <Box mb={ 8 }>
          <span>Please select the address to sign and copy the message and sign it using the GoldScan message provider of your choice. </span>
          <Link href="https://docs.scan.giltchain.com/using-goldscan/my-account/verified-addresses/copy-and-sign-message" external noIcon>
