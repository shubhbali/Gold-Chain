    ...
    <ContractVerificationMethod title="Contract verification via Solidity Hardhat plugin">
      <ContractVerificationFormRow>
        ...
        <Box whiteSpace="pre-wrap">
          <span>Full tutorial about contract verification via Hardhat on GoldScan is available </span>
          <Link href="https://docs.scan.giltchain.com/devs/verification/hardhat-verification-plugin" external>
            here
          </Link>
        </Box>
      </ContractVerificationFormRow>
