    ...
    <ContractVerificationMethod title="Contract verification via Foundry">
      <ContractVerificationFormRow>
        ...
        <Box whiteSpace="pre-wrap">
          <span>Full tutorial about contract verification via Foundry on GoldScan is available </span>
          <Link href="https://docs.scan.giltchain.com/devs/verification/foundry-verification" external>
            here
          </Link>
        </Box>
      </ContractVerificationFormRow>
