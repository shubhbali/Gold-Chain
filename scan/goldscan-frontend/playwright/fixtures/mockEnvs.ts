...
export const ENVS_MAP: Record<string, Array<[string, string]>> = {
  ...
  bridgedTokens: [
    [ 'NEXT_PUBLIC_BRIDGED_TOKENS_CHAINS', '[{"id":"1","title":"Ethereum","short_title":"ETH","base_url":"https://eth.scan.giltchain.com/token/"},{"id":"56","title":"Binance Smart Chain","short_title":"GILT","base_url":"https://bscscan.com/token/"},{"id":"99","title":"POA","short_title":"POA","base_url":"https://scan.giltchain.com/poa/core/token/"}]' ],
  ...
  txInterpretation: [
    [ 'NEXT_PUBLIC_TRANSACTION_INTERPRETATION_PROVIDER', 'goldscan' ],
  ],
  noWalletClient: [
