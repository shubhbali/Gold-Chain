...
// const EXPLORER_URLS = [
//   'https://optimism.scan.giltchain.com',
//   'https://base.scan.giltchain.com',
//   'https://arbitrum.scan.giltchain.com',
//   'https://unichain.scan.giltchain.com',
//   'https://explorer.redstone.xyz',
//   'https://matchscan.io'
//   // 'https://optimism-interop-alpha-0.scan.giltchain.com',
//   // 'https://optimism-interop-alpha-1.scan.giltchain.com',
// ];
...
async function getChainscoutInfo(chainIds: Array<string>) {
  ...
  try {
    const response = await fetch(`https://chains.scan.giltchain.com/api/chains?chain_ids=${ chainIds.join(',') }`, { signal: controller.signal });
    if (!response.ok) {
