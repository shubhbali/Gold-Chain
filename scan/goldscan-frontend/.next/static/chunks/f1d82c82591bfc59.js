(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,846880,e=>{"use strict";e.i(588984);var t=e.i(399702),r=e.i(872857);e.i(759703);var i=e.i(392074),o=e.i(938559),a=e.i(118827);let s=a.css`
  :host {
    display: block;
...
`;var l=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let n=class extends t.LitElement{constructor(){super(...arguments),this.width="",this.height="",this.borderRadius="m",this.variant="default"}render(){return this.style.cssText=`
      width: ${this.width};
      height: ${this.height};
      border-radius: clamp(0px,var(--wui-border-radius-${this.borderRadius}), 40px);
    `,r.html`<slot></slot>`}};n.styles=[s],l([(0,i.property)()],n.prototype,"width",void 0),l([(0,i.property)()],n.prototype,"height",void 0),l([(0,i.property)()],n.prototype,"borderRadius",void 0),l([(0,i.property)()],n.prototype,"variant",void 0),n=l([(0,o.customElement)("wui-shimmer")],n),e.s([],846880)},211366,e=>{"use strict";e.i(846880),e.s([])},229581,675164,231971,e=>{"use strict";var t=e.i(138230),r=e.i(596590),i=e.i(207176),o=e.i(729702),a=e.i(881936),s=e.i(375054),l=e.i(944396),n=e.i(301847),c=e.i(148018);async function h(){s.RouterController.push("ConnectingFarcaster");let e=o.ConnectorController.getAuthConnector();if(e&&!r.AccountController.state.farcasterUrl)try{let{url:t}=await e.provider.getFarcasterUri();r.AccountController.setFarcasterUrl(t,i.ChainController.state.activeChain)}catch(e){s.RouterController.goBack(),l.SnackController.showError(e)}}async function u(e){s.RouterController.push("ConnectingSocial");let a=o.ConnectorController.getAuthConnector(),h=null;try{let o=setTimeout(()=>{throw Error("Social login timed out. Please try again.")},45e3);if(a&&e){if(n.CoreHelperUtil.isTelegram()||(h=function(){try{return n.CoreHelperUtil.returnOpenHref(`${t.ConstantsUtil.SECURE_SITE_SDK_ORIGIN}/loading`,"popupWindow","width=600,height=800,scrollbars=yes")}catch(e){throw Error("Could not open social popup")}}()),h)r.AccountController.setSocialWindow(h,i.ChainController.state.activeChain);else if(!n.CoreHelperUtil.isTelegram())throw Error("Could not create social popup");let{uri:s}=await a.provider.getSocialRedirectUri({provider:e});if(!s)throw h?.close(),Error("Could not fetch the social redirect uri");if(h&&(h.location.href=s),n.CoreHelperUtil.isTelegram()){c.StorageUtil.setTelegramSocialProvider(e);let t=n.CoreHelperUtil.formatTelegramSocialLoginUrl(s);n.CoreHelperUtil.openHref(t,"_top")}clearTimeout(o)}}catch(e){h?.close(),l.SnackController.showError(e?.message)}}async function d(e){r.AccountController.setSocialProvider(e,i.ChainController.state.activeChain),a.EventsController.sendEvent({type:"track",event:"SOCIAL_LOGIN_STARTED",properties:{provider:e}}),"farcaster"===e?await h():await u(e)}e.s(["executeSocialLogin",()=>d],229581),e.i(588984);var p=e.i(399702),m=e.i(872857);e.i(759703);var f=e.i(392074);e.i(781840);var g=e.i(86988);e.i(596548);var v=e.i(864429),b=e.i(938559),w=p;e.i(630572);var y=e.i(118827);let C=y.css`
  :host {
    display: flex;
...
`;var x=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let k=class extends w.LitElement{constructor(){super(...arguments),this.logo="google"}render(){return m.html`<wui-icon color="inherit" size="inherit" name=${this.logo}></wui-icon> `}};k.styles=[v.resetStyles,C],x([(0,f.property)()],k.prototype,"logo",void 0),k=x([(0,b.customElement)("wui-logo")],k),e.s([],675164);let P=y.css`
  button {
...
`;var j=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let E=class extends p.LitElement{constructor(){super(...arguments),this.logo="google",this.name="Continue with google",this.align="left",this.disabled=!1}render(){return m.html`
    ...
    `}templatePlacement(){return"center"===this.align?m.html` <wui-logo class="invisible" logo=${this.logo}></wui-logo>`:null}};E.styles=[v.resetStyles,v.elementStyles,P],j([(0,f.property)()],E.prototype,"logo",void 0),j([(0,f.property)()],E.prototype,"name",void 0),j([(0,f.property)()],E.prototype,"align",void 0),j([(0,f.property)()],E.prototype,"tabIdx",void 0),j([(0,f.property)({type:Boolean})],E.prototype,"disabled",void 0),E=j([(0,b.customElement)("wui-list-social")],E),e.s([],231971)},143880,e=>{"use strict";e.i(588984);var t=e.i(399702),r=e.i(872857);e.i(759703);var i=e.i(392074);e.i(630572),e.i(287940);var o=e.i(520209);function a(e,t,r){return e!==t&&(e-t<0?t-e:e-t)<=r+.1}let s={generate({uri:e,size:t,logoSize:i,dotColor:s="#141414"}){let l,n,c=[],h=(n=Math.sqrt((l=Array.prototype.slice.call(o.default.create(e,{errorCorrectionLevel:"Q"}).modules.data,0)).length),l.reduce((e,t,r)=>(r%n==0?e.push([t]):e[e.length-1].push(t))&&e,[])),u=t/h.length,d=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];d.forEach(({x:e,y:t})=>{let i=(h.length-7)*u*e,o=(h.length-7)*u*t;for(let e=0;e<d.length;e+=1){let t=u*(7-2*e);c.push(r.svg`
            <rect
              ...
              y= ${0===e?i+u*e+2.5:i+u*e}
            />
          `)}});let p=Math.floor((i+25)/u),m=h.length/2-p/2,f=h.length/2+p/2-1,g=[];h.forEach((e,t)=>{e.forEach((e,r)=>{!h[t][r]||t<7&&r<7||t>h.length-8&&r<7||t<7&&r>h.length-8||t>m&&t<f&&r>m&&r<f||g.push([t*u+u/2,r*u+u/2])})});let v={};return g.forEach(([e,t])=>{v[e]?v[e]?.push(t):v[e]=[t]}),Object.entries(v).map(([e,t])=>{let r=t.filter(e=>t.every(t=>!a(e,t,u)));return[Number(e),r]}).forEach(([e,t])=>{t.forEach(t=>{c.push(r.svg`<circle cx=${e} cy=${t} fill=${s} r=${u/2.5} />`)})}),Object.entries(v).filter(([e,t])=>t.length>1).map(([e,t])=>{let r=t.filter(e=>t.some(t=>a(e,t,u)));return[Number(e),r]}).map(([e,t])=>{t.sort((e,t)=>e<t?-1:1);let r=[];for(let e of t){let t=r.find(t=>t.some(t=>a(e,t,u)));t?t.push(e):r.push([e])}return[e,r.map(e=>[e[0],e[e.length-1]])]}).forEach(([e,t])=>{t.forEach(([t,i])=>{c.push(r.svg`
              <line
                x1=${e}
                x2=${e}
                y1=${t}
              ...
              />
            `)})}),c}};var l=e.i(864429),n=e.i(938559),c=e.i(118827);let h=c.css`
  :host {
    position: relative;
    user-select: none;
    display: block;
...
`;var u=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let d=class extends t.LitElement{constructor(){super(...arguments),this.uri="",this.size=0,this.theme="dark",this.imageSrc=void 0,this.alt=void 0,this.arenaClear=void 0,this.farcaster=void 0}render(){return this.dataset.theme=this.theme,this.dataset.clear=String(this.arenaClear),this.style.cssText=`
    ...
    `}templateVisual(){return this.imageSrc?r.html`<wui-image src=${this.imageSrc} alt=${this.alt??"logo"}></wui-image>`:this.farcaster?r.html`<wui-icon
        ...
        color="inherit"
        name="farcaster"
      ></wui-icon>`:r.html`<wui-icon size="inherit" color="inherit" name="walletConnect"></wui-icon>`}};d.styles=[l.resetStyles,h],u([(0,i.property)()],d.prototype,"uri",void 0),u([(0,i.property)({type:Number})],d.prototype,"size",void 0),u([(0,i.property)()],d.prototype,"theme",void 0),u([(0,i.property)()],d.prototype,"imageSrc",void 0),u([(0,i.property)()],d.prototype,"alt",void 0),u([(0,i.property)()],d.prototype,"color",void 0),u([(0,i.property)({type:Boolean})],d.prototype,"arenaClear",void 0),u([(0,i.property)({type:Boolean})],d.prototype,"farcaster",void 0),d=u([(0,n.customElement)("wui-qr-code")],d),e.s([],143880)},155284,e=>{"use strict";e.s(["REOWN_URL",0,"https://reown.com","numbersRegex",0,/[0-9,.]/u,"specialCharactersRegex",0,/[.*+?^${}()|[\]\\]/gu])},353612,e=>{"use strict";e.i(588984);var t=e.i(399702),r=e.i(872857);e.i(759703);var i=e.i(392074),o=e.i(864429),a=e.i(938559),s=e.i(118827);let l=s.css`
  :host {
    display: block;
...
`;var n=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let c=class extends t.LitElement{constructor(){super(...arguments),this.radius=36}render(){return this.svgLoaderTemplate()}svgLoaderTemplate(){let e=this.radius>50?50:this.radius,t=36-e;return r.html`
...
`;var v=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let b=class extends h.LitElement{constructor(){super(...arguments),this.inputElementRef=(0,p.createRef)(),this.checked=void 0}render(){return s.html`
      <label>
        <input
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("checkboxChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};b.styles=[m.resetStyles,g],v([(0,u.property)({type:Boolean})],b.prototype,"checked",void 0),b=v([(0,c.customElement)("wui-checkbox")],b),e.i(331658);let w=f.css`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`;var y=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let C=class extends a.LitElement{constructor(){super(),this.unsubscribe=[],this.checked=o.state.isLegalCheckboxChecked,this.unsubscribe.push(o.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=n.OptionsController.state,r=n.OptionsController.state.features?.legalCheckbox;return(e||t)&&r?s.html`
      <wui-checkbox
    ...
    `:null}andTemplate(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=n.OptionsController.state;return e&&t?"and":""}termsTemplate(){let{termsConditionsUrl:e}=n.OptionsController.state;return e?s.html`<a rel="noreferrer" target="_blank" href=${e}>terms of service</a>`:null}privacyTemplate(){let{privacyPolicyUrl:e}=n.OptionsController.state;return e?s.html`<a rel="noreferrer" target="_blank" href=${e}>privacy policy</a>`:null}onCheckboxChange(){o.setIsLegalCheckboxChecked(!this.checked)}};C.styles=[w],y([(0,l.state)()],C.prototype,"checked",void 0),C=y([(0,c.customElement)("w3m-legal-checkbox")],C),e.s([],451801);var x=a;e.i(237029);var k=a;e.i(596548),e.i(108476);var P=e.i(155284);let j=f.css`
  .reown-logo {
...
`,E=class extends k.LitElement{render(){return s.html`
      <a
    ...
    `}};E.styles=[m.resetStyles,m.elementStyles,j],E=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s}([(0,c.customElement)("wui-ux-by-reown")],E),e.s([],933370);let $=f.css`
  :host > wui-flex {
...
`;var O=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let S=class extends x.LitElement{constructor(){super(),this.unsubscribe=[],this.remoteFeatures=n.OptionsController.state.remoteFeatures,this.unsubscribe.push(n.OptionsController.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=n.OptionsController.state,r=n.OptionsController.state.features?.legalCheckbox;return(e||t)&&!r?s.html`
    ...
    `:s.html`
      ...
      `}andTemplate(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=n.OptionsController.state;return e&&t?"and":""}termsTemplate(){let{termsConditionsUrl:e}=n.OptionsController.state;return e?s.html`<a href=${e} target="_blank" rel="noopener noreferrer"
      >Terms of Service</a
    >`:null}privacyTemplate(){let{privacyPolicyUrl:e}=n.OptionsController.state;return e?s.html`<a href=${e} target="_blank" rel="noopener noreferrer"
      >Privacy Policy</a
    >`:null}reownBrandingTemplate(e=!1){return this.remoteFeatures?.reownBranding?e?s.html`<wui-ux-by-reown class="branding-only"></wui-ux-by-reown>`:s.html`<wui-ux-by-reown></wui-ux-by-reown>`:null}};S.styles=[$],O([(0,l.state)()],S.prototype,"remoteFeatures",void 0),S=O([(0,c.customElement)("w3m-legal-footer")],S),e.s([],176375)},175041,e=>{"use strict";e.i(588984);var t=e.i(399702),r=e.i(872857);e.i(759703);var i=e.i(698797);e.i(781840);var o=e.i(86988),a=e.i(944411),s=e.i(843028);e.i(302184);var l=e.i(938559);e.i(237029),e.i(451801),e.i(176375);var n=t,c=e.i(392074),h=e.i(525417),u=e.i(729702),d=e.i(140018),p=e.i(375054),m=e.i(229581),f=e.i(301847);e.i(231971);var g=e.i(718454),v=e.i(118827);let b=v.css`
  :host {
...
`;var w=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let y=class extends n.LitElement{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=u.ConnectorController.state.connectors,this.authConnector=this.connectors.find(e=>"AUTH"===e.type),this.remoteFeatures=a.OptionsController.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(u.ConnectorController.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(e=>"AUTH"===e.type)}),a.OptionsController.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[],t=!!this.authConnector,i=e?.length,o="ConnectSocials"===p.RouterController.state.view;return t&&i||o?(o&&!i&&(e=d.ConstantsUtil.DEFAULT_SOCIALS),r.html` <wui-flex flexDirection="column" gap="xs">
      ${e.map(e=>r.html`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`):null}async onSocialClick(e){e&&await (0,m.executeSocialLogin)(e)}async handlePwaFrameLoad(){if(f.CoreHelperUtil.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof g.W3mFrameProvider&&await this.authConnector.provider.init()}catch(e){h.AlertController.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};y.styles=b,w([(0,c.property)()],y.prototype,"tabIdx",void 0),w([(0,i.state)()],y.prototype,"connectors",void 0),w([(0,i.state)()],y.prototype,"authConnector",void 0),w([(0,i.state)()],y.prototype,"remoteFeatures",void 0),w([(0,i.state)()],y.prototype,"isPwaLoading",void 0),y=w([(0,l.customElement)("w3m-social-login-list")],y);let C=v.css`
  wui-flex {
...
`;var x=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let k=class extends t.LitElement{constructor(){super(),this.unsubscribe=[],this.checked=s.OptionsStateController.state.isLegalCheckboxChecked,this.unsubscribe.push(s.OptionsStateController.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=a.OptionsController.state,i=a.OptionsController.state.features?.legalCheckbox,s=!!(e||t)&&!!i,l=s&&!this.checked;return r.html`
...
`;var z=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let N=class extends _.LitElement{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=j.AccountController.state.socialProvider,this.uri=j.AccountController.state.farcasterUrl,this.ready=!1,this.loading=!1,this.remoteFeatures=a.OptionsController.state.remoteFeatures,this.authConnector=u.ConnectorController.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(j.AccountController.subscribeKey("farcasterUrl",e=>{e&&(this.uri=e,this.connectFarcaster())}),j.AccountController.subscribeKey("socialProvider",e=>{e&&(this.socialProvider=e)}),a.OptionsController.subscribeKey("remoteFeatures",e=>{this.remoteFeatures=e})),window.addEventListener("resize",this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),r.html`${this.platformTemplate()}`}platformTemplate(){return f.CoreHelperUtil.isMobile()?r.html`${this.mobileTemplate()}`:r.html`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?r.html`${this.loadingTemplate()}`:r.html`${this.qrTemplate()}`}qrTemplate(){return r.html` <wui-flex
      flexDirection="column"
      alignItems="center"
      .padding=${["0","xl","xl","xl"]}
      gap="xl"
