...
`;var j=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let E=class extends p.LitElement{constructor(){super(...arguments),this.logo="google",this.name="Continue with google",this.align="left",this.disabled=!1}render(){return m.html`
    ...
    `}templatePlacement(){return"center"===this.align?m.html` <wui-logo class="invisible" logo=${this.logo}></wui-logo>`:null}};E.styles=[v.resetStyles,v.elementStyles,P],j([(0,f.property)()],E.prototype,"logo",void 0),j([(0,f.property)()],E.prototype,"name",void 0),j([(0,f.property)()],E.prototype,"align",void 0),j([(0,f.property)()],E.prototype,"tabIdx",void 0),j([(0,f.property)({type:Boolean})],E.prototype,"disabled",void 0),E=j([(0,b.customElement)("wui-list-social")],E),e.s([],231971)},567815,(e,t,r)=>{"use strict";t.exports=function(e){for(var t=[],r=e.length,i=0;i<r;i++){var o=e.charCodeAt(i);if(o>=55296&&o<=56319&&r>i+1){var a=e.charCodeAt(i+1);a>=56320&&a<=57343&&(o=(o-55296)*1024+a-56320+65536,i+=1)}if(o<128){t.push(o);continue}if(o<2048){t.push(o>>6|192),t.push(63&o|128);continue}if(o<55296||o>=57344&&o<65536){t.push(o>>12|224),t.push(o>>6&63|128),t.push(63&o|128);continue}if(o>=65536&&o<=1114111){t.push(o>>18|240),t.push(o>>12&63|128),t.push(o>>6&63|128),t.push(63&o|128);continue}t.push(239,191,189)}return new Uint8Array(t).buffer}},143880,e=>{"use strict";e.i(588984);var t=e.i(399702),r=e.i(872857);e.i(759703);var i=e.i(392074);e.i(630572),e.i(287940);var o=e.i(520209);function a(e,t,r){return e!==t&&(e-t<0?t-e:e-t)<=r+.1}let s={generate({uri:e,size:t,logoSize:i,dotColor:s="#141414"}){let l,n,c=[],u=(n=Math.sqrt((l=Array.prototype.slice.call(o.default.create(e,{errorCorrectionLevel:"Q"}).modules.data,0)).length),l.reduce((e,t,r)=>(r%n==0?e.push([t]):e[e.length-1].push(t))&&e,[])),h=t/u.length,d=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];d.forEach(({x:e,y:t})=>{let i=(u.length-7)*h*e,o=(u.length-7)*h*t;for(let e=0;e<d.length;e+=1){let t=h*(7-2*e);c.push(r.svg`
            <rect
            ...
            />
          `)}});let p=Math.floor((i+25)/h),m=u.length/2-p/2,f=u.length/2+p/2-1,g=[];u.forEach((e,t)=>{e.forEach((e,r)=>{!u[t][r]||t<7&&r<7||t>u.length-8&&r<7||t<7&&r>u.length-8||t>m&&t<f&&r>m&&r<f||g.push([t*h+h/2,r*h+h/2])})});let v={};return g.forEach(([e,t])=>{v[e]?v[e]?.push(t):v[e]=[t]}),Object.entries(v).map(([e,t])=>{let r=t.filter(e=>t.every(t=>!a(e,t,h)));return[Number(e),r]}).forEach(([e,t])=>{t.forEach(t=>{c.push(r.svg`<circle cx=${e} cy=${t} fill=${s} r=${h/2.5} />`)})}),Object.entries(v).filter(([e,t])=>t.length>1).map(([e,t])=>{let r=t.filter(e=>t.some(t=>a(e,t,h)));return[Number(e),r]}).map(([e,t])=>{t.sort((e,t)=>e<t?-1:1);let r=[];for(let e of t){let t=r.find(t=>t.some(t=>a(e,t,h)));t?t.push(e):r.push([e])}return[e,r.map(e=>[e[0],e[e.length-1]])]}).forEach(([e,t])=>{t.forEach(([t,i])=>{c.push(r.svg`
              <line
                x1=${e}
                x2=${e}
                y1=${t}
...
`;var v=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let b=class extends u.LitElement{constructor(){super(...arguments),this.inputElementRef=(0,p.createRef)(),this.checked=void 0}render(){return s.html`
      <label>
        <input
    ...
    `}dispatchChangeEvent(){this.dispatchEvent(new CustomEvent("checkboxChange",{detail:this.inputElementRef.value?.checked,bubbles:!0,composed:!0}))}};b.styles=[m.resetStyles,g],v([(0,h.property)({type:Boolean})],b.prototype,"checked",void 0),b=v([(0,c.customElement)("wui-checkbox")],b),e.i(331658);let w=f.css`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`;var w=function(e,t,r,i){var o,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,r):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,r,i);else for(var l=e.length-1;l>=0;l--)(o=e[l])&&(s=(a<3?o(s):a>3?o(t,r,s):o(t,r))||s);return a>3&&s&&Object.defineProperty(t,r,s),s};let y=class extends n.LitElement{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=h.ConnectorController.state.connectors,this.authConnector=this.connectors.find(e=>"AUTH"===e.type),this.remoteFeatures=a.OptionsController.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(h.ConnectorController.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(e=>"AUTH"===e.type)}),a.OptionsController.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[],t=!!this.authConnector,i=e?.length,o="ConnectSocials"===p.RouterController.state.view;return t&&i||o?(o&&!i&&(e=d.ConstantsUtil.DEFAULT_SOCIALS),r.html` <wui-flex flexDirection="column" gap="xs">
      ${e.map(e=>r.html`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`):null}async onSocialClick(e){e&&await (0,m.executeSocialLogin)(e)}async handlePwaFrameLoad(){if(f.CoreHelperUtil.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof g.W3mFrameProvider&&await this.authConnector.provider.init()}catch(e){u.AlertController.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};y.styles=b,w([(0,c.property)()],y.prototype,"tabIdx",void 0),w([(0,i.state)()],y.prototype,"connectors",void 0),w([(0,i.state)()],y.prototype,"authConnector",void 0),w([(0,i.state)()],y.prototype,"remoteFeatures",void 0),w([(0,i.state)()],y.prototype,"isPwaLoading",void 0),y=w([(0,l.customElement)("w3m-social-login-list")],y);let C=v.css`
  wui-flex {
