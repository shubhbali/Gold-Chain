...
const ByBitIcon = createIconic({
    alt: 'ByBit Wallet',
    iconName: 'bybit',
    sourcePath: 'icons/wallets/bybit.svg',
});
const Coin98Icon = createIconic({
    alt: 'Coin98 Wallet',
    iconName: 'coin98',
...
const InfinexIcon = createIconic({
    alt: 'Infinex Wallet',
    iconName: 'infinex',
...
const TronLinkIcon = createIconic({
    alt: 'TronLink Wallet',
    iconName: 'tronlink',
...
const DynamicWaasIcon = createIconic({
    alt: 'Dynamic Waas',
...
const OneKeyIcon = createIconic({
    alt: 'OneKey',
    iconName: 'onekey',
    sourcePath: 'icons/wallets/onekey.svg',
});
const AmbireIcon = createIconic({
    alt: 'Ambire',
    iconName: 'ambire',
    sourcePath: 'icons/wallets/ambire.svg',
});
const BitGetWalletIcon = createIconic({
    alt: 'Bitget Wallet',
    iconName: 'bitgetwallet',
    sourcePath: 'icons/wallets/bitgetwallet.svg',
});
const MathWalletIcon = createIconic({
    alt: 'Math Wallet',
    iconName: 'coin98',
    sourcePath: 'icons/wallets/coin98.svg',
});
const CloverWalletIcon = createIconic({
    alt: 'Clover Wallet',
    iconName: 'clover',
...
const PontemIcon = createIconic({
    alt: 'Pontem',
    iconName: 'pontem',
    sourcePath: 'icons/wallets/pontem.svg',
});
const LobstrIcon = createIconic({
    alt: 'Lobstr',
    iconName: 'lobstr',
    sourcePath: 'icons/wallets/lobstr.svg',
});
const FreighterIcon = createIconic({
    alt: 'Freighter',
    iconName: 'freighter',
    sourcePath: 'icons/wallets/freighter.svg',
});
const ShieldIcon = createIconic({
    alt: 'Shield',
    iconName: 'shield',
