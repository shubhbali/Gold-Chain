...
const Typography = (_a) => {
    var { as: Tag = 'p', variant, weight, color = 'primary', transform, className = '', truncate = false, style } = _a, props = __rest(_a, ["as", "variant", "weight", "color", "transform", "className", "truncate", "style"]);
