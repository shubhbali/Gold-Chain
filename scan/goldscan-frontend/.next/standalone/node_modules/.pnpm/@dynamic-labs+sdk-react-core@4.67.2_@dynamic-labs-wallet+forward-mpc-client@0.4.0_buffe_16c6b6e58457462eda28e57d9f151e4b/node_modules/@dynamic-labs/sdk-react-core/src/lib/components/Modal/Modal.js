...
const Modal = ({ children, className, isShown = true, transitionProps, }) => (jsx("div", { className: classNames('modal', className), children: jsx(OpacityTransition, Object.assign({}, transitionProps, { isShown: isShown, children: jsx("div", { className: 'modal__items', children: children }) })) }));
