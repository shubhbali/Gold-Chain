...
const useFetchBalance = ({ wallet, chain, network }) => {
    ...
    const isFetchBalanceDisabled = !wallet;
    const fetchBalance = () => __awaiter(void 0, void 0, void 0, function* () {
        if (isFetchBalanceDisabled)
            return;
        if (!chain || (wallet.connector.supportsNetworkSwitching() && !network)) {
            return;
        }
    ...
    const { isLoading } = usePromise(fetchBalance, {
        deps: [wallet === null || wallet === void 0 ? void 0 : wallet.address, network === null || network === void 0 ? void 0 : network.toString(), chain],
