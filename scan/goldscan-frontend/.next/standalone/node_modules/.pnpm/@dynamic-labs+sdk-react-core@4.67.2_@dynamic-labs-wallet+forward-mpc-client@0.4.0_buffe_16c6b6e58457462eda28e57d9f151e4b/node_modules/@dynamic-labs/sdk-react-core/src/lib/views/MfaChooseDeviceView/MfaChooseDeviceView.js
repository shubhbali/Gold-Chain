...
import { useGetMfaOptions } from './useGetMfaOptions/useGetMfaOptions.js';
...
const MfaChooseDeviceView = ({ isInitialSetup = true, createMfaToken = false, requestedScopes, }) => {
    ...
    const getMfaOptions = useGetMfaOptions(isInitialSetup);
    const { data: mfaOptions } = usePromise(getMfaOptions, {
        deps: [isInitialSetup],
        initialData: [],
    });
