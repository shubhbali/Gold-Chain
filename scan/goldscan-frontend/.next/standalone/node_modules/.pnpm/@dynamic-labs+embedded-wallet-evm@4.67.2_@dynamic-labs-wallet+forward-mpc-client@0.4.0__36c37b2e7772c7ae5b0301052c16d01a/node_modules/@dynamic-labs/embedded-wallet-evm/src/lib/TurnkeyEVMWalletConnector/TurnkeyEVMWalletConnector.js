...
class TurnkeyEVMWalletConnector extends TurnkeyWalletConnectorBase {
    ...
    getViemAccountCustomSource() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const { turnkeySubOrganizationId } = (_a = this.walletProperties) !== null && _a !== void 0 ? _a : {};
            const { address } = (_b = this.verifiedCredential) !== null && _b !== void 0 ? _b : {};
            assertDefined(turnkeySubOrganizationId, 'Turnkey sub organization id not found');
            assertDefined(address, 'Address not found');
            return {
                address: address,
    ...
    getTurnkeyAccount() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._turnkeyAccount = toAccount(yield this.getViemAccountCustomSource());
