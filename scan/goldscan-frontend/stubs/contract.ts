import type * as stats from '@goldchain-scan/stats-types';
...
export const SOLIDITY_SCAN_REPORT: SolidityScanReport = {
  scan_report: {
    ...
    scanner_reference_url: 'https://solidityscan.com/quickscan/0xc1EF7811FF2ebFB74F80ed7423f2AdAA37454be2/goldchain-scan/eth-goerli?ref=goldchain-scan',
  },
};
