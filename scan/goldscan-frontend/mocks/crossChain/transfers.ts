import type { GetTransfersResponse, InterchainTransfer } from '@goldchain-scan/interchain-indexer-types';
import { MessageStatus } from '@goldchain-scan/interchain-indexer-types';
