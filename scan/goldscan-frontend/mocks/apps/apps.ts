...
export const apps = [
  ...
  },
  {
    ...
    logo: 'https://approval-tracker.apps.scan.giltchain.com/icon-192.png',
    ...
    site: 'https://docs.scan.giltchain.com/for-users/goldscan-apps/token-approval-tracker',
    ...
    url: 'https://approval-tracker.apps.scan.giltchain.com/',
  },
];
