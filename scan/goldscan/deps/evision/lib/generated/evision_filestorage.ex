defmodule Evision.FileStorage do
  ...
  @spec fileStorage(Keyword.t()) :: any() | {:error, String.t()}
  def fileStorage([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename,:encoding,:flags])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_FileStorage()
    |> to_struct()
  end
  ...
  def endWriteStruct([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_endWriteStruct()
    |> to_struct()
  end
  ...
  def getFirstTopLevelNode([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_getFirstTopLevelNode()
    |> to_struct()
  end
  ...
  def getFormat([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_getFormat()
    |> to_struct()
  end
  ...
  def getNode([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_getNode()
    |> to_struct()
  end
  ...
  def isOpened([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_isOpened()
    |> to_struct()
  end
  ...
  def release([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_release()
    |> to_struct()
  end
  ...
  def releaseAndGetString([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_releaseAndGetString()
    |> to_struct()
  end
  ...
  def root([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:streamidx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_root()
    |> to_struct()
  end
  ...
  @spec startWriteStruct(Keyword.t()) :: any() | {:error, String.t()}
  def startWriteStruct([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:typeName,:name,:flags])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_startWriteStruct()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val,:name])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_write()
    |> to_struct()
  end
  ...
  @spec writeComment(Keyword.t()) :: any() | {:error, String.t()}
  def writeComment([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:append,:comment])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fileStorage_writeComment()
    |> to_struct()
  end
