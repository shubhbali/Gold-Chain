defmodule Evision.CascadeClassifier do
  ...
  def cascadeClassifier([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_CascadeClassifier()
    |> to_struct()
  end
  ...
  def convert([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:newcascade,:oldcascade])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_convert_static()
    |> to_struct()
  end
  ...
  def detectMultiScale([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:flags,:minNeighbors,:minSize,:scaleFactor,:objects,:maxSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_detectMultiScale()
    |> to_struct()
  end
  ...
  @spec detectMultiScale2(Keyword.t()) :: any() | {:error, String.t()}
  def detectMultiScale2([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:flags,:minNeighbors,:minSize,:scaleFactor,:objects,:numDetections,:maxSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_detectMultiScale2()
    |> to_struct()
  end
  ...
  @spec detectMultiScale3(Keyword.t()) :: any() | {:error, String.t()}
  def detectMultiScale3([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:levelWeights,:image,:flags,:rejectLevels,:minNeighbors,:minSize,:scaleFactor,:outputRejectLevels,:objects,:maxSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_detectMultiScale3()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_empty()
    |> to_struct()
  end
  ...
  def getFeatureType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_getFeatureType()
    |> to_struct()
  end
  ...
  def getOriginalWindowSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_getOriginalWindowSize()
    |> to_struct()
  end
  ...
  def isOldFormatCascade([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_isOldFormatCascade()
    |> to_struct()
  end
  ...
  def load([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_load()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:node])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cascadeClassifier_read()
    |> to_struct()
  end
