defmodule Evision.Barcode.BarcodeDetector do
  ...
  @spec barcodeDetector(Keyword.t()) :: any() | {:error, String.t()}
  def barcodeDetector([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:model_path,:prototxt_path])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_barcode_BarcodeDetector_BarcodeDetector()
    |> to_struct()
  end
  ...
  def decode([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points,:straight_code])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_BarcodeDetector_decode()
    |> to_struct()
  end
  ...
  @spec decodeMulti(Keyword.t()) :: any() | {:error, String.t()}
  def decodeMulti([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:decoded_info,:img,:points,:straight_code])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_BarcodeDetector_decodeMulti()
    |> to_struct()
  end
  ...
  @spec decodeWithType(Keyword.t()) :: any() | {:error, String.t()}
  def decodeWithType([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:decoded_info,:img,:points,:decoded_type])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_barcode_BarcodeDetector_decodeWithType()
    |> to_struct()
  end
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_BarcodeDetector_detect()
    |> to_struct()
  end
  ...
  def detectAndDecode([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points,:straight_code])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_BarcodeDetector_detectAndDecode()
    |> to_struct()
  end
  ...
  @spec detectAndDecodeMulti(Keyword.t()) :: any() | {:error, String.t()}
  def detectAndDecodeMulti([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:decoded_info,:img,:points,:straight_code])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_BarcodeDetector_detectAndDecodeMulti()
    |> to_struct()
  end
  ...
  @spec detectAndDecodeWithType(Keyword.t()) :: any() | {:error, String.t()}
  def detectAndDecodeWithType([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:decoded_info,:img,:points,:decoded_type])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_barcode_BarcodeDetector_detectAndDecodeWithType()
    |> to_struct()
  end
  ...
  @spec detectMulti(Keyword.t()) :: any() | {:error, String.t()}
  def detectMulti([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_BarcodeDetector_detectMulti()
    |> to_struct()
  end
  ...
  def getDetectorScales([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sizes])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_barcode_BarcodeDetector_getDetectorScales()
    |> to_struct()
  end
  ...
  def getDownsamplingThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_barcode_BarcodeDetector_getDownsamplingThreshold()
    |> to_struct()
  end
  ...
  def getGradientThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_barcode_BarcodeDetector_getGradientThreshold()
    |> to_struct()
  end
  ...
  @spec setDetectorScales(Keyword.t()) :: any() | {:error, String.t()}
  def setDetectorScales([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sizes])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_barcode_BarcodeDetector_setDetectorScales()
    |> to_struct()
  end
  ...
  @spec setDownsamplingThreshold(Keyword.t()) :: any() | {:error, String.t()}
  def setDownsamplingThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:thresh])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_barcode_BarcodeDetector_setDownsamplingThreshold()
    |> to_struct()
  end
  ...
  @spec setGradientThreshold(Keyword.t()) :: any() | {:error, String.t()}
  def setGradientThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:thresh])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.barcode_barcode_BarcodeDetector_setGradientThreshold()
    |> to_struct()
  end
