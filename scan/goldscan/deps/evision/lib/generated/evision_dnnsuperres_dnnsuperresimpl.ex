defmodule Evision.DNNSuperRes.DNNSuperResImpl do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.dnn_superres_dnn_superres_DnnSuperResImpl_create_static()
    |> to_struct()
  end
  ...
  def getAlgorithm([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_superres_dnn_superres_DnnSuperResImpl_getAlgorithm()
    |> to_struct()
  end
  ...
  def getScale([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_superres_dnn_superres_DnnSuperResImpl_getScale()
    |> to_struct()
  end
  ...
  @spec readModel(Keyword.t()) :: any() | {:error, String.t()}
  def readModel([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:path])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_superres_dnn_superres_DnnSuperResImpl_readModel()
    |> to_struct()
  end
  ...
  @spec setModel(Keyword.t()) :: any() | {:error, String.t()}
  def setModel([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:scale,:algo])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_superres_dnn_superres_DnnSuperResImpl_setModel()
    |> to_struct()
  end
  ...
  def setPreferableBackend([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_superres_dnn_superres_DnnSuperResImpl_setPreferableBackend()
    |> to_struct()
  end
  ...
  def setPreferableTarget([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_superres_dnn_superres_DnnSuperResImpl_setPreferableTarget()
    |> to_struct()
  end
  ...
  @spec upsample(Keyword.t()) :: any() | {:error, String.t()}
  def upsample([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:result])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_superres_dnn_superres_DnnSuperResImpl_upsample()
    |> to_struct()
  end
  ...
  @spec upsampleMultioutput(Keyword.t()) :: any() | {:error, String.t()}
  def upsampleMultioutput([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:node_names,:img,:imgs_new,:scale_factors])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_superres_dnn_superres_DnnSuperResImpl_upsampleMultioutput()
    |> to_struct()
  end
