defmodule Evision.ArUco.Board do
  ...
  @spec board(Keyword.t()) :: any() | {:error, String.t()}
  def board([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:objPoints,:dictionary,:ids])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_Board_Board()
    |> to_struct()
  end
  ...
  @spec generateImage(Keyword.t()) :: any() | {:error, String.t()}
  def generateImage([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:outSize,:img,:borderBits,:marginSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_Board_generateImage()
    |> to_struct()
  end
  ...
  def getDictionary([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_Board_getDictionary()
    |> to_struct()
  end
  ...
  def getIds([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_Board_getIds()
    |> to_struct()
  end
  ...
  def getObjPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_Board_getObjPoints()
    |> to_struct()
  end
  ...
  def getRightBottomCorner([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_Board_getRightBottomCorner()
    |> to_struct()
  end
  ...
  @spec matchImagePoints(Keyword.t()) :: any() | {:error, String.t()}
  def matchImagePoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imgPoints,:detectedIds,:objPoints,:detectedCorners])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_Board_matchImagePoints()
    |> to_struct()
  end
