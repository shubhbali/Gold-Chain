defmodule Evision.XPhoto.SimpleWB do
  ...
  def getInputMax([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_getInputMax()
    |> to_struct()
  end
  ...
  def getInputMin([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_getInputMin()
    |> to_struct()
  end
  ...
  def getOutputMax([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_getOutputMax()
    |> to_struct()
  end
  ...
  def getOutputMin([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_getOutputMin()
    |> to_struct()
  end
  ...
  def getP([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_getP()
    |> to_struct()
  end
  ...
  def setInputMax([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_setInputMax()
    |> to_struct()
  end
  ...
  def setInputMin([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_setInputMin()
    |> to_struct()
  end
  ...
  def setOutputMax([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_setOutputMax()
    |> to_struct()
  end
  ...
  def setOutputMin([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_setOutputMin()
    |> to_struct()
  end
  ...
  def setP([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_SimpleWB_setP()
    |> to_struct()
  end
