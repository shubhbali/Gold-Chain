defmodule Evision.VideoCapture do
  ...
  """
  @spec videoCapture(Keyword.t()) :: any() | {:error, String.t()}
  def videoCapture([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:params,:filename,:source,:index,:apiPreference])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_VideoCapture()
    |> to_struct()
  end
  ...
  ##### Positional Arguments
  - **source**: `Evision.IStreamReader.t()`
  - **apiPreference**: `integer()`
  - **params**: `[integer()]`
  ...
  Python prototype (for reference only):
  ```python3
  VideoCapture(source, apiPreference, params) -> <VideoCapture object>
  ```
  #### Variant 2:
  ...
  """
  @spec videoCapture(Evision.IStreamReader.t(), integer(), list(integer())) :: Evision.VideoCapture.t() | {:error, String.t()}
  def videoCapture(source, apiPreference, params) when is_struct(source, Evision.IStreamReader) and is_integer(apiPreference) and is_list(params)
  do
    positional = [
  ...
  **Note**: In @ref videoio_c "C API", when you finished working with video, release CvCapture structure with
  ...
  def get([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:propId])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_get()
    |> to_struct()
  end
  ...
  **Note**: Stream should be opened.
  ...
  def getBackendName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_getBackendName()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getExceptionMode(Keyword.t()) :: any() | {:error, String.t()}
  def getExceptionMode([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_getExceptionMode()
    |> to_struct()
  end
  ...
  ```
  """
  @spec grab(Keyword.t()) :: any() | {:error, String.t()}
  def grab([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_grab()
    |> to_struct()
  end
  ...
  def isOpened([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_isOpened()
    |> to_struct()
  end
  ...
  @spec open(Keyword.t()) :: any() | {:error, String.t()}
  def open([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:params,:filename,:source,:index,:apiPreference])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_open()
    |> to_struct()
  end
  ...
  """
  @spec open(Evision.VideoCapture.t(), Evision.IStreamReader.t(), integer(), list(integer())) :: boolean() | {:error, String.t()}
  def open(self, source, apiPreference, params) when is_struct(source, Evision.IStreamReader) and is_integer(apiPreference) and is_list(params)
  do
    positional = [
      source: Evision.Internal.Structurise.from_struct(source),
      apiPreference: Evision.Internal.Structurise.from_struct(apiPreference),
  ...
  **Note**: In @ref videoio_c "C API", functions cvRetrieveFrame() and cv.RetrieveFrame() return image stored inside the video
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_read()
    |> to_struct()
  end
  ...
  def release([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_release()
    |> to_struct()
  end
  ...
  **Note**: In @ref videoio_c "C API", functions cvRetrieveFrame() and cv.RetrieveFrame() return image stored inside the video
  ...
  ```
  """
  @spec retrieve(Keyword.t()) :: any() | {:error, String.t()}
  def retrieve([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:flag])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_retrieve()
    |> to_struct()
  end
  ...
  def set([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:propId,:value])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_set()
    |> to_struct()
  end
  ...
  **Note**: Even if it returns `true` this doesn't ensure that the property
  ...
  @spec setExceptionMode(Keyword.t()) :: any() | {:error, String.t()}
  def setExceptionMode([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:enable])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.videoCapture_setExceptionMode()
    |> to_struct()
  end
