defmodule Evision.Text do
  ...
  def computeNMChannels([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_mode,:_src,:_channels])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_computeNMChannels()
    |> to_struct()
  end
  ...
  def createERFilterNM1([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:cb,:filename,:thresholdDelta,:maxArea,:minArea,:nonMaxSuppression,:minProbabilityDiff,:minProbability])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_createERFilterNM1()
    |> to_struct()
  end
  ...
  def createERFilterNM2([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:cb,:filename,:minProbability])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_createERFilterNM2()
    |> to_struct()
  end
  ...
  @spec createOCRHMMTransitionsTable(Keyword.t()) :: any() | {:error, String.t()}
  def createOCRHMMTransitionsTable([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vocabulary,:lexicon])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_createOCRHMMTransitionsTable()
    |> to_struct()
  end
  ...
  **Note**: 
  ...
  def detectRegions([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename,:image,:regions,:er_filter1,:er_filter2,:groups_rects,:minProbability,:method])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_detectRegions()
    |> to_struct()
  end
  ...
  @spec detectTextSWT(Keyword.t()) :: any() | {:error, String.t()}
  def detectTextSWT([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:input,:chainBBs,:dark_on_light,:result,:draw])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_detectTextSWT()
    |> to_struct()
  end
  ...
  @spec erGrouping(Keyword.t()) :: any() | {:error, String.t()}
  def erGrouping([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename,:image,:regions,:channel,:groups_rects,:minProbablity,:method])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_erGrouping()
    |> to_struct()
  end
  ...
  def loadClassifierNM1([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_loadClassifierNM1()
    |> to_struct()
  end
  ...
  def loadClassifierNM2([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_loadClassifierNM2()
    |> to_struct()
  end
  ...
  def loadOCRBeamSearchClassifierCNN([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_loadOCRBeamSearchClassifierCNN()
    |> to_struct()
  end
  ...
  @spec loadOCRHMMClassifier(Keyword.t()) :: any() | {:error, String.t()}
  def loadOCRHMMClassifier([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename,:classifier])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_loadOCRHMMClassifier()
    |> to_struct()
  end
  ...
  def loadOCRHMMClassifierCNN([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_loadOCRHMMClassifierCNN()
    |> to_struct()
  end
  ...
  def loadOCRHMMClassifierNM([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.text_loadOCRHMMClassifierNM()
    |> to_struct()
  end
