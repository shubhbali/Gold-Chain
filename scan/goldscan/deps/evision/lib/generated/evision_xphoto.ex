defmodule Evision.XPhoto do
  ...
  @spec applyChannelGains(Keyword.t()) :: any() | {:error, String.t()}
  def applyChannelGains([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:gainG,:dst,:gainR,:gainB])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_applyChannelGains()
    |> to_struct()
  end
  ...
  def bm3dDenoising([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:blockMatchingStep2,:src,:dst,:templateWindowSize,:normType,:transformType,:dstStep1,:groupSize,:dstStep2,:step,:blockMatchingStep1,:slidingStep,:beta,:searchWindowSize,:h])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_bm3dDenoising()
    |> to_struct()
  end
  ...
  @spec createGrayworldWB(Keyword.t()) :: any() | {:error, String.t()}
  def createGrayworldWB([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_createGrayworldWB()
    |> to_struct()
  end
  ...
  def createLearningBasedWB([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:path_to_model])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_createLearningBasedWB()
    |> to_struct()
  end
  ...
  @spec createSimpleWB(Keyword.t()) :: any() | {:error, String.t()}
  def createSimpleWB([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_createSimpleWB()
    |> to_struct()
  end
  ...
  def createTonemapDurand([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:contrast,:sigma_space,:saturation,:gamma,:sigma_color])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_createTonemapDurand()
    |> to_struct()
  end
  ...
  @spec dctDenoising(Keyword.t()) :: any() | {:error, String.t()}
  def dctDenoising([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:psize,:sigma,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_dctDenoising()
    |> to_struct()
  end
  ...
  def inpaint([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:mask,:dst,:algorithmType])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_inpaint()
    |> to_struct()
  end
  ...
  @spec oilPainting(Keyword.t()) :: any() | {:error, String.t()}
  def oilPainting([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:dst,:code,:dynRatio,:size])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_oilPainting()
    |> to_struct()
  end
