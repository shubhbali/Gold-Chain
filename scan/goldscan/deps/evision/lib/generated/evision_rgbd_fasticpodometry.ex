defmodule Evision.RGBD.FastICPOdometry do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:cameraMatrix,:angleThreshold,:maxDistDiff,:iterCounts,:sigmaDepth,:kernelSize,:sigmaSpatial])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_create_static()
    |> to_struct()
  end
  ...
  def getAngleThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_getAngleThreshold()
    |> to_struct()
  end
  ...
  def getCameraMatrix([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_getCameraMatrix()
    |> to_struct()
  end
  ...
  def getIterationCounts([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_getIterationCounts()
    |> to_struct()
  end
  ...
  def getKernelSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_getKernelSize()
    |> to_struct()
  end
  ...
  def getMaxDistDiff([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_getMaxDistDiff()
    |> to_struct()
  end
  ...
  def getSigmaDepth([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_getSigmaDepth()
    |> to_struct()
  end
  ...
  def getSigmaSpatial([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_getSigmaSpatial()
    |> to_struct()
  end
  ...
  def getTransformType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_getTransformType()
    |> to_struct()
  end
  ...
  def prepareFrameCache([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_prepareFrameCache()
    |> to_struct()
  end
  ...
  def setAngleThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:f])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_setAngleThreshold()
    |> to_struct()
  end
  ...
  def setCameraMatrix([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_setCameraMatrix()
    |> to_struct()
  end
  ...
  def setIterationCounts([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_setIterationCounts()
    |> to_struct()
  end
  ...
  def setKernelSize([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:f])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_setKernelSize()
    |> to_struct()
  end
  ...
  def setMaxDistDiff([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_setMaxDistDiff()
    |> to_struct()
  end
  ...
  def setSigmaDepth([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:f])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_setSigmaDepth()
    |> to_struct()
  end
  ...
  def setSigmaSpatial([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:f])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_setSigmaSpatial()
    |> to_struct()
  end
  ...
  def setTransformType([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rgbd_FastICPOdometry_setTransformType()
    |> to_struct()
  end
