defmodule Evision.FishEye do
  ...
  def calibrate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:D,:flags,:imagePoints,:image_size,:K,:criteria,:rvecs,:objectPoints,:tvecs])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_calibrate()
    |> to_struct()
  end
  ...
  ```
  """
  @spec distortPoints(Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), [{:alpha, term()}] | nil) :: Evision.Mat.t() | {:error, String.t()}
  def distortPoints(undistorted, kundistorted, k, d, opts) when (is_struct(undistorted, Evision.Mat) or is_struct(undistorted, Nx.Tensor) or is_number(undistorted) or is_tuple(undistorted)) and (is_struct(kundistorted, Evision.Mat) or is_struct(kundistorted, Nx.Tensor) or is_number(kundistorted) or is_tuple(kundistorted)) and (is_struct(k, Evision.Mat) or is_struct(k, Nx.Tensor) or is_number(k) or is_tuple(k)) and (is_struct(d, Evision.Mat) or is_struct(d, Nx.Tensor) or is_number(d) or is_tuple(d)) and (opts == nil or (is_list(opts) and is_tuple(hd(opts))))
  do
    Keyword.validate!(opts || [], [:alpha])
    positional = [
      undistorted: Evision.Internal.Structurise.from_struct(undistorted),
      kundistorted: Evision.Internal.Structurise.from_struct(kundistorted),
      k: Evision.Internal.Structurise.from_struct(k),
      d: Evision.Internal.Structurise.from_struct(d)
    ]
  ...
  def distortPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:distorted,:D,:K,:undistorted,:Kundistorted,:alpha])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_distortPoints()
    |> to_struct()
  end
  ...
  @spec distortPoints(Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in()) :: Evision.Mat.t() | {:error, String.t()}
  def distortPoints(undistorted, kundistorted, k, d) when (is_struct(undistorted, Evision.Mat) or is_struct(undistorted, Nx.Tensor) or is_number(undistorted) or is_tuple(undistorted)) and (is_struct(kundistorted, Evision.Mat) or is_struct(kundistorted, Nx.Tensor) or is_number(kundistorted) or is_tuple(kundistorted)) and (is_struct(k, Evision.Mat) or is_struct(k, Nx.Tensor) or is_number(k) or is_tuple(k)) and (is_struct(d, Evision.Mat) or is_struct(d, Nx.Tensor) or is_number(d) or is_tuple(d))
  do
    positional = [
      undistorted: Evision.Internal.Structurise.from_struct(undistorted),
      kundistorted: Evision.Internal.Structurise.from_struct(kundistorted),
  ...
  @spec estimateNewCameraMatrixForUndistortRectify(Keyword.t()) :: any() | {:error, String.t()}
  def estimateNewCameraMatrixForUndistortRectify([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:P,:D,:new_size,:R,:fov_scale,:balance,:image_size,:K])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_estimateNewCameraMatrixForUndistortRectify()
    |> to_struct()
  end
  ...
  def initUndistortRectifyMap([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:P,:D,:R,:K,:map2,:m1type,:map1,:size])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_initUndistortRectifyMap()
    |> to_struct()
  end
  ...
  def projectPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:D,:imagePoints,:jacobian,:K,:alpha,:tvec,:objectPoints,:rvec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_projectPoints()
    |> to_struct()
  end
  ...
  def solvePnP([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:cameraMatrix,:flags,:imagePoints,:criteria,:distCoeffs,:useExtrinsicGuess,:tvec,:objectPoints,:rvec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_solvePnP()
    |> to_struct()
  end
  ...
  def stereoCalibrate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:D2,:imageSize,:T,:flags,:R,:criteria,:D1,:imagePoints1,:K1,:K2,:rvecs,:imagePoints2,:objectPoints,:tvecs])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_stereoCalibrate()
    |> to_struct()
  end
  ...
  def stereoRectify([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:newImageSize,:D2,:imageSize,:flags,:R,:fov_scale,:Q,:balance,:R2,:D1,:P1,:K1,:R1,:K2,:P2,:tvec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_stereoRectify()
    |> to_struct()
  end
  ...
  def undistortImage([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:distorted,:D,:new_size,:K,:undistorted,:Knew])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_undistortImage()
    |> to_struct()
  end
  ...
  def undistortPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:distorted,:P,:D,:R,:K,:criteria,:undistorted])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.fisheye_undistortPoints()
    |> to_struct()
  end
