defmodule Evision.Detail.MatchesInfo do
  ...
  def getInliers([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_MatchesInfo_getInliers()
    |> to_struct()
  end
  ...
  def getMatches([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_MatchesInfo_getMatches()
    |> to_struct()
  end
