defmodule Evision.Omnidir do
  ...
  def calibrate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:D,:flags,:imagePoints,:xi,:K,:criteria,:idx,:rvecs,:size,:objectPoints,:tvecs])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.omnidir_calibrate()
    |> to_struct()
  end
  ...
  def initUndistortRectifyMap([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:P,:D,:flags,:R,:xi,:K,:map2,:m1type,:map1,:size])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.omnidir_initUndistortRectifyMap()
    |> to_struct()
  end
  ...
  def projectPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:D,:imagePoints,:xi,:jacobian,:K,:tvec,:objectPoints,:rvec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.omnidir_projectPoints()
    |> to_struct()
  end
  ...
  def stereoCalibrate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:D2,:rvecsL,:tvecsL,:flags,:imageSize2,:imagePoints1,:D1,:xi1,:xi2,:K1,:criteria,:rvec,:K2,:idx,:tvec,:imagePoints2,:objectPoints,:imageSize1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.omnidir_stereoCalibrate()
    |> to_struct()
  end
  ...
  @spec stereoReconstruct(Keyword.t()) :: any() | {:error, String.t()}
  def stereoReconstruct([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:SADWindowSize,:newSize,:pointCloud,:Knew,:D2,:T,:D1,:xi2,:image2Rec,:image1Rec,:K1,:flag,:image1,:xi1,:numDisparities,:R,:image2,:disparity,:K2,:pointType])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.omnidir_stereoReconstruct()
    |> to_struct()
  end
  ...
  def stereoRectify([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:R1,:T,:R2])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.omnidir_stereoRectify()
    |> to_struct()
  end
  ...
  def undistortImage([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:distorted,:D,:new_size,:flags,:R,:xi,:K,:undistorted,:Knew])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.omnidir_undistortImage()
    |> to_struct()
  end
  ...
  def undistortPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:distorted,:D,:R,:xi,:K,:undistorted])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.omnidir_undistortPoints()
    |> to_struct()
  end
