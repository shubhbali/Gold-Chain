defmodule Evision.TonemapReinhard do
  ...
  def getColorAdaptation([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.tonemapReinhard_getColorAdaptation()
    |> to_struct()
  end
  ...
  def getIntensity([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.tonemapReinhard_getIntensity()
    |> to_struct()
  end
  ...
  def getLightAdaptation([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.tonemapReinhard_getLightAdaptation()
    |> to_struct()
  end
  ...
  def setColorAdaptation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:color_adapt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.tonemapReinhard_setColorAdaptation()
    |> to_struct()
  end
  ...
  def setIntensity([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:intensity])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.tonemapReinhard_setIntensity()
    |> to_struct()
  end
  ...
  def setLightAdaptation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:light_adapt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.tonemapReinhard_setLightAdaptation()
    |> to_struct()
  end
