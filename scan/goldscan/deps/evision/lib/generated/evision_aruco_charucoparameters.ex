defmodule Evision.ArUco.CharucoParameters do
  ...
  @spec charucoParameters(Keyword.t()) :: any() | {:error, String.t()}
  def charucoParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_CharucoParameters_CharucoParameters()
    |> to_struct()
  end
