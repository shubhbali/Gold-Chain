defmodule Evision.LargeKinfu.Params do
  ...
  def coarseParams([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.large_kinfu_large_kinfu_Params_coarseParams_static()
    |> to_struct()
  end
  ...
  def defaultParams([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.large_kinfu_large_kinfu_Params_defaultParams_static()
    |> to_struct()
  end
  ...
  def hashTSDFParams([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.large_kinfu_large_kinfu_Params_hashTSDFParams_static()
    |> to_struct()
  end
