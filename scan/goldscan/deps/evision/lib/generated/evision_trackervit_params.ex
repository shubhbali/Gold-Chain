defmodule Evision.TrackerVit.Params do
  ...
  def params([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.trackerVit_Params_TrackerVit_Params()
    |> to_struct()
  end
  ...
  @spec get_tracking_score_threshold(Evision.TrackerVit.Params.t()) :: number()
  def get_tracking_score_threshold(self) do
    :evision_nif.trackerVit_Params_get_tracking_score_threshold(Evision.Internal.Structurise.from_struct(self))
    |> to_struct()
  end
  @spec set_tracking_score_threshold(Evision.TrackerVit.Params.t(), number()) :: Evision.TrackerVit.Params.t()
  def set_tracking_score_threshold(self, prop) do
    :evision_nif.trackerVit_Params_set_tracking_score_threshold(
        Evision.Internal.Structurise.from_struct(self),
        [tracking_score_threshold: Evision.Internal.Structurise.from_struct(prop)]
    )
    |> to_struct()
  end
end
