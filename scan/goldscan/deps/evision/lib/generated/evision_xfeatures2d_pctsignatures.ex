defmodule Evision.XFeatures2D.PCTSignatures do
  ...
  def clear([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.xfeatures2d_PCTSignatures_clear()
    |> to_struct()
  end
  ...
  @spec computeSignature(Keyword.t()) :: any() | {:error, String.t()}
  def computeSignature([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:signature,:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_computeSignature()
    |> to_struct()
  end
  ...
  @spec computeSignatures(Keyword.t()) :: any() | {:error, String.t()}
  def computeSignatures([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:images,:signatures])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_computeSignatures()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:pointDistribution,:initClusterSeedIndexes,:initSeedCount,:initSampleCount,:initSamplingPoints])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_create_static()
    |> to_struct()
  end
  ...
  @spec drawSignature(Keyword.t()) :: any() | {:error, String.t()}
  def drawSignature([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:radiusToShorterSideRatio,:signature,:result,:source,:borderThickness])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_drawSignature_static()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignatures_empty()
    |> to_struct()
  end
  ...
  @spec generateInitPoints(Keyword.t()) :: any() | {:error, String.t()}
  def generateInitPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:pointDistribution,:initPoints,:count])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_generateInitPoints_static()
    |> to_struct()
  end
  ...
  **Note**: Generated coordinates are in range [0..1)
  ...
  def getClusterMinSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getClusterMinSize()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignatures_getDefaultName()
    |> to_struct()
  end
  ...
  def getDistanceFunction([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getDistanceFunction()
    |> to_struct()
  end
  ...
  def getDropThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getDropThreshold()
    |> to_struct()
  end
  ...
  def getGrayscaleBits([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getGrayscaleBits()
    |> to_struct()
  end
  ...
  def getInitSeedCount([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getInitSeedCount()
    |> to_struct()
  end
  ...
  def getInitSeedIndexes([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getInitSeedIndexes()
    |> to_struct()
  end
  ...
  def getIterationCount([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getIterationCount()
    |> to_struct()
  end
  ...
  def getJoiningDistance([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getJoiningDistance()
    |> to_struct()
  end
  ...
  def getMaxClustersCount([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getMaxClustersCount()
    |> to_struct()
  end
  ...
  def getSampleCount([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getSampleCount()
    |> to_struct()
  end
  ...
  def getSamplingPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getSamplingPoints()
    |> to_struct()
  end
  ...
  def getWeightA([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getWeightA()
    |> to_struct()
  end
  ...
  def getWeightB([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getWeightB()
    |> to_struct()
  end
  ...
  def getWeightContrast([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getWeightContrast()
    |> to_struct()
  end
  ...
  def getWeightEntropy([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getWeightEntropy()
    |> to_struct()
  end
  ...
  def getWeightL([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getWeightL()
    |> to_struct()
  end
  ...
  def getWeightX([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getWeightX()
    |> to_struct()
  end
  ...
  def getWeightY([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getWeightY()
    |> to_struct()
  end
  ...
  def getWindowRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_getWindowRadius()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignatures_read()
    |> to_struct()
  end
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignatures_save()
    |> to_struct()
  end
  ...
  @spec setClusterMinSize(Keyword.t()) :: any() | {:error, String.t()}
  def setClusterMinSize([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:clusterMinSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setClusterMinSize()
    |> to_struct()
  end
  ...
  @spec setDistanceFunction(Keyword.t()) :: any() | {:error, String.t()}
  def setDistanceFunction([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:distanceFunction])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setDistanceFunction()
    |> to_struct()
  end
  ...
  @spec setDropThreshold(Keyword.t()) :: any() | {:error, String.t()}
  def setDropThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:dropThreshold])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setDropThreshold()
    |> to_struct()
  end
  ...
  @spec setGrayscaleBits(Keyword.t()) :: any() | {:error, String.t()}
  def setGrayscaleBits([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:grayscaleBits])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setGrayscaleBits()
    |> to_struct()
  end
  ...
  @spec setInitSeedIndexes(Keyword.t()) :: any() | {:error, String.t()}
  def setInitSeedIndexes([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:initSeedIndexes])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setInitSeedIndexes()
    |> to_struct()
  end
  ...
  @spec setIterationCount(Keyword.t()) :: any() | {:error, String.t()}
  def setIterationCount([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:iterationCount])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setIterationCount()
    |> to_struct()
  end
  ...
  @spec setJoiningDistance(Keyword.t()) :: any() | {:error, String.t()}
  def setJoiningDistance([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:joiningDistance])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setJoiningDistance()
    |> to_struct()
  end
  ...
  @spec setMaxClustersCount(Keyword.t()) :: any() | {:error, String.t()}
  def setMaxClustersCount([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:maxClustersCount])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setMaxClustersCount()
    |> to_struct()
  end
  ...
  @spec setSamplingPoints(Keyword.t()) :: any() | {:error, String.t()}
  def setSamplingPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:samplingPoints])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setSamplingPoints()
    |> to_struct()
  end
  ...
  **Note**: Number of sampling points must be greater or equal to clusterization seed count.
  ...
  @spec setTranslation(Keyword.t()) :: any() | {:error, String.t()}
  def setTranslation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:value,:idx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setTranslation()
    |> to_struct()
  end
  ...
  **Note**: 
  ...
  @spec setTranslations(Keyword.t()) :: any() | {:error, String.t()}
  def setTranslations([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:translations])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setTranslations()
    |> to_struct()
  end
  ...
  **Note**: 
  ...
  @spec setWeight(Keyword.t()) :: any() | {:error, String.t()}
  def setWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:value,:idx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWeight()
    |> to_struct()
  end
  ...
  **Note**: 
  ...
  @spec setWeightA(Keyword.t()) :: any() | {:error, String.t()}
  def setWeightA([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWeightA()
    |> to_struct()
  end
  ...
  @spec setWeightB(Keyword.t()) :: any() | {:error, String.t()}
  def setWeightB([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWeightB()
    |> to_struct()
  end
  ...
  @spec setWeightContrast(Keyword.t()) :: any() | {:error, String.t()}
  def setWeightContrast([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWeightContrast()
    |> to_struct()
  end
  ...
  @spec setWeightEntropy(Keyword.t()) :: any() | {:error, String.t()}
  def setWeightEntropy([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWeightEntropy()
    |> to_struct()
  end
  ...
  @spec setWeightL(Keyword.t()) :: any() | {:error, String.t()}
  def setWeightL([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWeightL()
    |> to_struct()
  end
  ...
  @spec setWeightX(Keyword.t()) :: any() | {:error, String.t()}
  def setWeightX([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWeightX()
    |> to_struct()
  end
  ...
  @spec setWeightY(Keyword.t()) :: any() | {:error, String.t()}
  def setWeightY([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWeightY()
    |> to_struct()
  end
  ...
  def setWeights([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weights])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWeights()
    |> to_struct()
  end
  ...
  **Note**: 
  ...
  @spec setWindowRadius(Keyword.t()) :: any() | {:error, String.t()}
  def setWindowRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:radius])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignatures_setWindowRadius()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignatures_write()
    |> to_struct()
  end
