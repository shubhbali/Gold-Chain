defmodule Evision.ML.KNearest do
  ...
  def calcError([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.ml_ml_KNearest_calcError()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_create_static()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_empty()
    |> to_struct()
  end
  ...
  def findNearest([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:neighborResponses,:samples,:results,:dist,:k])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_findNearest()
    |> to_struct()
  end
  ...
  def getAlgorithmType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_getAlgorithmType()
    |> to_struct()
  end
  ...
  def getDefaultK([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_getDefaultK()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_KNearest_getDefaultName()
    |> to_struct()
  end
  ...
  def getEmax([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_getEmax()
    |> to_struct()
  end
  ...
  def getIsClassifier([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_getIsClassifier()
    |> to_struct()
  end
  ...
  def getVarCount([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_getVarCount()
    |> to_struct()
  end
  ...
  def isClassifier([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_isClassifier()
    |> to_struct()
  end
  ...
  def isTrained([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_isTrained()
    |> to_struct()
  end
  ...
  def load([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_load_static()
    |> to_struct()
  end
  ...
  def predict([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_predict()
    |> to_struct()
  end
  ...
  @spec setAlgorithmType(Keyword.t()) :: any() | {:error, String.t()}
  def setAlgorithmType([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_setAlgorithmType()
    |> to_struct()
  end
  ...
  @spec setDefaultK(Keyword.t()) :: any() | {:error, String.t()}
  def setDefaultK([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_setDefaultK()
    |> to_struct()
  end
  ...
  @spec setEmax(Keyword.t()) :: any() | {:error, String.t()}
  def setEmax([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_setEmax()
    |> to_struct()
  end
  ...
  @spec setIsClassifier(Keyword.t()) :: any() | {:error, String.t()}
  def setIsClassifier([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_setIsClassifier()
    |> to_struct()
  end
  ...
  def train([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_KNearest_train()
    |> to_struct()
  end
