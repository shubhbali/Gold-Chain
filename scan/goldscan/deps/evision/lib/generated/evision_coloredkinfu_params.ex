defmodule Evision.ColoredKinFu.Params do
  ...
  def params([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.colored_kinfu_colored_kinfu_Params_Params()
    |> to_struct()
  end
  ...
  def coarseParams([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_Params_coarseParams_static()
    |> to_struct()
  end
  ...
  def coloredTSDFParams([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_Params_coloredTSDFParams_static()
    |> to_struct()
  end
  ...
  def defaultParams([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_Params_defaultParams_static()
    |> to_struct()
  end
  ...
  def hashTSDFParams([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:isCoarse])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_Params_hashTSDFParams_static()
    |> to_struct()
  end
  ...
  def setInitialVolumePose([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_Params_setInitialVolumePose()
    |> to_struct()
  end
