defmodule Evision.RGBD do
  ...
  @spec depthTo3d(Keyword.t()) :: any() | {:error, String.t()}
  def depthTo3d([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:points3d,:mask,:depth,:K])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_depthTo3d()
    |> to_struct()
  end
  ...
  @spec depthTo3dSparse(Keyword.t()) :: any() | {:error, String.t()}
  def depthTo3dSparse([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:points3d,:in_points,:in_K,:depth])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_depthTo3dSparse()
    |> to_struct()
  end
  ...
  @spec registerDepth(Keyword.t()) :: any() | {:error, String.t()}
  def registerDepth([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:Rt,:depthDilation,:registeredDepth,:unregisteredDepth,:unregisteredCameraMatrix,:outputImagePlaneSize,:registeredCameraMatrix,:registeredDistCoeffs])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_registerDepth()
    |> to_struct()
  end
  ...
  @spec rescaleDepth(Keyword.t()) :: any() | {:error, String.t()}
  def rescaleDepth([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:in,:depth_factor,:out,:depth])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_rescaleDepth()
    |> to_struct()
  end
  ...
  @spec warpFrame(Keyword.t()) :: any() | {:error, String.t()}
  def warpFrame([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:warpedDepth,:image,:Rt,:mask,:distCoeff,:warpedImage,:warpedMask,:depth,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rgbd_warpFrame()
    |> to_struct()
  end
