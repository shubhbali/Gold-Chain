defmodule Evision.CLAHE do
  ...
  def collectGarbage([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.clahe_collectGarbage()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getClipLimit(Keyword.t()) :: any() | {:error, String.t()}
  def getClipLimit([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.clahe_getClipLimit()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.clahe_getDefaultName()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getTilesGridSize(Keyword.t()) :: any() | {:error, String.t()}
  def getTilesGridSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.clahe_getTilesGridSize()
    |> to_struct()
  end
  ...
  @spec setClipLimit(Keyword.t()) :: any() | {:error, String.t()}
  def setClipLimit([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:clipLimit])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.clahe_setClipLimit()
    |> to_struct()
  end
  ...
  @spec setTilesGridSize(Keyword.t()) :: any() | {:error, String.t()}
  def setTilesGridSize([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:tileGridSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.clahe_setTilesGridSize()
    |> to_struct()
  end
