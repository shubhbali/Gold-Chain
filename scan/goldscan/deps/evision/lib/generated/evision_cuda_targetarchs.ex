defmodule Evision.CUDA.TargetArchs do
  ...
  def has([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minor,:major])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cuda_cuda_TargetArchs_has_static()
    |> to_struct()
  end
  ...
  def hasBin([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minor,:major])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cuda_cuda_TargetArchs_hasBin_static()
    |> to_struct()
  end
  ...
  def hasEqualOrGreater([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minor,:major])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cuda_cuda_TargetArchs_hasEqualOrGreater_static()
    |> to_struct()
  end
  ...
  def hasEqualOrGreaterBin([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minor,:major])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cuda_cuda_TargetArchs_hasEqualOrGreaterBin_static()
    |> to_struct()
  end
  ...
  def hasEqualOrGreaterPtx([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minor,:major])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cuda_cuda_TargetArchs_hasEqualOrGreaterPtx_static()
    |> to_struct()
  end
  ...
  def hasEqualOrLessPtx([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minor,:major])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cuda_cuda_TargetArchs_hasEqualOrLessPtx_static()
    |> to_struct()
  end
  ...
  def hasPtx([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minor,:major])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.cuda_cuda_TargetArchs_hasPtx_static()
    |> to_struct()
  end
