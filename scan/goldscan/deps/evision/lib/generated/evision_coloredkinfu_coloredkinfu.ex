defmodule Evision.ColoredKinFu.ColoredKinFu do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.colored_kinfu_colored_kinfu_ColoredKinFu_create_static()
    |> to_struct()
  end
  ...
  def getCloud([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:points,:colors,:normals])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_ColoredKinFu_getCloud()
    |> to_struct()
  end
  ...
  def getNormals([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_ColoredKinFu_getNormals()
    |> to_struct()
  end
  ...
  def getPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_ColoredKinFu_getPoints()
    |> to_struct()
  end
  ...
  def render([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_ColoredKinFu_render()
    |> to_struct()
  end
  ...
  def reset([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_ColoredKinFu_reset()
    |> to_struct()
  end
  ...
  def update([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rgb,:depth])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.colored_kinfu_colored_kinfu_ColoredKinFu_update()
    |> to_struct()
  end
