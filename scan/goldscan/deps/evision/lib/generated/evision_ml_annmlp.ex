defmodule Evision.ML.ANNMLP do
  ...
  def calcError([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:data,:resp,:test])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_calcError()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_create_static()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_empty()
    |> to_struct()
  end
  ...
  def getAnnealCoolingRatio([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getAnnealCoolingRatio()
    |> to_struct()
  end
  ...
  def getAnnealFinalT([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getAnnealFinalT()
    |> to_struct()
  end
  ...
  def getAnnealInitialT([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getAnnealInitialT()
    |> to_struct()
  end
  ...
  def getAnnealItePerStep([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getAnnealItePerStep()
    |> to_struct()
  end
  ...
  def getBackpropMomentumScale([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getBackpropMomentumScale()
    |> to_struct()
  end
  ...
  def getBackpropWeightScale([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getBackpropWeightScale()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ANN_MLP_getDefaultName()
    |> to_struct()
  end
  ...
  def getLayerSizes([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getLayerSizes()
    |> to_struct()
  end
  ...
  def getRpropDW0([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getRpropDW0()
    |> to_struct()
  end
  ...
  def getRpropDWMax([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getRpropDWMax()
    |> to_struct()
  end
  ...
  def getRpropDWMin([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getRpropDWMin()
    |> to_struct()
  end
  ...
  def getRpropDWMinus([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getRpropDWMinus()
    |> to_struct()
  end
  ...
  def getRpropDWPlus([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getRpropDWPlus()
    |> to_struct()
  end
  ...
  def getTermCriteria([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getTermCriteria()
    |> to_struct()
  end
  ...
  def getTrainMethod([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getTrainMethod()
    |> to_struct()
  end
  ...
  def getVarCount([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getVarCount()
    |> to_struct()
  end
  ...
  def getWeights([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:layerIdx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_getWeights()
    |> to_struct()
  end
  ...
  def isClassifier([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_isClassifier()
    |> to_struct()
  end
  ...
  def isTrained([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_isTrained()
    |> to_struct()
  end
  ...
  def load([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filepath])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_load_static()
    |> to_struct()
  end
  ...
  def predict([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:samples,:flags,:results])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_predict()
    |> to_struct()
  end
  ...
  @spec setActivationFunction(Keyword.t()) :: any() | {:error, String.t()}
  def setActivationFunction([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:type,:param1,:param2])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setActivationFunction()
    |> to_struct()
  end
  ...
  @spec setAnnealCoolingRatio(Keyword.t()) :: any() | {:error, String.t()}
  def setAnnealCoolingRatio([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setAnnealCoolingRatio()
    |> to_struct()
  end
  ...
  @spec setAnnealFinalT(Keyword.t()) :: any() | {:error, String.t()}
  def setAnnealFinalT([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setAnnealFinalT()
    |> to_struct()
  end
  ...
  @spec setAnnealInitialT(Keyword.t()) :: any() | {:error, String.t()}
  def setAnnealInitialT([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setAnnealInitialT()
    |> to_struct()
  end
  ...
  @spec setAnnealItePerStep(Keyword.t()) :: any() | {:error, String.t()}
  def setAnnealItePerStep([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setAnnealItePerStep()
    |> to_struct()
  end
  ...
  @spec setBackpropMomentumScale(Keyword.t()) :: any() | {:error, String.t()}
  def setBackpropMomentumScale([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setBackpropMomentumScale()
    |> to_struct()
  end
  ...
  @spec setBackpropWeightScale(Keyword.t()) :: any() | {:error, String.t()}
  def setBackpropWeightScale([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setBackpropWeightScale()
    |> to_struct()
  end
  ...
  @spec setLayerSizes(Keyword.t()) :: any() | {:error, String.t()}
  def setLayerSizes([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_layer_sizes])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setLayerSizes()
    |> to_struct()
  end
  ...
  @spec setRpropDW0(Keyword.t()) :: any() | {:error, String.t()}
  def setRpropDW0([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setRpropDW0()
    |> to_struct()
  end
  ...
  @spec setRpropDWMax(Keyword.t()) :: any() | {:error, String.t()}
  def setRpropDWMax([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setRpropDWMax()
    |> to_struct()
  end
  ...
  @spec setRpropDWMin(Keyword.t()) :: any() | {:error, String.t()}
  def setRpropDWMin([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setRpropDWMin()
    |> to_struct()
  end
  ...
  @spec setRpropDWMinus(Keyword.t()) :: any() | {:error, String.t()}
  def setRpropDWMinus([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setRpropDWMinus()
    |> to_struct()
  end
  ...
  @spec setRpropDWPlus(Keyword.t()) :: any() | {:error, String.t()}
  def setRpropDWPlus([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setRpropDWPlus()
    |> to_struct()
  end
  ...
  def setTermCriteria([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setTermCriteria()
    |> to_struct()
  end
  ...
  def setTrainMethod([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:method,:param1,:param2])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_setTrainMethod()
    |> to_struct()
  end
  ...
  def train([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:flags,:trainData,:samples,:responses,:layout])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_ANN_MLP_train()
    |> to_struct()
  end
