defmodule Evision.ML.Boost do
  ...
  def calcError([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.ml_ml_Boost_calcError()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_create_static()
    |> to_struct()
  end
  ...
  def getBoostType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getBoostType()
    |> to_struct()
  end
  ...
  def getCVFolds([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getCVFolds()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_Boost_getDefaultName()
    |> to_struct()
  end
  ...
  def getMaxCategories([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getMaxCategories()
    |> to_struct()
  end
  ...
  def getMaxDepth([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getMaxDepth()
    |> to_struct()
  end
  ...
  def getMinSampleCount([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getMinSampleCount()
    |> to_struct()
  end
  ...
  def getPriors([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getPriors()
    |> to_struct()
  end
  ...
  def getRegressionAccuracy([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getRegressionAccuracy()
    |> to_struct()
  end
  ...
  def getTruncatePrunedTree([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getTruncatePrunedTree()
    |> to_struct()
  end
  ...
  def getUse1SERule([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getUse1SERule()
    |> to_struct()
  end
  ...
  def getUseSurrogates([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getUseSurrogates()
    |> to_struct()
  end
  ...
  def getVarCount([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getVarCount()
    |> to_struct()
  end
  ...
  def getWeakCount([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getWeakCount()
    |> to_struct()
  end
  ...
  def getWeightTrimRate([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_getWeightTrimRate()
    |> to_struct()
  end
  ...
  def isClassifier([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_isClassifier()
    |> to_struct()
  end
  ...
  def isTrained([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_isTrained()
    |> to_struct()
  end
  ...
  def load([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_load_static()
    |> to_struct()
  end
  ...
  def predict([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_predict()
    |> to_struct()
  end
  ...
  @spec setBoostType(Keyword.t()) :: any() | {:error, String.t()}
  def setBoostType([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setBoostType()
    |> to_struct()
  end
  ...
  def setCVFolds([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setCVFolds()
    |> to_struct()
  end
  ...
  def setMaxCategories([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setMaxCategories()
    |> to_struct()
  end
  ...
  def setMaxDepth([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setMaxDepth()
    |> to_struct()
  end
  ...
  def setMinSampleCount([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setMinSampleCount()
    |> to_struct()
  end
  ...
  def setPriors([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setPriors()
    |> to_struct()
  end
  ...
  def setRegressionAccuracy([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setRegressionAccuracy()
    |> to_struct()
  end
  ...
  def setTruncatePrunedTree([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setTruncatePrunedTree()
    |> to_struct()
  end
  ...
  def setUse1SERule([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setUse1SERule()
    |> to_struct()
  end
  ...
  def setUseSurrogates([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setUseSurrogates()
    |> to_struct()
  end
  ...
  @spec setWeakCount(Keyword.t()) :: any() | {:error, String.t()}
  def setWeakCount([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setWeakCount()
    |> to_struct()
  end
  ...
  @spec setWeightTrimRate(Keyword.t()) :: any() | {:error, String.t()}
  def setWeightTrimRate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_Boost_setWeightTrimRate()
    |> to_struct()
  end
