defmodule Evision.ArUco.EstimateParameters do
  ...
  @spec estimateParameters(Keyword.t()) :: any() | {:error, String.t()}
  def estimateParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_EstimateParameters_EstimateParameters()
    |> to_struct()
  end
