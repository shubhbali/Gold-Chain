defmodule Evision.Detail.BestOf2NearestRangeMatcher do
  ...
  def bestOf2NearestRangeMatcher([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:try_use_gpu,:num_matches_thresh2,:match_conf,:num_matches_thresh1,:range_width])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestRangeMatcher_BestOf2NearestRangeMatcher()
    |> to_struct()
  end
  ...
  def apply([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:features1,:features2,:matches_info])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestRangeMatcher_apply()
    |> to_struct()
  end
  ...
  def apply2([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:pairwise_matches,:features,:mask])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestRangeMatcher_apply2()
    |> to_struct()
  end
  ...
  def collectGarbage([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestRangeMatcher_collectGarbage()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:try_use_gpu,:matches_confindece_thresh,:num_matches_thresh2,:match_conf,:num_matches_thresh1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestRangeMatcher_create_static()
    |> to_struct()
  end
  ...
  def isThreadSafe([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestRangeMatcher_isThreadSafe()
    |> to_struct()
  end
