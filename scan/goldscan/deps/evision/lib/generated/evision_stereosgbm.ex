defmodule Evision.StereoSGBM do
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_compute()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:numDisparities,:blockSize,:disp12MaxDiff,:speckleRange,:preFilterCap,:P1,:mode,:uniquenessRatio,:P2,:minDisparity,:speckleWindowSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_create_static()
    |> to_struct()
  end
  ...
  def getBlockSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getBlockSize()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getDefaultName()
    |> to_struct()
  end
  ...
  def getDisp12MaxDiff([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getDisp12MaxDiff()
    |> to_struct()
  end
  ...
  def getMinDisparity([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getMinDisparity()
    |> to_struct()
  end
  ...
  def getMode([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getMode()
    |> to_struct()
  end
  ...
  def getNumDisparities([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getNumDisparities()
    |> to_struct()
  end
  ...
  def getP1([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getP1()
    |> to_struct()
  end
  ...
  def getP2([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getP2()
    |> to_struct()
  end
  ...
  def getPreFilterCap([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getPreFilterCap()
    |> to_struct()
  end
  ...
  def getSpeckleRange([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getSpeckleRange()
    |> to_struct()
  end
  ...
  def getSpeckleWindowSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getSpeckleWindowSize()
    |> to_struct()
  end
  ...
  def getUniquenessRatio([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_getUniquenessRatio()
    |> to_struct()
  end
  ...
  def setBlockSize([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setBlockSize()
    |> to_struct()
  end
  ...
  def setDisp12MaxDiff([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setDisp12MaxDiff()
    |> to_struct()
  end
  ...
  def setMinDisparity([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setMinDisparity()
    |> to_struct()
  end
  ...
  def setMode([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setMode()
    |> to_struct()
  end
  ...
  def setNumDisparities([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setNumDisparities()
    |> to_struct()
  end
  ...
  @spec setP1(Keyword.t()) :: any() | {:error, String.t()}
  def setP1([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:P1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setP1()
    |> to_struct()
  end
  ...
  @spec setP2(Keyword.t()) :: any() | {:error, String.t()}
  def setP2([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:P2])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setP2()
    |> to_struct()
  end
  ...
  def setPreFilterCap([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setPreFilterCap()
    |> to_struct()
  end
  ...
  def setSpeckleRange([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setSpeckleRange()
    |> to_struct()
  end
  ...
  def setSpeckleWindowSize([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setSpeckleWindowSize()
    |> to_struct()
  end
  ...
  def setUniquenessRatio([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereoSGBM_setUniquenessRatio()
    |> to_struct()
  end
