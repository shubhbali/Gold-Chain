defmodule Evision.CirclesGridFinderParameters do
  ...
  @spec circlesGridFinderParameters(Keyword.t()) :: any() | {:error, String.t()}
  def circlesGridFinderParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.circlesGridFinderParameters_CirclesGridFinderParameters()
    |> to_struct()
  end
