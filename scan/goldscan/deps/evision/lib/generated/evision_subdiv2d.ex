defmodule Evision.Subdiv2D do
  ...
  ```
  """
  @spec subdiv2D(Keyword.t()) :: any() | {:error, String.t()}
  def subdiv2D([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rect])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_Subdiv2D()
    |> to_struct()
  end
  ...
  @spec edgeDst(Keyword.t()) :: any() | {:error, String.t()}
  def edgeDst([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:dstpt,:edge])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_edgeDst()
    |> to_struct()
  end
  ...
  @spec edgeOrg(Keyword.t()) :: any() | {:error, String.t()}
  def edgeOrg([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:orgpt,:edge])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_edgeOrg()
    |> to_struct()
  end
  ...
  @spec findNearest(Keyword.t()) :: any() | {:error, String.t()}
  def findNearest([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:nearestPt,:pt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_findNearest()
    |> to_struct()
  end
  ...
  @spec getEdge(Keyword.t()) :: any() | {:error, String.t()}
  def getEdge([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:nextEdgeType,:edge])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_getEdge()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getEdgeList(Keyword.t()) :: any() | {:error, String.t()}
  def getEdgeList([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:edgeList])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_getEdgeList()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getLeadingEdgeList(Keyword.t()) :: any() | {:error, String.t()}
  def getLeadingEdgeList([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:leadingEdgeList])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_getLeadingEdgeList()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getTriangleList(Keyword.t()) :: any() | {:error, String.t()}
  def getTriangleList([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:triangleList])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_getTriangleList()
    |> to_struct()
  end
  ...
  @spec getVertex(Keyword.t()) :: any() | {:error, String.t()}
  def getVertex([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vertex,:firstEdge])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_getVertex()
    |> to_struct()
  end
  ...
  @spec getVoronoiFacetList(Keyword.t()) :: any() | {:error, String.t()}
  def getVoronoiFacetList([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:facetCenters,:idx,:facetList])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_getVoronoiFacetList()
    |> to_struct()
  end
  ...
  @spec initDelaunay(Keyword.t()) :: any() | {:error, String.t()}
  def initDelaunay([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rect])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_initDelaunay()
    |> to_struct()
  end
  ...
  @spec insert(Keyword.t()) :: any() | {:error, String.t()}
  def insert([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:ptvec,:pt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_insert()
    |> to_struct()
  end
  ...
  **Note**: If the point is outside of the triangulation specified rect a runtime error is raised.
  ...
  @spec locate(Keyword.t()) :: any() | {:error, String.t()}
  def locate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:edge,:vertex,:pt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_locate()
    |> to_struct()
  end
  ...
  @spec nextEdge(Keyword.t()) :: any() | {:error, String.t()}
  def nextEdge([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:edge])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_nextEdge()
    |> to_struct()
  end
  ...
  @spec rotateEdge(Keyword.t()) :: any() | {:error, String.t()}
  def rotateEdge([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rotate,:edge])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_rotateEdge()
    |> to_struct()
  end
  ...
  @spec symEdge(Keyword.t()) :: any() | {:error, String.t()}
  def symEdge([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:edge])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.subdiv2D_symEdge()
    |> to_struct()
  end
