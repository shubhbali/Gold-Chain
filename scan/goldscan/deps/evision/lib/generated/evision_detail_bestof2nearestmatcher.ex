defmodule Evision.Detail.BestOf2NearestMatcher do
  ...
  def bestOf2NearestMatcher([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.detail_detail_BestOf2NearestMatcher_BestOf2NearestMatcher()
    |> to_struct()
  end
  ...
  def apply([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestMatcher_apply()
    |> to_struct()
  end
  ...
  def apply2([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestMatcher_apply2()
    |> to_struct()
  end
  ...
  def collectGarbage([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestMatcher_collectGarbage()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:try_use_gpu,:matches_confindece_thresh,:num_matches_thresh2,:match_conf,:num_matches_thresh1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestMatcher_create_static()
    |> to_struct()
  end
  ...
  def isThreadSafe([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BestOf2NearestMatcher_isThreadSafe()
    |> to_struct()
  end
