defmodule Evision.Intensitytransform do
  ...
  def bimef([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:input,:b,:output,:mu,:a])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.intensity_transform_BIMEF()
    |> to_struct()
  end
  ...
  @spec bimef2(Keyword.t()) :: any() | {:error, String.t()}
  def bimef2([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:input,:b,:output,:mu,:a,:k])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.intensity_transform_BIMEF2()
    |> to_struct()
  end
  ...
  @spec autoscaling(Keyword.t()) :: any() | {:error, String.t()}
  def autoscaling([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:input,:output])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.intensity_transform_autoscaling()
    |> to_struct()
  end
  ...
  @spec contrastStretching(Keyword.t()) :: any() | {:error, String.t()}
  def contrastStretching([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:s2,:input,:s1,:output,:r2,:r1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.intensity_transform_contrastStretching()
    |> to_struct()
  end
  ...
  def gammaCorrection([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:gamma,:input,:output])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.intensity_transform_gammaCorrection()
    |> to_struct()
  end
  ...
  @spec logTransform(Keyword.t()) :: any() | {:error, String.t()}
  def logTransform([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:input,:output])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.intensity_transform_logTransform()
    |> to_struct()
  end
