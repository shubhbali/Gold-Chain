defmodule Evision.Detail do
  ...
  def calibrateRotatingCamera([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:K,:Hs])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_calibrateRotatingCamera()
    |> to_struct()
  end
  ...
  @spec computeImageFeatures(Keyword.t()) :: any() | {:error, String.t()}
  def computeImageFeatures([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:images,:featuresFinder,:features,:masks])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_computeImageFeatures()
    |> to_struct()
  end
  ...
  @spec computeImageFeatures2(Keyword.t()) :: any() | {:error, String.t()}
  def computeImageFeatures2([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:featuresFinder,:features,:image,:mask])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_computeImageFeatures2()
    |> to_struct()
  end
  ...
  @spec createLaplacePyr(Keyword.t()) :: any() | {:error, String.t()}
  def createLaplacePyr([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:pyr,:num_levels])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_createLaplacePyr()
    |> to_struct()
  end
  ...
  @spec createLaplacePyrGpu(Keyword.t()) :: any() | {:error, String.t()}
  def createLaplacePyrGpu([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:pyr,:num_levels])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_createLaplacePyrGpu()
    |> to_struct()
  end
  ...
  @spec createWeightMap(Keyword.t()) :: any() | {:error, String.t()}
  def createWeightMap([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight,:mask,:sharpness])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_createWeightMap()
    |> to_struct()
  end
  ...
  @spec focalsFromHomography(Keyword.t()) :: any() | {:error, String.t()}
  def focalsFromHomography([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:H,:f0_ok,:f1_ok,:f0,:f1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_focalsFromHomography()
    |> to_struct()
  end
  ...
  @spec leaveBiggestComponent(Keyword.t()) :: any() | {:error, String.t()}
  def leaveBiggestComponent([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:pairwise_matches,:conf_threshold,:features])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_leaveBiggestComponent()
    |> to_struct()
  end
  ...
  @spec matchesGraphAsString(Keyword.t()) :: any() | {:error, String.t()}
  def matchesGraphAsString([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:paths,:conf_threshold,:pairwise_matches])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_matchesGraphAsString()
    |> to_struct()
  end
  ...
  @spec normalizeUsingWeightMap(Keyword.t()) :: any() | {:error, String.t()}
  def normalizeUsingWeightMap([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight,:src])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_normalizeUsingWeightMap()
    |> to_struct()
  end
  ...
  @spec overlapRoi(Keyword.t()) :: any() | {:error, String.t()}
  def overlapRoi([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:tl2,:sz1,:roi,:tl1,:sz2])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_overlapRoi()
    |> to_struct()
  end
  ...
  def restoreImageFromLaplacePyr([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:pyr])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_restoreImageFromLaplacePyr()
    |> to_struct()
  end
  ...
  def restoreImageFromLaplacePyrGpu([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:pyr])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_restoreImageFromLaplacePyrGpu()
    |> to_struct()
  end
  ...
  @spec resultRoi(Keyword.t()) :: any() | {:error, String.t()}
  def resultRoi([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:images,:corners,:sizes])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_resultRoi()
    |> to_struct()
  end
  ...
  @spec resultRoiIntersection(Keyword.t()) :: any() | {:error, String.t()}
  def resultRoiIntersection([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sizes,:corners])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_resultRoiIntersection()
    |> to_struct()
  end
  ...
  def resultTl([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:corners])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_resultTl()
    |> to_struct()
  end
  ...
  @spec selectRandomSubset(Keyword.t()) :: any() | {:error, String.t()}
  def selectRandomSubset([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:subset,:size,:count])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_selectRandomSubset()
    |> to_struct()
  end
  ...
  @spec stitchingLogLevel(Keyword.t()) :: any() | {:error, String.t()}
  def stitchingLogLevel([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_stitchingLogLevel()
    |> to_struct()
  end
  ...
  @spec waveCorrect(Keyword.t()) :: any() | {:error, String.t()}
  def waveCorrect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rmats,:kind])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_waveCorrect()
    |> to_struct()
  end
