defmodule Evision.DNN.SegmentationModel do
  ...
  """
  @spec segmentationModel(Keyword.t()) :: any() | {:error, String.t()}
  def segmentationModel([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:network,:model,:config])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_SegmentationModel()
    |> to_struct()
  end
  ...
  def enableWinograd([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_enableWinograd()
    |> to_struct()
  end
  ...
  def predict([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_predict()
    |> to_struct()
  end
  ...
  @spec segment(Keyword.t()) :: any() | {:error, String.t()}
  def segment([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:frame,:mask])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_segment()
    |> to_struct()
  end
  ...
  def setInputCrop([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_setInputCrop()
    |> to_struct()
  end
  ...
  def setInputMean([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_setInputMean()
    |> to_struct()
  end
  ...
  def setInputParams([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_setInputParams()
    |> to_struct()
  end
  ...
  def setInputScale([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_setInputScale()
    |> to_struct()
  end
  ...
  def setInputSize([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_setInputSize()
    |> to_struct()
  end
  ...
  **Note**: If shape of the new blob less than 0, then frame size not change.
  ...
  def setInputSwapRB([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_setInputSwapRB()
    |> to_struct()
  end
  ...
  def setOutputNames([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_setOutputNames()
    |> to_struct()
  end
  ...
  def setPreferableBackend([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_setPreferableBackend()
    |> to_struct()
  end
  ...
  def setPreferableTarget([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_SegmentationModel_setPreferableTarget()
    |> to_struct()
  end
