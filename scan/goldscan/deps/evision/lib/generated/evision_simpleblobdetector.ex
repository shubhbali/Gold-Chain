defmodule Evision.SimpleBlobDetector do
  ...
  @doc false
  def to_struct({:ok, %{class: Evision.SimpleBlobDetector, ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  @doc false
  def to_struct(%{class: Evision.SimpleBlobDetector, ref: ref}) do
    %T{
      ref: ref
    }
  end
  ...
  - **self**: `Evision.SimpleBlobDetector.t()`
  - **images**: `[Evision.Mat]`.
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.simpleBlobDetector_compute()
    |> to_struct()
  end
  ...
  ##### Return
  - **retval**: `Evision.SimpleBlobDetector.t()`
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_create_static()
    |> to_struct()
  end
  @spec create([{:parameters, term()}] | nil) :: Evision.SimpleBlobDetector.t() | {:error, String.t()}
  ...
  def defaultNorm([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_defaultNorm()
    |> to_struct()
  end
  ...
  def descriptorSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_descriptorSize()
    |> to_struct()
  end
  ...
  def descriptorType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_descriptorType()
    |> to_struct()
  end
  ...
  """
  @spec detect(Evision.SimpleBlobDetector.t(), list(Evision.Mat.maybe_mat_in()), [{:masks, term()}] | nil) :: list(list(Evision.KeyPoint.t())) | {:error, String.t()}
  ...
  @spec detect(Evision.SimpleBlobDetector.t(), Evision.Mat.maybe_mat_in(), [{:mask, term()}] | nil) :: list(Evision.KeyPoint.t()) | {:error, String.t()}
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_detect()
    |> to_struct()
  end
  ...
  ```
  """
  @spec detectAndCompute(Evision.SimpleBlobDetector.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), [{:useProvidedKeypoints, term()}] | nil) :: {list(Evision.KeyPoint.t()), Evision.Mat.t()} | {:error, String.t()}
  ...
  def detectAndCompute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_detectAndCompute()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_empty()
    |> to_struct()
  end
  ...
  def getBlobContours([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_getBlobContours()
    |> to_struct()
  end
  @spec getBlobContours(Evision.SimpleBlobDetector.t()) :: list(list({number(), number()})) | {:error, String.t()}
  def getBlobContours(self) do
    positional = [
    ]
    :evision_nif.simpleBlobDetector_getBlobContours(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_getDefaultName()
    |> to_struct()
  end
  ...
  ##### Return
  - **retval**: `Evision.SimpleBlobDetector.Params.t()`
  ...
  def getParams([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_getParams()
    |> to_struct()
  end
  @spec getParams(Evision.SimpleBlobDetector.t()) :: Evision.SimpleBlobDetector.Params.t() | {:error, String.t()}
  def getParams(self) do
    positional = [
    ]
    :evision_nif.simpleBlobDetector_getParams(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_read()
    |> to_struct()
  end
  ...
  """
  @spec read(Evision.SimpleBlobDetector.t(), Evision.FileNode.t()) :: Evision.SimpleBlobDetector.t() | {:error, String.t()}
  ...
  @spec read(Evision.SimpleBlobDetector.t(), binary()) :: Evision.SimpleBlobDetector.t() | {:error, String.t()}
  ...
  def setParams([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:params])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_setParams()
    |> to_struct()
  end
  ...
  ##### Positional Arguments
  - **self**: `Evision.SimpleBlobDetector.t()`
  - **params**: `Evision.SimpleBlobDetector.Params`
  ...
  ```
  """
  @spec setParams(Evision.SimpleBlobDetector.t(), Evision.SimpleBlobDetector.Params.t()) :: Evision.SimpleBlobDetector.t() | {:error, String.t()}
  def setParams(self, params) when is_struct(params, Evision.SimpleBlobDetector.Params)
  do
    positional = [
      params: Evision.Internal.Structurise.from_struct(params)
    ]
    :evision_nif.simpleBlobDetector_setParams(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.simpleBlobDetector_write()
    |> to_struct()
  end
  ...
  ```
  """
  @spec write(Evision.SimpleBlobDetector.t(), Evision.FileStorage.t(), binary()) :: Evision.SimpleBlobDetector.t() | {:error, String.t()}
  ...
  ```
  """
  @spec write(Evision.SimpleBlobDetector.t(), binary()) :: Evision.SimpleBlobDetector.t() | {:error, String.t()}
