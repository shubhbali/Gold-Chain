defmodule Evision.Plot.Plot2d do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:data,:dataY,:dataX])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_create_static()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_Plot2d_getDefaultName()
    |> to_struct()
  end
  ...
  def render([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotResult])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_render()
    |> to_struct()
  end
  ...
  @spec setGridLinesNumber(Keyword.t()) :: any() | {:error, String.t()}
  def setGridLinesNumber([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:gridLinesNumber])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setGridLinesNumber()
    |> to_struct()
  end
  ...
  @spec setInvertOrientation(Keyword.t()) :: any() | {:error, String.t()}
  def setInvertOrientation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_invertOrientation])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setInvertOrientation()
    |> to_struct()
  end
  ...
  @spec setMaxX(Keyword.t()) :: any() | {:error, String.t()}
  def setMaxX([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotMaxX])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setMaxX()
    |> to_struct()
  end
  ...
  @spec setMaxY(Keyword.t()) :: any() | {:error, String.t()}
  def setMaxY([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotMaxY])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setMaxY()
    |> to_struct()
  end
  ...
  @spec setMinX(Keyword.t()) :: any() | {:error, String.t()}
  def setMinX([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotMinX])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setMinX()
    |> to_struct()
  end
  ...
  @spec setMinY(Keyword.t()) :: any() | {:error, String.t()}
  def setMinY([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotMinY])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setMinY()
    |> to_struct()
  end
  ...
  @spec setNeedPlotLine(Keyword.t()) :: any() | {:error, String.t()}
  def setNeedPlotLine([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_needPlotLine])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setNeedPlotLine()
    |> to_struct()
  end
  ...
  @spec setPlotAxisColor(Keyword.t()) :: any() | {:error, String.t()}
  def setPlotAxisColor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotAxisColor])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setPlotAxisColor()
    |> to_struct()
  end
  ...
  @spec setPlotBackgroundColor(Keyword.t()) :: any() | {:error, String.t()}
  def setPlotBackgroundColor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotBackgroundColor])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setPlotBackgroundColor()
    |> to_struct()
  end
  ...
  @spec setPlotGridColor(Keyword.t()) :: any() | {:error, String.t()}
  def setPlotGridColor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotGridColor])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setPlotGridColor()
    |> to_struct()
  end
  ...
  @spec setPlotLineColor(Keyword.t()) :: any() | {:error, String.t()}
  def setPlotLineColor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotLineColor])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setPlotLineColor()
    |> to_struct()
  end
  ...
  @spec setPlotLineWidth(Keyword.t()) :: any() | {:error, String.t()}
  def setPlotLineWidth([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotLineWidth])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setPlotLineWidth()
    |> to_struct()
  end
  ...
  @spec setPlotSize(Keyword.t()) :: any() | {:error, String.t()}
  def setPlotSize([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotSizeWidth,:_plotSizeHeight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setPlotSize()
    |> to_struct()
  end
  ...
  @spec setPlotTextColor(Keyword.t()) :: any() | {:error, String.t()}
  def setPlotTextColor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_plotTextColor])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setPlotTextColor()
    |> to_struct()
  end
  ...
  @spec setPointIdxToPrint(Keyword.t()) :: any() | {:error, String.t()}
  def setPointIdxToPrint([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:pointIdx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setPointIdxToPrint()
    |> to_struct()
  end
  ...
  @spec setShowGrid(Keyword.t()) :: any() | {:error, String.t()}
  def setShowGrid([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:needShowGrid])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setShowGrid()
    |> to_struct()
  end
  ...
  @spec setShowText(Keyword.t()) :: any() | {:error, String.t()}
  def setShowText([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:needShowText])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.plot_plot_Plot2d_setShowText()
    |> to_struct()
  end
