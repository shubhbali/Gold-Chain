defmodule Evision.CCM.ColorCorrectionModel do
  ...
  def colorCorrectionModel([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:ref_cs,:src,:colored,:colors,:constcolor])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_ColorCorrectionModel()
    |> to_struct()
  end
  ...
  def getCCM([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_getCCM()
    |> to_struct()
  end
  ...
  def getLoss([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_getLoss()
    |> to_struct()
  end
  ...
  def getMask([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_getMask()
    |> to_struct()
  end
  ...
  def getWeights([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_getWeights()
    |> to_struct()
  end
  ...
  def get_dst_rgbl([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_get_dst_rgbl()
    |> to_struct()
  end
  ...
  def get_src_rgbl([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_get_src_rgbl()
    |> to_struct()
  end
  ...
  @spec infer(Keyword.t()) :: any() | {:error, String.t()}
  def infer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:islinear,:img])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_infer()
    |> to_struct()
  end
  ...
  def run([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_run()
    |> to_struct()
  end
  ...
  @spec setCCM_TYPE(Keyword.t()) :: any() | {:error, String.t()}
  def setCCM_TYPE([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:ccm_type])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setCCM_TYPE()
    |> to_struct()
  end
  ...
  def setColorSpace([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:cs])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setColorSpace()
    |> to_struct()
  end
  ...
  **Note**: It should be some RGB color space;
  ...
  def setDistance([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:distance])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setDistance()
    |> to_struct()
  end
  ...
  def setEpsilon([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:epsilon])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setEpsilon()
    |> to_struct()
  end
  ...
  def setInitialMethod([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:initial_method_type])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setInitialMethod()
    |> to_struct()
  end
  ...
  @spec setLinear(Keyword.t()) :: any() | {:error, String.t()}
  def setLinear([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:linear_type])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setLinear()
    |> to_struct()
  end
  ...
  @spec setLinearDegree(Keyword.t()) :: any() | {:error, String.t()}
  def setLinearDegree([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:deg])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setLinearDegree()
    |> to_struct()
  end
  ...
  **Note**: only valid when linear is set to
  ...
  @spec setLinearGamma(Keyword.t()) :: any() | {:error, String.t()}
  def setLinearGamma([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:gamma])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setLinearGamma()
    |> to_struct()
  end
  ...
  **Note**: only valid when linear is set to "gamma";\\n
  ...
  def setMaxCount([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:max_count])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setMaxCount()
    |> to_struct()
  end
  ...
  def setSaturatedThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:lower,:upper])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setSaturatedThreshold()
    |> to_struct()
  end
  ...
  def setWeightCoeff([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weights_coeff])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setWeightCoeff()
    |> to_struct()
  end
  ...
  def setWeightsList([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weights_list])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ccm_ccm_ColorCorrectionModel_setWeightsList()
    |> to_struct()
  end
