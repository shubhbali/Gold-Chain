defmodule Evision.StructuredLight.SinusoidalPattern.Params do
  ...
  @spec structured_light_SinusoidalPattern_Params(Keyword.t()) :: any() | {:error, String.t()}
  def structured_light_SinusoidalPattern_Params([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.structured_light_structured_light_SinusoidalPattern_Params_SinusoidalPattern_Params()
    |> to_struct()
  end
