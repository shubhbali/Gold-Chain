defmodule Evision.MergeRobertson do
  import Kernel, except: [apply: 2, apply: 3]

  @typedoc """
  Type that represents an `MergeRobertson` struct.
  ...
  @doc false
  def to_struct({:ok, %{class: Evision.MergeRobertson, ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  @doc false
  def to_struct(%{class: Evision.MergeRobertson, ref: ref}) do
    %T{
      ref: ref
    }
  end
  ...
  ```
  """
  @spec process(Evision.MergeRobertson.t(), list(Evision.Mat.maybe_mat_in()), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), [{atom(), term()},...] | nil) :: Evision.Mat.t() | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.mergeRobertson_process(Evision.Internal.Structurise.from_struct(self), positional ++ Evision.Internal.Structurise.from_struct(opts || []))
     |> to_struct()
  end
  ...
  def process([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.mergeRobertson_process()
    |> to_struct()
  end
  ...
  """
  @spec process(Evision.MergeRobertson.t(), list(Evision.Mat.maybe_mat_in()), Evision.Mat.maybe_mat_in(), [{atom(), term()},...] | nil) :: Evision.Mat.t() | {:error, String.t()}
  ...
  @spec process(Evision.MergeRobertson.t(), list(Evision.Mat.maybe_mat_in()), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in()) :: Evision.Mat.t() | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.mergeRobertson_process(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  ```
  """
  @spec process(Evision.MergeRobertson.t(), list(Evision.Mat.maybe_mat_in()), Evision.Mat.maybe_mat_in()) :: Evision.Mat.t() | {:error, String.t()}
