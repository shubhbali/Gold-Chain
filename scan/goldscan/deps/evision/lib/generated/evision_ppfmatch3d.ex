defmodule Evision.PPFMatch3D do
  ...
  @spec addNoisePC(Keyword.t()) :: any() | {:error, String.t()}
  def addNoisePC([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:scale,:pc])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_addNoisePC()
    |> to_struct()
  end
  ...
  @spec computeNormalsPC3d(Keyword.t()) :: any() | {:error, String.t()}
  def computeNormalsPC3d([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:PC,:FlipViewpoint,:PCNormals,:NumNeighbors,:viewpoint])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_computeNormalsPC3d()
    |> to_struct()
  end
  ...
  def getRandomPose([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:Pose])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_getRandomPose()
    |> to_struct()
  end
  ...
  def loadPLYSimple([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:fileName,:withNormals])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_loadPLYSimple()
    |> to_struct()
  end
  ...
  @spec samplePCByQuantization(Keyword.t()) :: any() | {:error, String.t()}
  def samplePCByQuantization([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sample_step_relative,:pc,:yrange,:weightByCenter,:xrange,:zrange])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_samplePCByQuantization()
    |> to_struct()
  end
  ...
  @spec transformPCPose(Keyword.t()) :: any() | {:error, String.t()}
  def transformPCPose([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:Pose,:pc])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_transformPCPose()
    |> to_struct()
  end
  ...
  @spec writePLY(Keyword.t()) :: any() | {:error, String.t()}
  def writePLY([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:fileName,:PC])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_writePLY()
    |> to_struct()
  end
  ...
  @spec writePLYVisibleNormals(Keyword.t()) :: any() | {:error, String.t()}
  def writePLYVisibleNormals([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:fileName,:PC])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_writePLYVisibleNormals()
    |> to_struct()
  end
