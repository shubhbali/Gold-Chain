defmodule Evision.XFeatures2D.HarrisLaplaceFeatureDetector do
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.xfeatures2d_HarrisLaplaceFeatureDetector_compute()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:numOctaves,:maxCorners,:num_layers,:DOG_thresh,:corn_thresh])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_create_static()
    |> to_struct()
  end
  ...
  def defaultNorm([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_HarrisLaplaceFeatureDetector_defaultNorm()
    |> to_struct()
  end
  ...
  def descriptorSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_HarrisLaplaceFeatureDetector_descriptorSize()
    |> to_struct()
  end
  ...
  def descriptorType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_HarrisLaplaceFeatureDetector_descriptorType()
    |> to_struct()
  end
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_HarrisLaplaceFeatureDetector_detect()
    |> to_struct()
  end
  ...
  def detectAndCompute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_HarrisLaplaceFeatureDetector_detectAndCompute()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_HarrisLaplaceFeatureDetector_empty()
    |> to_struct()
  end
  ...
  def getCornThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_getCornThresh()
    |> to_struct()
  end
  ...
  def getDOGThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_getDOGThresh()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_getDefaultName()
    |> to_struct()
  end
  ...
  def getMaxCorners([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_getMaxCorners()
    |> to_struct()
  end
  ...
  def getNumLayers([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_getNumLayers()
    |> to_struct()
  end
  ...
  def getNumOctaves([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_getNumOctaves()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_HarrisLaplaceFeatureDetector_read()
    |> to_struct()
  end
  ...
  def setCornThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:corn_thresh_])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_setCornThresh()
    |> to_struct()
  end
  ...
  def setDOGThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:DOG_thresh_])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_setDOGThresh()
    |> to_struct()
  end
  ...
  def setMaxCorners([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:maxCorners_])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_setMaxCorners()
    |> to_struct()
  end
  ...
  def setNumLayers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:num_layers_])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_setNumLayers()
    |> to_struct()
  end
  ...
  def setNumOctaves([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:numOctaves_])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_HarrisLaplaceFeatureDetector_setNumOctaves()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_HarrisLaplaceFeatureDetector_write()
    |> to_struct()
  end
