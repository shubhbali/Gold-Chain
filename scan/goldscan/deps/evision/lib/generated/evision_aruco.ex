defmodule Evision.ArUco do
  ...
  @spec calibrateCameraAruco(Keyword.t()) :: any() | {:error, String.t()}
  def calibrateCameraAruco([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imageSize,:board,:counter,:flags,:ids,:criteria,:distCoeffs,:rvecs,:corners,:tvecs,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_calibrateCameraAruco()
    |> to_struct()
  end
  ...
  @spec calibrateCameraArucoExtended(Keyword.t()) :: any() | {:error, String.t()}
  def calibrateCameraArucoExtended([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imageSize,:board,:counter,:flags,:ids,:stdDeviationsIntrinsics,:distCoeffs,:perViewErrors,:criteria,:rvecs,:stdDeviationsExtrinsics,:corners,:tvecs,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_calibrateCameraArucoExtended()
    |> to_struct()
  end
  ...
  @spec calibrateCameraCharuco(Keyword.t()) :: any() | {:error, String.t()}
  def calibrateCameraCharuco([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imageSize,:board,:flags,:charucoCorners,:criteria,:distCoeffs,:rvecs,:charucoIds,:tvecs,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_calibrateCameraCharuco()
    |> to_struct()
  end
  ...
  @spec calibrateCameraCharucoExtended(Keyword.t()) :: any() | {:error, String.t()}
  def calibrateCameraCharucoExtended([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imageSize,:board,:flags,:charucoCorners,:stdDeviationsExtrinsics,:stdDeviationsIntrinsics,:distCoeffs,:perViewErrors,:criteria,:rvecs,:charucoIds,:tvecs,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_calibrateCameraCharucoExtended()
    |> to_struct()
  end
  ...
  @spec detectCharucoDiamond(Keyword.t()) :: any() | {:error, String.t()}
  def detectCharucoDiamond([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:diamondIds,:diamondCorners,:image,:squareMarkerLengthRate,:markerCorners,:distCoeffs,:dictionary,:markerIds,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_detectCharucoDiamond()
    |> to_struct()
  end
  ...
  def detectMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:rejectedImgPoints,:ids,:parameters,:corners,:dictionary])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_detectMarkers()
    |> to_struct()
  end
  ...
  @spec drawCharucoDiamond(Keyword.t()) :: any() | {:error, String.t()}
  def drawCharucoDiamond([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:squareLength,:img,:ids,:borderBits,:marginSize,:markerLength,:dictionary])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_drawCharucoDiamond()
    |> to_struct()
  end
  ...
  def drawDetectedCornersCharuco([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:charucoIds,:charucoCorners,:cornerColor,:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_drawDetectedCornersCharuco()
    |> to_struct()
  end
  ...
  def drawDetectedDiamonds([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:diamondIds,:borderColor,:diamondCorners,:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_drawDetectedDiamonds()
    |> to_struct()
  end
  ...
  def drawDetectedMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:borderColor,:corners,:ids,:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_drawDetectedMarkers()
    |> to_struct()
  end
  ...
  @spec drawPlanarBoard(Keyword.t()) :: any() | {:error, String.t()}
  def drawPlanarBoard([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:board,:borderBits,:marginSize,:outSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_drawPlanarBoard()
    |> to_struct()
  end
  ...
  @spec estimatePoseBoard(Keyword.t()) :: any() | {:error, String.t()}
  def estimatePoseBoard([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:board,:ids,:distCoeffs,:rvec,:tvec,:corners,:useExtrinsicGuess,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_estimatePoseBoard()
    |> to_struct()
  end
  ...
  @spec estimatePoseCharucoBoard(Keyword.t()) :: any() | {:error, String.t()}
  def estimatePoseCharucoBoard([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:board,:charucoCorners,:distCoeffs,:rvec,:tvec,:charucoIds,:useExtrinsicGuess,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_estimatePoseCharucoBoard()
    |> to_struct()
  end
  ...
  @spec estimatePoseSingleMarkers(Keyword.t()) :: any() | {:error, String.t()}
  def estimatePoseSingleMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:markerLength,:objPoints,:distCoeffs,:estimateParameters,:rvecs,:corners,:tvecs,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_estimatePoseSingleMarkers()
    |> to_struct()
  end
  ...
  def extendDictionary([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:randomSeed,:nMarkers,:baseDictionary,:markerSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_extendDictionary()
    |> to_struct()
  end
  ...
  def generateImageMarker([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:borderBits,:id,:sidePixels,:dictionary])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_generateImageMarker()
    |> to_struct()
  end
  ...
  @spec getBoardObjectAndImagePoints(Keyword.t()) :: any() | {:error, String.t()}
  def getBoardObjectAndImagePoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:detectedIds,:board,:imgPoints,:objPoints,:detectedCorners])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_getBoardObjectAndImagePoints()
    |> to_struct()
  end
  ...
  def getPredefinedDictionary([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:dict])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_getPredefinedDictionary()
    |> to_struct()
  end
  ...
  @spec interpolateCornersCharuco(Keyword.t()) :: any() | {:error, String.t()}
  def interpolateCornersCharuco([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minMarkers,:board,:image,:charucoCorners,:markerCorners,:distCoeffs,:charucoIds,:markerIds,:cameraMatrix])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_interpolateCornersCharuco()
    |> to_struct()
  end
  ...
  def refineDetectedMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:detectedIds,:cameraMatrix,:board,:image,:rejectedCorners,:minRepDistance,:distCoeffs,:parameters,:errorCorrectionRate,:checkAllOrders,:recoveredIdxs,:detectedCorners])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_refineDetectedMarkers()
    |> to_struct()
  end
  ...
  @spec testCharucoCornersCollinear(Keyword.t()) :: any() | {:error, String.t()}
  def testCharucoCornersCollinear([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:charucoIds,:board])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_testCharucoCornersCollinear()
    |> to_struct()
  end
