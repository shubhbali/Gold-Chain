defmodule Evision.DNN do
  ...
  def nmsBoxesRotated([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bboxes,:scores,:eta,:nms_threshold,:score_threshold,:indices,:top_k])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_NMSBoxesRotated()
    |> to_struct()
  end
  ...
  **Note**: 
  ...
  def blobFromImage([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image,:mean,:crop,:ddepth,:swapRB,:size,:scalefactor])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_blobFromImage()
    |> to_struct()
  end
  ...
  def blobFromImageWithParams([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:blob,:param,:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_blobFromImageWithParams()
    |> to_struct()
  end
  ...
  **Note**: 
  ...
  def blobFromImages([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:images,:mean,:crop,:ddepth,:swapRB,:size,:scalefactor])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_blobFromImages()
    |> to_struct()
  end
  ...
  def blobFromImagesWithParams([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:images,:blob,:param])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_blobFromImagesWithParams()
    |> to_struct()
  end
  ...
  def getAvailableTargets([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:be])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_getAvailableTargets()
    |> to_struct()
  end
  ...
  def imagesFromBlob([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:blob_,:images_])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_imagesFromBlob()
    |> to_struct()
  end
  ...
  def readNet([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bufferModel,:config,:framework,:bufferConfig,:model])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readNet()
    |> to_struct()
  end
  ...
  def readNetFromCaffeBuffer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bufferModel,:bufferProto,:prototxt,:caffeModel])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readNetFromCaffe()
    |> to_struct()
  end
  ...
  def readNetFromDarknetBuffer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bufferCfg,:cfgFile,:bufferModel,:darknetModel])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readNetFromDarknet()
    |> to_struct()
  end
  ...
  def readNetFromModelOptimizerBuffer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bufferWeights,:bin,:bufferModelConfig,:xml])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readNetFromModelOptimizer()
    |> to_struct()
  end
  ...
  def readNetFromONNXBuffer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:buffer,:onnxFile])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readNetFromONNX()
    |> to_struct()
  end
  ...
  def readNetFromTFLiteBuffer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bufferModel,:model])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readNetFromTFLite()
    |> to_struct()
  end
  ...
  def readNetFromTensorflowBuffer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bufferModel,:bufferConfig,:model,:config])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readNetFromTensorflow()
    |> to_struct()
  end
  ...
  **Note**: Ascii mode of Torch serializer is more preferable, because binary mode extensively use `long` type of C language,
  ...
  def readNetFromTorch([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:isBinary,:model,:evaluate])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readNetFromTorch()
    |> to_struct()
  end
  ...
  def readTensorFromONNX([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:path])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readTensorFromONNX()
    |> to_struct()
  end
  ...
  def readTorchBlob([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:isBinary,:filename])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_readTorchBlob()
    |> to_struct()
  end
  ...
  **Note**: Shrinked model has no origin float32 weights so it can't be used
  ...
  @spec shrinkCaffeModel(Keyword.t()) :: any() | {:error, String.t()}
  def shrinkCaffeModel([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:layersTypes,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_shrinkCaffeModel()
    |> to_struct()
  end
  ...
  **Note**: Shrinked model has no origin float32 weights so it can't be used
  ...
  def writeTextGraph([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:model,:output])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_writeTextGraph()
    |> to_struct()
  end
