defmodule Evision.FlannBasedMatcher do
  ...
  @typedoc """
  Type that represents an `FlannBasedMatcher` struct.
  ...
  @doc false
  def to_struct({:ok, %{class: Evision.FlannBasedMatcher, ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  @doc false
  def to_struct(%{class: Evision.FlannBasedMatcher, ref: ref}) do
    %T{
      ref: ref
    }
  end
  ...
  ##### Return
  - **self**: `Evision.FlannBasedMatcher.t()`
  ...
  ```
  """
  @spec flannBasedMatcher(Keyword.t()) :: any() | {:error, String.t()}
  def flannBasedMatcher([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:searchParams,:indexParams])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_FlannBasedMatcher()
    |> to_struct()
  end
  @spec flannBasedMatcher([{:indexParams, term()} | {:searchParams, term()}] | nil) :: Evision.FlannBasedMatcher.t() | {:error, String.t()}
  def flannBasedMatcher(opts) when opts == nil or (is_list(opts) and is_tuple(hd(opts)))
  do
    Keyword.validate!(opts || [], [:indexParams, :searchParams])
    positional = [
    ]
  ...
  def add([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:descriptors])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_add()
    |> to_struct()
  end
  ...
  ```
  """
  @spec add(Evision.FlannBasedMatcher.t(), list(Evision.Mat.maybe_mat_in())) :: Evision.FlannBasedMatcher.t() | {:error, String.t()}
  ...
  def clear([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_clear()
    |> to_struct()
  end
  @spec clear(Evision.FlannBasedMatcher.t()) :: Evision.FlannBasedMatcher.t() | {:error, String.t()}
  def clear(self) do
    positional = [
    ]
  ...
  ```
  """
  @spec clone(Evision.FlannBasedMatcher.t(), [{:emptyTrainData, term()}] | nil) :: Evision.DescriptorMatcher.t() | {:error, String.t()}
  def clone(self, opts) when opts == nil or (is_list(opts) and is_tuple(hd(opts)))
  do
    Keyword.validate!(opts || [], [:emptyTrainData])
    positional = [
    ]
    :evision_nif.flannBasedMatcher_clone(Evision.Internal.Structurise.from_struct(self), positional ++ Evision.Internal.Structurise.from_struct(opts || []))
     |> to_struct()
  end
  ...
  def clone([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:emptyTrainData])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_clone()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_create_static()
    |> to_struct()
  end
  ...
  create
  ##### Return
  - **retval**: `Evision.FlannBasedMatcher.t()`
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_empty()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_getDefaultName()
    |> to_struct()
  end
  @spec getDefaultName(Evision.FlannBasedMatcher.t()) :: binary() | {:error, String.t()}
  def getDefaultName(self) do
    positional = [
    ]
    :evision_nif.flannBasedMatcher_getDefaultName(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def getTrainDescriptors([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_getTrainDescriptors()
    |> to_struct()
  end
  ...
  def isMaskSupported([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_isMaskSupported()
    |> to_struct()
  end
  ...
  ```
  """
  @spec knnMatch(Evision.FlannBasedMatcher.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), integer(), [{:compactResult, term()} | {:mask, term()}] | nil) :: list(list(Evision.DMatch.t())) | {:error, String.t()}
  ...
  @spec knnMatch(Keyword.t()) :: any() | {:error, String.t()}
  def knnMatch([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:trainDescriptors,:mask,:compactResult,:matches,:queryDescriptors,:k,:masks])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_knnMatch()
    |> to_struct()
  end
  ...
  """
  @spec knnMatch(Evision.FlannBasedMatcher.t(), Evision.Mat.maybe_mat_in(), integer(), [{:compactResult, term()} | {:masks, term()}] | nil) :: list(list(Evision.DMatch.t())) | {:error, String.t()}
  ...
  ```
  """
  @spec match(Evision.FlannBasedMatcher.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), [{:mask, term()}] | nil) :: list(Evision.DMatch.t()) | {:error, String.t()}
  ...
  def match([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:trainDescriptors,:mask,:matches,:queryDescriptors,:masks])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_match()
    |> to_struct()
  end
  ...
  """
  @spec match(Evision.FlannBasedMatcher.t(), Evision.Mat.maybe_mat_in(), [{:masks, term()}] | nil) :: list(Evision.DMatch.t()) | {:error, String.t()}
  ...
  ```
  """
  @spec radiusMatch(Evision.FlannBasedMatcher.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), number(), [{:compactResult, term()} | {:mask, term()}] | nil) :: list(list(Evision.DMatch.t())) | {:error, String.t()}
  ...
  @spec radiusMatch(Keyword.t()) :: any() | {:error, String.t()}
  def radiusMatch([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:trainDescriptors,:mask,:compactResult,:maxDistance,:matches,:queryDescriptors,:masks])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_radiusMatch()
    |> to_struct()
  end
  ...
  """
  @spec radiusMatch(Evision.FlannBasedMatcher.t(), Evision.Mat.maybe_mat_in(), number(), [{:compactResult, term()} | {:masks, term()}] | nil) :: list(list(Evision.DMatch.t())) | {:error, String.t()}
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_read()
    |> to_struct()
  end
  ...
  """
  @spec read(Evision.FlannBasedMatcher.t(), Evision.FileNode.t()) :: Evision.FlannBasedMatcher.t() | {:error, String.t()}
  ...
  @spec read(Evision.FlannBasedMatcher.t(), binary()) :: Evision.FlannBasedMatcher.t() | {:error, String.t()}
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_save()
    |> to_struct()
  end
  ...
  ```
  """
  @spec save(Evision.FlannBasedMatcher.t(), binary()) :: Evision.FlannBasedMatcher.t() | {:error, String.t()}
  def save(self, filename) when is_binary(filename)
  do
    positional = [
      filename: Evision.Internal.Structurise.from_struct(filename)
    ]
    :evision_nif.flannBasedMatcher_save(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def train([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_train()
    |> to_struct()
  end
  @spec train(Evision.FlannBasedMatcher.t()) :: Evision.FlannBasedMatcher.t() | {:error, String.t()}
  def train(self) do
    positional = [
    ]
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.flannBasedMatcher_write()
    |> to_struct()
  end
  ...
  ```
  """
  @spec write(Evision.FlannBasedMatcher.t(), Evision.FileStorage.t(), binary()) :: Evision.FlannBasedMatcher.t() | {:error, String.t()}
  ...
  ```
  """
  @spec write(Evision.FlannBasedMatcher.t(), binary()) :: Evision.FlannBasedMatcher.t() | {:error, String.t()}
