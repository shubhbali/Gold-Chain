defmodule Evision.XImgProc.EdgeAwareInterpolator do
  ...
  def getFGSLambda([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_getFGSLambda()
    |> to_struct()
  end
  ...
  def getFGSSigma([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_getFGSSigma()
    |> to_struct()
  end
  ...
  def getK([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_getK()
    |> to_struct()
  end
  ...
  def getLambda([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_getLambda()
    |> to_struct()
  end
  ...
  def getSigma([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_getSigma()
    |> to_struct()
  end
  ...
  def getUsePostProcessing([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_getUsePostProcessing()
    |> to_struct()
  end
  ...
  def setCostMap([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_costMap])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_setCostMap()
    |> to_struct()
  end
  ...
  def setFGSLambda([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_setFGSLambda()
    |> to_struct()
  end
  ...
  def setFGSSigma([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_sigma])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_setFGSSigma()
    |> to_struct()
  end
  ...
  def setK([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_k])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_setK()
    |> to_struct()
  end
  ...
  def setLambda([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_lambda])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_setLambda()
    |> to_struct()
  end
  ...
  def setSigma([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_sigma])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_setSigma()
    |> to_struct()
  end
  ...
  @spec setUsePostProcessing(Keyword.t()) :: any() | {:error, String.t()}
  def setUsePostProcessing([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_use_post_proc])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_EdgeAwareInterpolator_setUsePostProcessing()
    |> to_struct()
  end
