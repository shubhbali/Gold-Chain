defmodule Evision.DNN.TextDetectionModelDB do
  ...
  def textDetectionModelDB([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:network,:model,:config])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_TextDetectionModel_DB()
    |> to_struct()
  end
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:confidences,:frame,:detections])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_detect()
    |> to_struct()
  end
  ...
  def detectTextRectangles([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:confidences,:frame,:detections])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_detectTextRectangles()
    |> to_struct()
  end
  ...
  **Note**: Result may be inaccurate in case of strong perspective transformations.
  ...
  def enableWinograd([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_enableWinograd()
    |> to_struct()
  end
  ...
  def getBinaryThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_getBinaryThreshold()
    |> to_struct()
  end
  ...
  def getMaxCandidates([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_getMaxCandidates()
    |> to_struct()
  end
  ...
  def getPolygonThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_getPolygonThreshold()
    |> to_struct()
  end
  ...
  def getUnclipRatio([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_getUnclipRatio()
    |> to_struct()
  end
  ...
  def predict([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_predict()
    |> to_struct()
  end
  ...
  def setBinaryThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:binaryThreshold])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setBinaryThreshold()
    |> to_struct()
  end
  ...
  def setInputCrop([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setInputCrop()
    |> to_struct()
  end
  ...
  def setInputMean([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setInputMean()
    |> to_struct()
  end
  ...
  def setInputParams([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setInputParams()
    |> to_struct()
  end
  ...
  def setInputScale([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setInputScale()
    |> to_struct()
  end
  ...
  def setInputSize([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setInputSize()
    |> to_struct()
  end
  ...
  **Note**: If shape of the new blob less than 0, then frame size not change.
  ...
  def setInputSwapRB([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setInputSwapRB()
    |> to_struct()
  end
  ...
  def setMaxCandidates([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:maxCandidates])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setMaxCandidates()
    |> to_struct()
  end
  ...
  def setOutputNames([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setOutputNames()
    |> to_struct()
  end
  ...
  def setPolygonThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:polygonThreshold])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setPolygonThreshold()
    |> to_struct()
  end
  ...
  def setPreferableBackend([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setPreferableBackend()
    |> to_struct()
  end
  ...
  def setPreferableTarget([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setPreferableTarget()
    |> to_struct()
  end
  ...
  def setUnclipRatio([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:unclipRatio])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_TextDetectionModel_DB_setUnclipRatio()
    |> to_struct()
  end
