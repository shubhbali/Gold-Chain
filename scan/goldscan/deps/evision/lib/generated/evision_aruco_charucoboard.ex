defmodule Evision.ArUco.CharucoBoard do
  ...
  @spec charucoBoard(Keyword.t()) :: any() | {:error, String.t()}
  def charucoBoard([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:squareLength,:ids,:markerLength,:dictionary,:size])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_CharucoBoard_CharucoBoard()
    |> to_struct()
  end
  ...
  @spec checkCharucoCornersCollinear(Keyword.t()) :: any() | {:error, String.t()}
  def checkCharucoCornersCollinear([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:charucoIds])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_CharucoBoard_checkCharucoCornersCollinear()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getChessboardCorners(Keyword.t()) :: any() | {:error, String.t()}
  def getChessboardCorners([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_CharucoBoard_getChessboardCorners()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getChessboardSize(Keyword.t()) :: any() | {:error, String.t()}
  def getChessboardSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_CharucoBoard_getChessboardSize()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getLegacyPattern(Keyword.t()) :: any() | {:error, String.t()}
  def getLegacyPattern([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_CharucoBoard_getLegacyPattern()
    |> to_struct()
  end
  ...
  def getMarkerLength([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_CharucoBoard_getMarkerLength()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getSquareLength(Keyword.t()) :: any() | {:error, String.t()}
  def getSquareLength([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_CharucoBoard_getSquareLength()
    |> to_struct()
  end
  ...
  @spec setLegacyPattern(Keyword.t()) :: any() | {:error, String.t()}
  def setLegacyPattern([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:legacyPattern])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_CharucoBoard_setLegacyPattern()
    |> to_struct()
  end
