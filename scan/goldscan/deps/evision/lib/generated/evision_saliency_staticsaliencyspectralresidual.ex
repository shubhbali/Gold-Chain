defmodule Evision.Saliency.StaticSaliencySpectralResidual do
  ...
  def computeSaliency([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.saliency_saliency_StaticSaliencySpectralResidual_computeSaliency()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_StaticSaliencySpectralResidual_create_static()
    |> to_struct()
  end
  ...
  def getImageHeight([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_StaticSaliencySpectralResidual_getImageHeight()
    |> to_struct()
  end
  ...
  def getImageWidth([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_StaticSaliencySpectralResidual_getImageWidth()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_StaticSaliencySpectralResidual_read()
    |> to_struct()
  end
  ...
  def setImageHeight([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_StaticSaliencySpectralResidual_setImageHeight()
    |> to_struct()
  end
  ...
  def setImageWidth([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_StaticSaliencySpectralResidual_setImageWidth()
    |> to_struct()
  end
