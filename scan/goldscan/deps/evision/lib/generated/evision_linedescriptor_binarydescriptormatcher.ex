defmodule Evision.LineDescriptor.BinaryDescriptorMatcher do
  ...
  @spec binaryDescriptorMatcher(Keyword.t()) :: any() | {:error, String.t()}
  def binaryDescriptorMatcher([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptorMatcher_BinaryDescriptorMatcher()
    |> to_struct()
  end
  ...
  def clear([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptorMatcher_clear()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptorMatcher_empty()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptorMatcher_getDefaultName()
    |> to_struct()
  end
  ...
  def knnMatch([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:trainDescriptors,:mask,:compactResult,:matches,:queryDescriptors,:k])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptorMatcher_knnMatch()
    |> to_struct()
  end
  ...
  @spec knnMatchQuery(Keyword.t()) :: any() | {:error, String.t()}
  def knnMatchQuery([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:compactResult,:matches,:queryDescriptors,:k,:masks])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptorMatcher_knnMatchQuery()
    |> to_struct()
  end
  ...
  def match([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:queryDescriptors,:trainDescriptors,:mask,:matches])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptorMatcher_match()
    |> to_struct()
  end
  ...
  @spec matchQuery(Keyword.t()) :: any() | {:error, String.t()}
  def matchQuery([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:queryDescriptors,:matches,:masks])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptorMatcher_matchQuery()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptorMatcher_read()
    |> to_struct()
  end
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptorMatcher_save()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptorMatcher_write()
    |> to_struct()
  end
