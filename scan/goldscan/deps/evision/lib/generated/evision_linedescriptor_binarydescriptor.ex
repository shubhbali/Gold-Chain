defmodule Evision.LineDescriptor.BinaryDescriptor do
  ...
  def clear([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.line_descriptor_BinaryDescriptor_clear()
    |> to_struct()
  end
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:keylines,:returnFloatDescr,:image,:descriptors])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptor_compute()
    |> to_struct()
  end
  ...
  @spec createBinaryDescriptor(Keyword.t()) :: any() | {:error, String.t()}
  def createBinaryDescriptor([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptor_createBinaryDescriptor_static()
    |> to_struct()
  end
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:keypoints,:mask,:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptor_detect()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptor_empty()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptor_getDefaultName()
    |> to_struct()
  end
  ...
  def getNumOfOctaves([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptor_getNumOfOctaves()
    |> to_struct()
  end
  ...
  def getReductionRatio([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptor_getReductionRatio()
    |> to_struct()
  end
  ...
  def getWidthOfBand([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptor_getWidthOfBand()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptor_read()
    |> to_struct()
  end
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptor_save()
    |> to_struct()
  end
  ...
  @spec setNumOfOctaves(Keyword.t()) :: any() | {:error, String.t()}
  def setNumOfOctaves([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:octaves])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptor_setNumOfOctaves()
    |> to_struct()
  end
  ...
  @spec setReductionRatio(Keyword.t()) :: any() | {:error, String.t()}
  def setReductionRatio([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rRatio])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptor_setReductionRatio()
    |> to_struct()
  end
  ...
  @spec setWidthOfBand(Keyword.t()) :: any() | {:error, String.t()}
  def setWidthOfBand([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:width])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_BinaryDescriptor_setWidthOfBand()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_BinaryDescriptor_write()
    |> to_struct()
  end
