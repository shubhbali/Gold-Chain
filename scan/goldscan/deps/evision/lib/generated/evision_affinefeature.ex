defmodule Evision.AffineFeature do
  ...
  @typedoc """
  Type that represents an `AffineFeature` struct.
  ...
  @doc false
  def to_struct({:ok, %{class: Evision.AffineFeature, ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  @doc false
  def to_struct(%{class: Evision.AffineFeature, ref: ref}) do
    %T{
      ref: ref
    }
  end
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.affineFeature_compute()
    |> to_struct()
  end
  ...
  ##### Return
  - **retval**: `Evision.AffineFeature.t()`
  ...
  ```
  """
  @spec create(Evision.Feature2D.t(), [{:maxTilt, term()} | {:minTilt, term()} | {:rotateStepBase, term()} | {:tiltStep, term()}] | nil) :: Evision.AffineFeature.t() | {:error, String.t()}
  def create(backend, opts) when opts == nil or (is_list(opts) and is_tuple(hd(opts)))
  do
    Keyword.validate!(opts || [], [:maxTilt, :minTilt, :rotateStepBase, :tiltStep])
    positional = [
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:tiltStep,:maxTilt,:rotateStepBase,:backend,:minTilt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_create_static()
    |> to_struct()
  end
  @spec create(Evision.Feature2D.t()) :: Evision.AffineFeature.t() | {:error, String.t()}
  def create(backend) do
    positional = [
      backend: Evision.Internal.Structurise.from_struct(backend)
    ]
  ...
  def defaultNorm([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_defaultNorm()
    |> to_struct()
  end
  ...
  def descriptorSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_descriptorSize()
    |> to_struct()
  end
  ...
  def descriptorType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_descriptorType()
    |> to_struct()
  end
  ...
  """
  @spec detect(Evision.AffineFeature.t(), list(Evision.Mat.maybe_mat_in()), [{:masks, term()}] | nil) :: list(list(Evision.KeyPoint.t())) | {:error, String.t()}
  ...
  @spec detect(Evision.AffineFeature.t(), Evision.Mat.maybe_mat_in(), [{:mask, term()}] | nil) :: list(Evision.KeyPoint.t()) | {:error, String.t()}
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_detect()
    |> to_struct()
  end
  ...
  ```
  """
  @spec detectAndCompute(Evision.AffineFeature.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), [{:useProvidedKeypoints, term()}] | nil) :: {list(Evision.KeyPoint.t()), Evision.Mat.t()} | {:error, String.t()}
  ...
  def detectAndCompute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_detectAndCompute()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_empty()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_getDefaultName()
    |> to_struct()
  end
  ...
  @spec getViewParams(Keyword.t()) :: any() | {:error, String.t()}
  def getViewParams([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rolls,:tilts])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_getViewParams()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getViewParams(Evision.AffineFeature.t(), list(number()), list(number())) :: Evision.AffineFeature.t() | {:error, String.t()}
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_read()
    |> to_struct()
  end
  ...
  """
  @spec read(Evision.AffineFeature.t(), Evision.FileNode.t()) :: Evision.AffineFeature.t() | {:error, String.t()}
  ...
  @spec read(Evision.AffineFeature.t(), binary()) :: Evision.AffineFeature.t() | {:error, String.t()}
  ...
  @spec setViewParams(Keyword.t()) :: any() | {:error, String.t()}
  def setViewParams([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rolls,:tilts])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_setViewParams()
    |> to_struct()
  end
  ...
  ```
  """
  @spec setViewParams(Evision.AffineFeature.t(), list(number()), list(number())) :: Evision.AffineFeature.t() | {:error, String.t()}
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.affineFeature_write()
    |> to_struct()
  end
  ...
  ```
  """
  @spec write(Evision.AffineFeature.t(), Evision.FileStorage.t(), binary()) :: Evision.AffineFeature.t() | {:error, String.t()}
  ...
  ```
  """
  @spec write(Evision.AffineFeature.t(), binary()) :: Evision.AffineFeature.t() | {:error, String.t()}
