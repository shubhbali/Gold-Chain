defmodule Evision.Stereo.QuasiDenseStereo do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:monoImgSize,:paramFilepath])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereo_stereo_QuasiDenseStereo_create_static()
    |> to_struct()
  end
  ...
  **Note**: The returned Match elements inside the sMatches vector, do not use corr member.
  ...
  def getDenseMatches([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:denseMatches])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereo_stereo_QuasiDenseStereo_getDenseMatches()
    |> to_struct()
  end
  ...
  **Note**: Default level is 50
  ...
  def getDisparity([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereo_stereo_QuasiDenseStereo_getDisparity()
    |> to_struct()
  end
  ...
  @spec getMatch(Keyword.t()) :: any() | {:error, String.t()}
  def getMatch([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:y,:x])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereo_stereo_QuasiDenseStereo_getMatch()
    |> to_struct()
  end
  ...
  **Note**: The returned Match elements inside the sMatches vector, do not use corr member.
  ...
  def getSparseMatches([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sMatches])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereo_stereo_QuasiDenseStereo_getSparseMatches()
    |> to_struct()
  end
  ...
  @spec loadParameters(Keyword.t()) :: any() | {:error, String.t()}
  def loadParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filepath])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereo_stereo_QuasiDenseStereo_loadParameters()
    |> to_struct()
  end
  ...
  **Note**: Loading different parameters will have an effect on the output. This is useful for tuning
  ...
  def process([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imgLeft,:imgRight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereo_stereo_QuasiDenseStereo_process()
    |> to_struct()
  end
  ...
  **Note**: If input images are in color, the method assumes that are BGR and converts them to grayscale.
  ...
  @spec saveParameters(Keyword.t()) :: any() | {:error, String.t()}
  def saveParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filepath])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.stereo_stereo_QuasiDenseStereo_saveParameters()
    |> to_struct()
  end
