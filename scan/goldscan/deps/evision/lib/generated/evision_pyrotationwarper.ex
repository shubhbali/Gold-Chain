defmodule Evision.PyRotationWarper do
  ...
  def pyRotationWarper([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:type,:scale])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.pyRotationWarper_PyRotationWarper()
    |> to_struct()
  end
  ...
  def buildMaps([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:K,:xmap,:ymap,:src_size])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.pyRotationWarper_buildMaps()
    |> to_struct()
  end
  ...
  def getScale([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.pyRotationWarper_getScale()
    |> to_struct()
  end
  ...
  def setScale([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:arg1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.pyRotationWarper_setScale()
    |> to_struct()
  end
  ...
  def warp([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:dst,:R,:K,:border_mode,:interp_mode])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.pyRotationWarper_warp()
    |> to_struct()
  end
  ...
  def warpBackward([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:dst_size,:src,:dst,:R,:K,:border_mode,:interp_mode])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.pyRotationWarper_warpBackward()
    |> to_struct()
  end
  ...
  def warpPoint([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:K,:pt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.pyRotationWarper_warpPoint()
    |> to_struct()
  end
  ...
  def warpPointBackward([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:K,:pt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.pyRotationWarper_warpPointBackward()
    |> to_struct()
  end
  ...
  def warpRoi([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:R,:K,:src_size])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.pyRotationWarper_warpRoi()
    |> to_struct()
  end
