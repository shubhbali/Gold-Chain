defmodule Evision.DNN.ClassificationModel do
  ...
  """
  @spec classificationModel(Keyword.t()) :: any() | {:error, String.t()}
  def classificationModel([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:network,:model,:config])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_ClassificationModel()
    |> to_struct()
  end
  ...
  @spec classify(Keyword.t()) :: any() | {:error, String.t()}
  def classify([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:conf,:frame,:classId])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_classify()
    |> to_struct()
  end
  ...
  def enableWinograd([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_enableWinograd()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getEnableSoftmaxPostProcessing(Keyword.t()) :: any() | {:error, String.t()}
  def getEnableSoftmaxPostProcessing([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_getEnableSoftmaxPostProcessing()
    |> to_struct()
  end
  ...
  def predict([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_predict()
    |> to_struct()
  end
  ...
  @spec setEnableSoftmaxPostProcessing(Keyword.t()) :: any() | {:error, String.t()}
  def setEnableSoftmaxPostProcessing([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:enable])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setEnableSoftmaxPostProcessing()
    |> to_struct()
  end
  ...
  def setInputCrop([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setInputCrop()
    |> to_struct()
  end
  ...
  def setInputMean([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setInputMean()
    |> to_struct()
  end
  ...
  def setInputParams([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setInputParams()
    |> to_struct()
  end
  ...
  def setInputScale([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setInputScale()
    |> to_struct()
  end
  ...
  def setInputSize([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setInputSize()
    |> to_struct()
  end
  ...
  **Note**: If shape of the new blob less than 0, then frame size not change.
  ...
  def setInputSwapRB([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setInputSwapRB()
    |> to_struct()
  end
  ...
  def setOutputNames([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setOutputNames()
    |> to_struct()
  end
  ...
  def setPreferableBackend([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setPreferableBackend()
    |> to_struct()
  end
  ...
  def setPreferableTarget([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_ClassificationModel_setPreferableTarget()
    |> to_struct()
  end
