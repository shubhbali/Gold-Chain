defmodule Evision.LineDescriptor.KeyLine do
  ...
  def keyLine([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_KeyLine_KeyLine()
    |> to_struct()
  end
  ...
  def getEndPoint([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_KeyLine_getEndPoint()
    |> to_struct()
  end
  ...
  def getEndPointInOctave([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_KeyLine_getEndPointInOctave()
    |> to_struct()
  end
  ...
  def getStartPoint([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_KeyLine_getStartPoint()
    |> to_struct()
  end
  ...
  def getStartPointInOctave([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.line_descriptor_line_descriptor_KeyLine_getStartPointInOctave()
    |> to_struct()
  end
