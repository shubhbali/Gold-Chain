defmodule Evision.MergeMertens do
  ...
  ```
  """
  @spec getContrastWeight(Keyword.t()) :: any() | {:error, String.t()}
  def getContrastWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mergeMertens_getContrastWeight()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getExposureWeight(Keyword.t()) :: any() | {:error, String.t()}
  def getExposureWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mergeMertens_getExposureWeight()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getSaturationWeight(Keyword.t()) :: any() | {:error, String.t()}
  def getSaturationWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mergeMertens_getSaturationWeight()
    |> to_struct()
  end
  ...
  def process([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mergeMertens_process()
    |> to_struct()
  end
  ...
  @spec setContrastWeight(Keyword.t()) :: any() | {:error, String.t()}
  def setContrastWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:contrast_weiht])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mergeMertens_setContrastWeight()
    |> to_struct()
  end
  ...
  @spec setExposureWeight(Keyword.t()) :: any() | {:error, String.t()}
  def setExposureWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:exposure_weight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mergeMertens_setExposureWeight()
    |> to_struct()
  end
  ...
  @spec setSaturationWeight(Keyword.t()) :: any() | {:error, String.t()}
  def setSaturationWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:saturation_weight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mergeMertens_setSaturationWeight()
    |> to_struct()
  end
