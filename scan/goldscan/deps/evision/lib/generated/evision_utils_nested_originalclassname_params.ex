defmodule Evision.Utils.Nested.OriginalClassName.Params do
  ...
  ```
  """
  @spec utils_nested_OriginalClassName_Params(Keyword.t()) :: any() | {:error, String.t()}
  def utils_nested_OriginalClassName_Params([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:float_param,:int_param])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_nested_utils_nested_OriginalClassName_Params_OriginalClassName_Params()
    |> to_struct()
  end
