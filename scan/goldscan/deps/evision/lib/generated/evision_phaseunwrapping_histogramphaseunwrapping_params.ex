defmodule Evision.PhaseUnwrapping.HistogramPhaseUnwrapping.Params do
  ...
  @spec phase_unwrapping_HistogramPhaseUnwrapping_Params(Keyword.t()) :: any() | {:error, String.t()}
  def phase_unwrapping_HistogramPhaseUnwrapping_Params([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.phase_unwrapping_phase_unwrapping_HistogramPhaseUnwrapping_Params_HistogramPhaseUnwrapping_Params()
    |> to_struct()
  end
