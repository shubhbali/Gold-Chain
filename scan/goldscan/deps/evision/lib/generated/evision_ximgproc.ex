defmodule Evision.XImgProc do
  ...
  def fastHoughTransform([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:angleRange,:src,:dst,:dstMatDepth,:op,:makeSkew])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_FastHoughTransform()
    |> to_struct()
  end
  ...
  def gradientDericheX([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:omega,:op,:dst,:alpha])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_GradientDericheX()
    |> to_struct()
  end
  ...
  def gradientDericheY([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:omega,:op,:dst,:alpha])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_GradientDericheY()
    |> to_struct()
  end
  ...
  def houghPoint2Line([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:srcImgInfo,:houghPoint,:angleRange,:makeSkew,:rules])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_HoughPoint2Line()
    |> to_struct()
  end
  ...
  def peiLinNormalization([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:I,:T])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_PeiLinNormalization()
    |> to_struct()
  end
  ...
  def radonTransform([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:dst,:theta,:end_angle,:crop,:start_angle,:norm])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_RadonTransform()
    |> to_struct()
  end
  ...
  **Note**: Joint images with CV_8U and CV_16U depth converted to images with CV_32F depth and [0; 1]
  ...
  def amFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:joint,:src,:adjust_outliers,:dst,:sigma_r,:sigma_s])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_amFilter()
    |> to_struct()
  end
  ...
  **Note**: Joint images with CV_8U and CV_16U depth converted to images with CV_32F depth and [0; 1]
  ...
  def anisotropicDiffusion([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:dst,:K,:alpha,:niters])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_anisotropicDiffusion()
    |> to_struct()
  end
  ...
  def bilateralTextureFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:dst,:sigmaAlpha,:fr,:numIter,:sigmaAvg])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_bilateralTextureFilter()
    |> to_struct()
  end
  ...
  def colorMatchTemplate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:templ,:result])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_colorMatchTemplate()
    |> to_struct()
  end
  ...
  def computeBadPixelPercent([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:ROI,:src,:GT,:thresh])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_computeBadPixelPercent()
    |> to_struct()
  end
  ...
  def computeMSE([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:ROI,:src,:GT])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_computeMSE()
    |> to_struct()
  end
  ...
  def contourSampling([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:out,:src,:nbElt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_contourSampling()
    |> to_struct()
  end
  ...
  def covarianceEstimation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:windowRows,:src,:windowCols,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_covarianceEstimation()
    |> to_struct()
  end
  ...
  **Note**: Joint images with CV_8U and CV_16U depth converted to images with CV_32F depth and [0; 1]
  ...
  def createAMFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sigma_r,:sigma_s,:adjust_outliers])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createAMFilter()
    |> to_struct()
  end
  ...
  **Note**: Joint images with CV_8U and CV_16U depth converted to images with CV_32F depth and [0; 1]
  ...
  def createContourFitting([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:fd,:ctr])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createContourFitting()
    |> to_struct()
  end
  ...
  def createDTFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sigmaColor,:guide,:mode,:numIters,:sigmaSpatial])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createDTFilter()
    |> to_struct()
  end
  ...
  def createDisparityWLSFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:matcher_left])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createDisparityWLSFilter()
    |> to_struct()
  end
  ...
  def createDisparityWLSFilterGeneric([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:use_confidence])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createDisparityWLSFilterGeneric()
    |> to_struct()
  end
  ...
  def createEdgeAwareInterpolator([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createEdgeAwareInterpolator()
    |> to_struct()
  end
  ...
  def createEdgeBoxes([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:edgeMergeThr,:maxAspectRatio,:kappa,:eta,:maxBoxes,:clusterMinMag,:minScore,:minBoxArea,:gamma,:alpha,:edgeMinMag,:beta])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createEdgeBoxes()
    |> to_struct()
  end
  ...
  def createEdgeDrawing([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createEdgeDrawing()
    |> to_struct()
  end
  ...
  def createFastBilateralSolverFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:max_tol,:guide,:lambda,:num_iter,:sigma_luma,:sigma_chroma,:sigma_spatial])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createFastBilateralSolverFilter()
    |> to_struct()
  end
  ...
  def createFastGlobalSmootherFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:guide,:lambda,:num_iter,:lambda_attenuation,:sigma_color])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createFastGlobalSmootherFilter()
    |> to_struct()
  end
  ...
  def createFastLineDetector([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:distance_threshold,:canny_th1,:do_merge,:canny_th2,:canny_aperture_size,:length_threshold])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createFastLineDetector()
    |> to_struct()
  end
  ...
  def createGuidedFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:eps,:scale,:radius,:guide])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createGuidedFilter()
    |> to_struct()
  end
  ...
  def createQuaternionImage([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:qimg])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createQuaternionImage()
    |> to_struct()
  end
  ...
  def createRFFeatureGetter([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createRFFeatureGetter()
    |> to_struct()
  end
  ...
  def createRICInterpolator([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createRICInterpolator()
    |> to_struct()
  end
  ...
  def createRightMatcher([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:matcher_left])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createRightMatcher()
    |> to_struct()
  end
  ...
  def createScanSegment([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:slices,:image_width,:image_height,:num_superpixels,:merge_small])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createScanSegment()
    |> to_struct()
  end
  ...
  def createStructuredEdgeDetection([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:howToGetFeatures,:model])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createStructuredEdgeDetection()
    |> to_struct()
  end
  ...
  def createSuperpixelLSC([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:ratio,:image,:region_size])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createSuperpixelLSC()
    |> to_struct()
  end
  ...
  def createSuperpixelSEEDS([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:histogram_bins,:image_width,:image_height,:prior,:num_superpixels,:double_step,:image_channels,:num_levels])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createSuperpixelSEEDS()
    |> to_struct()
  end
  ...
  def createSuperpixelSLIC([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:algorithm,:ruler,:image,:region_size])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_createSuperpixelSLIC()
    |> to_struct()
  end
  ...
  def dtFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sigmaColor,:src,:dst,:guide,:mode,:numIters,:sigmaSpatial])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_dtFilter()
    |> to_struct()
  end
  ...
  def edgePreservingFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:d,:threshold,:src,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_edgePreservingFilter()
    |> to_struct()
  end
  ...
  **Note**: Confidence images with CV_8U depth are expected to in [0, 255] and CV_32F in [0, 1] range.
  ...
  def fastBilateralSolverFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:max_tol,:confidence,:src,:dst,:guide,:lambda,:num_iter,:sigma_luma,:sigma_chroma,:sigma_spatial])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_fastBilateralSolverFilter()
    |> to_struct()
  end
  ...
  **Note**: Confidence images with CV_8U depth are expected to in [0, 255] and CV_32F in [0, 1] range.
  ...
  def fastGlobalSmootherFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:dst,:guide,:lambda,:num_iter,:lambda_attenuation,:sigma_color])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_fastGlobalSmootherFilter()
    |> to_struct()
  end
  ...
  def findEllipses([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:centerDistanceThreshold,:image,:scoreThreshold,:ellipses,:reliabilityThreshold])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_findEllipses()
    |> to_struct()
  end
  ...
  def fourierDescriptor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:nbFD,:dst,:nbElt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_fourierDescriptor()
    |> to_struct()
  end
  ...
  def getDisparityVis([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:scale,:src,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_getDisparityVis()
    |> to_struct()
  end
  ...
  def guidedFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:eps,:src,:scale,:dDepth,:dst,:guide,:radius])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_guidedFilter()
    |> to_struct()
  end
  ...
  **Note**: bilateralFilter and jointBilateralFilter use L1 norm to compute difference between colors.
  ...
  def jointBilateralFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:joint,:sigmaColor,:src,:sigmaSpace,:dst,:borderType,:d])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_jointBilateralFilter()
    |> to_struct()
  end
  ...
  **Note**: bilateralFilter and jointBilateralFilter use L1 norm to compute difference between colors.
  ...
  def l0Smooth([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:kappa,:src,:lambda,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_l0Smooth()
    |> to_struct()
  end
  ...
  def niBlackThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:type,:blockSize,:_dst,:maxValue,:r,:_src,:k,:binarizationMethod])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_niBlackThreshold()
    |> to_struct()
  end
  ...
  def qconj([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:qcimg,:qimg])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_qconj()
    |> to_struct()
  end
  ...
  def qdft([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sideLeft,:img,:qimg,:flags])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_qdft()
    |> to_struct()
  end
  ...
  def qmultiply([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src1,:src2,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_qmultiply()
    |> to_struct()
  end
  ...
  def qunitary([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:qnimg,:qimg])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_qunitary()
    |> to_struct()
  end
  ...
  def readGT([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src_path,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_readGT()
    |> to_struct()
  end
  ...
  **Note**: rollingGuidanceFilter uses jointBilateralFilter as the edge-preserving filter.
  ...
  def rollingGuidanceFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sigmaColor,:src,:sigmaSpace,:dst,:borderType,:d,:numOfIter])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_rollingGuidanceFilter()
    |> to_struct()
  end
  ...
  def thinning([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:thinningType,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_thinning()
    |> to_struct()
  end
  ...
  def transformFD([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:fdContour,:dst,:t])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_transformFD()
    |> to_struct()
  end
  ...
  def weightedMedianFilter([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:joint,:src,:dst,:mask,:weightType,:sigma,:r])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_weightedMedianFilter()
    |> to_struct()
  end
  ...
  def createGraphSegmentation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:min_size,:sigma,:k])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_segmentation_createGraphSegmentation()
    |> to_struct()
  end
  ...
  def createSelectiveSearchSegmentation([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_segmentation_createSelectiveSearchSegmentation()
    |> to_struct()
  end
  ...
  @spec createSelectiveSearchSegmentationStrategyColor(Keyword.t()) :: any() | {:error, String.t()}
  def createSelectiveSearchSegmentationStrategyColor([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_segmentation_createSelectiveSearchSegmentationStrategyColor()
    |> to_struct()
  end
  ...
  @spec createSelectiveSearchSegmentationStrategyFill(Keyword.t()) :: any() | {:error, String.t()}
  def createSelectiveSearchSegmentationStrategyFill([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_segmentation_createSelectiveSearchSegmentationStrategyFill()
    |> to_struct()
  end
  ...
  def createSelectiveSearchSegmentationStrategyMultiple([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:s2,:s1,:s3,:s4])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_segmentation_createSelectiveSearchSegmentationStrategyMultiple()
    |> to_struct()
  end
  ...
  @spec createSelectiveSearchSegmentationStrategySize(Keyword.t()) :: any() | {:error, String.t()}
  def createSelectiveSearchSegmentationStrategySize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_segmentation_createSelectiveSearchSegmentationStrategySize()
    |> to_struct()
  end
  ...
  @spec createSelectiveSearchSegmentationStrategyTexture(Keyword.t()) :: any() | {:error, String.t()}
  def createSelectiveSearchSegmentationStrategyTexture([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_segmentation_createSelectiveSearchSegmentationStrategyTexture()
    |> to_struct()
  end
