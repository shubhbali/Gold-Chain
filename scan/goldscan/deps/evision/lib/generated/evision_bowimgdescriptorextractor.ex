defmodule Evision.BOWImgDescriptorExtractor do
  ...
  def bowImgDescriptorExtractor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:dextractor,:dmatcher])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bowImgDescriptorExtractor_BOWImgDescriptorExtractor()
    |> to_struct()
  end
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:keypoints,:imgDescriptor,:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bowImgDescriptorExtractor_compute()
    |> to_struct()
  end
  ...
  def descriptorSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bowImgDescriptorExtractor_descriptorSize()
    |> to_struct()
  end
  ...
  def descriptorType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bowImgDescriptorExtractor_descriptorType()
    |> to_struct()
  end
  ...
  def getVocabulary([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bowImgDescriptorExtractor_getVocabulary()
    |> to_struct()
  end
  ...
  def setVocabulary([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bowImgDescriptorExtractor_setVocabulary()
    |> to_struct()
  end
