defmodule Evision.BgSegm do
  ...
  ```
  """
  @spec createBackgroundSubtractorCNT(Keyword.t()) :: any() | {:error, String.t()}
  def createBackgroundSubtractorCNT([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:maxPixelStability,:isParallel,:useHistory,:minPixelStability])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bgsegm_createBackgroundSubtractorCNT()
    |> to_struct()
  end
  ...
  ```
  """
  @spec createBackgroundSubtractorGMG(Keyword.t()) :: any() | {:error, String.t()}
  def createBackgroundSubtractorGMG([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:initializationFrames,:decisionThreshold])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bgsegm_createBackgroundSubtractorGMG()
    |> to_struct()
  end
  ...
  ```
  """
  @spec createBackgroundSubtractorGSOC(Keyword.t()) :: any() | {:error, String.t()}
  def createBackgroundSubtractorGSOC([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:propagationRate,:noiseRemovalThresholdFacBG,:blinkingSupressionMultiplier,:nSamples,:replaceRate,:blinkingSupressionDecay,:noiseRemovalThresholdFacFG,:hitsThreshold,:alpha,:mc,:beta])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bgsegm_createBackgroundSubtractorGSOC()
    |> to_struct()
  end
  ...
  ```
  """
  @spec createBackgroundSubtractorLSBP(Keyword.t()) :: any() | {:error, String.t()}
  def createBackgroundSubtractorLSBP([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:Rscale,:LSBPRadius,:Tdec,:Tupper,:noiseRemovalThresholdFacBG,:minCount,:nSamples,:Tlower,:noiseRemovalThresholdFacFG,:Rincdec,:Tinc,:mc,:LSBPthreshold])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bgsegm_createBackgroundSubtractorLSBP()
    |> to_struct()
  end
  ...
  def createBackgroundSubtractorMOG([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:nmixtures,:backgroundRatio,:history,:noiseSigma])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bgsegm_createBackgroundSubtractorMOG()
    |> to_struct()
  end
  ...
  @spec createSyntheticSequenceGenerator(Keyword.t()) :: any() | {:error, String.t()}
  def createSyntheticSequenceGenerator([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:objspeed,:background,:wavelength,:amplitude,:object,:wavespeed])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bgsegm_createSyntheticSequenceGenerator()
    |> to_struct()
  end
