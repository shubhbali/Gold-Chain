defmodule Evision.DMatch do
  ...
  @spec dMatcher(Keyword.t()) :: any() | {:error, String.t()}
  def dMatcher([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_queryIdx,:_trainIdx,:_distance,:_imgIdx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dMatch_DMatch()
    |> to_struct()
  end
