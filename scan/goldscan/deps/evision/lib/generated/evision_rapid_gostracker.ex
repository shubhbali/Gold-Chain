defmodule Evision.Rapid.GOSTracker do
  ...
  - **self**: `Evision.Rapid.GOSTracker.t()`
  ...
  def clear([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.rapid_GOSTracker_clear()
    |> to_struct()
  end
  @spec clear(Evision.Rapid.GOSTracker.t()) :: Evision.Rapid.GOSTracker.t() | {:error, String.t()}
  def clear(self) do
    positional = [
    ]
    :evision_nif.rapid_GOSTracker_clear(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def clearState([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_rapid_GOSTracker_clearState()
    |> to_struct()
  end
  @spec clearState(Evision.Rapid.GOSTracker.t()) :: Evision.Rapid.GOSTracker.t() | {:error, String.t()}
  def clearState(self) do
    positional = [
    ]
    :evision_nif.rapid_rapid_GOSTracker_clearState(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  ```
  """
  @spec compute(Evision.Rapid.GOSTracker.t(), Evision.Mat.maybe_mat_in(), integer(), integer(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), [{:termcrit, term()}] | nil) :: {number(), Evision.Mat.t(), Evision.Mat.t()} | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.rapid_rapid_GOSTracker_compute(Evision.Internal.Structurise.from_struct(self), positional ++ Evision.Internal.Structurise.from_struct(opts || []))
     |> to_struct()
  end
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_rapid_GOSTracker_compute()
    |> to_struct()
  end
  ...
  ```
  """
  @spec compute(Evision.Rapid.GOSTracker.t(), Evision.Mat.maybe_mat_in(), integer(), integer(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in()) :: {number(), Evision.Mat.t(), Evision.Mat.t()} | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.rapid_rapid_GOSTracker_compute(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:pts3d,:histBins,:sobelThesh,:tris])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_rapid_GOSTracker_create_static()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_GOSTracker_empty()
    |> to_struct()
  end
  @spec empty(Evision.Rapid.GOSTracker.t()) :: boolean() | {:error, String.t()}
  def empty(self) do
    positional = [
    ]
    :evision_nif.rapid_GOSTracker_empty(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_GOSTracker_getDefaultName()
    |> to_struct()
  end
  @spec getDefaultName(Evision.Rapid.GOSTracker.t()) :: binary() | {:error, String.t()}
  def getDefaultName(self) do
    positional = [
    ]
    :evision_nif.rapid_GOSTracker_getDefaultName(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_GOSTracker_read()
    |> to_struct()
  end
  ...
  ```
  """
  @spec read(Evision.Rapid.GOSTracker.t(), Evision.FileNode.t()) :: Evision.Rapid.GOSTracker.t() | {:error, String.t()}
  def read(self, func) when is_struct(func, Evision.FileNode)
  do
    positional = [
      func: Evision.Internal.Structurise.from_struct(func)
    ]
    :evision_nif.rapid_GOSTracker_read(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_GOSTracker_save()
    |> to_struct()
  end
  ...
  ```
  """
  @spec save(Evision.Rapid.GOSTracker.t(), binary()) :: Evision.Rapid.GOSTracker.t() | {:error, String.t()}
  def save(self, filename) when is_binary(filename)
  do
    positional = [
      filename: Evision.Internal.Structurise.from_struct(filename)
    ]
    :evision_nif.rapid_GOSTracker_save(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_GOSTracker_write()
    |> to_struct()
  end
  ...
  ```
  """
  @spec write(Evision.Rapid.GOSTracker.t(), Evision.FileStorage.t(), binary()) :: Evision.Rapid.GOSTracker.t() | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.rapid_GOSTracker_write(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  ```
  """
  @spec write(Evision.Rapid.GOSTracker.t(), Evision.FileStorage.t()) :: Evision.Rapid.GOSTracker.t() | {:error, String.t()}
