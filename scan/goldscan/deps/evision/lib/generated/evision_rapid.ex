defmodule Evision.Rapid do
  ...
  def convertCorrespondencies([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:cols,:pts2d,:mask,:pts3d,:srcLocations])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_convertCorrespondencies()
    |> to_struct()
  end
  ...
  def drawCorrespondencies([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bundle,:colors,:cols])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_drawCorrespondencies()
    |> to_struct()
  end
  ...
  def drawSearchLines([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:locations,:color])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_drawSearchLines()
    |> to_struct()
  end
  ...
  def drawWireframe([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:type,:img,:tris,:pts2d,:color,:cullBackface])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_drawWireframe()
    |> to_struct()
  end
  ...
  def extractControlPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:num,:ctl3d,:tris,:K,:pts3d,:len,:tvec,:imsize,:ctl2d,:rvec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_extractControlPoints()
    |> to_struct()
  end
  ...
  def extractLineBundle([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:srcLocations,:len,:bundle,:ctl2d])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_extractLineBundle()
    |> to_struct()
  end
  ...
  def findCorrespondencies([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bundle,:response,:cols])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_findCorrespondencies()
    |> to_struct()
  end
  ...
  def rapid([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:num,:img,:tris,:rmsd,:K,:pts3d,:len,:tvec,:rvec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.rapid_rapid()
    |> to_struct()
  end
