defmodule Evision.GeneralizedHoughGuil do
  ...
  def getAngleEpsilon([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getAngleEpsilon()
    |> to_struct()
  end
  ...
  def getAngleStep([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getAngleStep()
    |> to_struct()
  end
  ...
  def getAngleThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getAngleThresh()
    |> to_struct()
  end
  ...
  def getLevels([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getLevels()
    |> to_struct()
  end
  ...
  def getMaxAngle([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getMaxAngle()
    |> to_struct()
  end
  ...
  def getMaxScale([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getMaxScale()
    |> to_struct()
  end
  ...
  def getMinAngle([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getMinAngle()
    |> to_struct()
  end
  ...
  def getMinScale([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getMinScale()
    |> to_struct()
  end
  ...
  def getPosThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getPosThresh()
    |> to_struct()
  end
  ...
  def getScaleStep([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getScaleStep()
    |> to_struct()
  end
  ...
  def getScaleThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getScaleThresh()
    |> to_struct()
  end
  ...
  def getXi([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_getXi()
    |> to_struct()
  end
  ...
  @spec setAngleEpsilon(Keyword.t()) :: any() | {:error, String.t()}
  def setAngleEpsilon([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:angleEpsilon])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setAngleEpsilon()
    |> to_struct()
  end
  ...
  @spec setAngleStep(Keyword.t()) :: any() | {:error, String.t()}
  def setAngleStep([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:angleStep])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setAngleStep()
    |> to_struct()
  end
  ...
  @spec setAngleThresh(Keyword.t()) :: any() | {:error, String.t()}
  def setAngleThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:angleThresh])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setAngleThresh()
    |> to_struct()
  end
  ...
  def setLevels([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setLevels()
    |> to_struct()
  end
  ...
  @spec setMaxAngle(Keyword.t()) :: any() | {:error, String.t()}
  def setMaxAngle([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:maxAngle])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setMaxAngle()
    |> to_struct()
  end
  ...
  @spec setMaxScale(Keyword.t()) :: any() | {:error, String.t()}
  def setMaxScale([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:maxScale])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setMaxScale()
    |> to_struct()
  end
  ...
  @spec setMinAngle(Keyword.t()) :: any() | {:error, String.t()}
  def setMinAngle([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minAngle])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setMinAngle()
    |> to_struct()
  end
  ...
  @spec setMinScale(Keyword.t()) :: any() | {:error, String.t()}
  def setMinScale([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minScale])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setMinScale()
    |> to_struct()
  end
  ...
  @spec setPosThresh(Keyword.t()) :: any() | {:error, String.t()}
  def setPosThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:posThresh])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setPosThresh()
    |> to_struct()
  end
  ...
  @spec setScaleStep(Keyword.t()) :: any() | {:error, String.t()}
  def setScaleStep([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:scaleStep])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setScaleStep()
    |> to_struct()
  end
  ...
  @spec setScaleThresh(Keyword.t()) :: any() | {:error, String.t()}
  def setScaleThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:scaleThresh])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setScaleThresh()
    |> to_struct()
  end
  ...
  @spec setXi(Keyword.t()) :: any() | {:error, String.t()}
  def setXi([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:xi])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.generalizedHoughGuil_setXi()
    |> to_struct()
  end
