defmodule Evision.ShapeContextDistanceExtractor do
  ...
  def getAngularBins([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getAngularBins()
    |> to_struct()
  end
  ...
  def getBendingEnergyWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getBendingEnergyWeight()
    |> to_struct()
  end
  ...
  def getCostExtractor([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getCostExtractor()
    |> to_struct()
  end
  ...
  def getImageAppearanceWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getImageAppearanceWeight()
    |> to_struct()
  end
  ...
  def getImages([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image1,:image2])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getImages()
    |> to_struct()
  end
  ...
  def getInnerRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getInnerRadius()
    |> to_struct()
  end
  ...
  def getIterations([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getIterations()
    |> to_struct()
  end
  ...
  def getOuterRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getOuterRadius()
    |> to_struct()
  end
  ...
  def getRadialBins([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getRadialBins()
    |> to_struct()
  end
  ...
  def getRotationInvariant([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getRotationInvariant()
    |> to_struct()
  end
  ...
  def getShapeContextWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getShapeContextWeight()
    |> to_struct()
  end
  ...
  def getStdDev([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getStdDev()
    |> to_struct()
  end
  ...
  def getTransformAlgorithm([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_getTransformAlgorithm()
    |> to_struct()
  end
  ...
  def setAngularBins([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:nAngularBins])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setAngularBins()
    |> to_struct()
  end
  ...
  def setBendingEnergyWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bendingEnergyWeight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setBendingEnergyWeight()
    |> to_struct()
  end
  ...
  def setCostExtractor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:comparer])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setCostExtractor()
    |> to_struct()
  end
  ...
  def setImageAppearanceWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imageAppearanceWeight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setImageAppearanceWeight()
    |> to_struct()
  end
  ...
  def setImages([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image1,:image2])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setImages()
    |> to_struct()
  end
  ...
  def setInnerRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:innerRadius])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setInnerRadius()
    |> to_struct()
  end
  ...
  def setIterations([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:iterations])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setIterations()
    |> to_struct()
  end
  ...
  def setOuterRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:outerRadius])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setOuterRadius()
    |> to_struct()
  end
  ...
  def setRadialBins([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:nRadialBins])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setRadialBins()
    |> to_struct()
  end
  ...
  def setRotationInvariant([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rotationInvariant])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setRotationInvariant()
    |> to_struct()
  end
  ...
  def setShapeContextWeight([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:shapeContextWeight])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setShapeContextWeight()
    |> to_struct()
  end
  ...
  def setStdDev([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sigma])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setStdDev()
    |> to_struct()
  end
  ...
  def setTransformAlgorithm([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:transformer])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.shapeContextDistanceExtractor_setTransformAlgorithm()
    |> to_struct()
  end
