defmodule Evision.LineMod.Detector do
  ...
  @spec detector(Keyword.t()) :: any() | {:error, String.t()}
  def detector([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:T_pyramid,:modalities])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_Detector()
    |> to_struct()
  end
  ...
  @spec addSyntheticTemplate(Keyword.t()) :: any() | {:error, String.t()}
  def addSyntheticTemplate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:class_id,:templates])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_addSyntheticTemplate()
    |> to_struct()
  end
  ...
  @spec addTemplate(Keyword.t()) :: any() | {:error, String.t()}
  def addTemplate([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:class_id,:object_mask,:bounding_box,:sources])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_addTemplate()
    |> to_struct()
  end
  ...
  def classIds([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_classIds()
    |> to_struct()
  end
  ...
  def getModalities([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_getModalities()
    |> to_struct()
  end
  ...
  @spec getT(Keyword.t()) :: any() | {:error, String.t()}
  def getT([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:pyramid_level])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_getT()
    |> to_struct()
  end
  ...
  @spec getTemplates(Keyword.t()) :: any() | {:error, String.t()}
  def getTemplates([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:class_id,:template_id])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_getTemplates()
    |> to_struct()
  end
  ...
  def match([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:class_ids,:quantized_images,:matches,:threshold,:masks,:sources])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_match()
    |> to_struct()
  end
  ...
  def numClasses([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_numClasses()
    |> to_struct()
  end
  ...
  def numTemplates([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:class_id])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_numTemplates()
    |> to_struct()
  end
  ...
  def pyramidLevels([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_pyramidLevels()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_read()
    |> to_struct()
  end
  ...
  @spec readClasses(Keyword.t()) :: any() | {:error, String.t()}
  def readClasses([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:format,:class_ids])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_readClasses()
    |> to_struct()
  end
  ...
  def writeClasses([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:format])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_linemod_Detector_writeClasses()
    |> to_struct()
  end
