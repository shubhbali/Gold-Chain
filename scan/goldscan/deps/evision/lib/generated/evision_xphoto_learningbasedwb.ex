defmodule Evision.XPhoto.LearningBasedWB do
  ...
  @spec extractSimpleFeatures(Keyword.t()) :: any() | {:error, String.t()}
  def extractSimpleFeatures([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:src,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_LearningBasedWB_extractSimpleFeatures()
    |> to_struct()
  end
  ...
  def getHistBinNum([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_LearningBasedWB_getHistBinNum()
    |> to_struct()
  end
  ...
  def getRangeMaxVal([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_LearningBasedWB_getRangeMaxVal()
    |> to_struct()
  end
  ...
  def getSaturationThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_LearningBasedWB_getSaturationThreshold()
    |> to_struct()
  end
  ...
  @spec setHistBinNum(Keyword.t()) :: any() | {:error, String.t()}
  def setHistBinNum([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_LearningBasedWB_setHistBinNum()
    |> to_struct()
  end
  ...
  @spec setRangeMaxVal(Keyword.t()) :: any() | {:error, String.t()}
  def setRangeMaxVal([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_LearningBasedWB_setRangeMaxVal()
    |> to_struct()
  end
  ...
  @spec setSaturationThreshold(Keyword.t()) :: any() | {:error, String.t()}
  def setSaturationThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_LearningBasedWB_setSaturationThreshold()
    |> to_struct()
  end
