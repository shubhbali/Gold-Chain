defmodule Evision.MSER do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:edge_blur_size,:max_area,:area_threshold,:delta,:min_area,:min_diversity,:max_evolution,:min_margin,:max_variation])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_create_static()
    |> to_struct()
  end
  ...
  def descriptorSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_descriptorSize()
    |> to_struct()
  end
  ...
  def descriptorType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_descriptorType()
    |> to_struct()
  end
  ...
  def detectAndCompute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_detectAndCompute()
    |> to_struct()
  end
  ...
  @spec detectRegions(Keyword.t()) :: any() | {:error, String.t()}
  def detectRegions([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:msers,:bboxes,:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_detectRegions()
    |> to_struct()
  end
  ...
  def getAreaThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getAreaThreshold()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getDefaultName()
    |> to_struct()
  end
  ...
  def getDelta([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getDelta()
    |> to_struct()
  end
  ...
  def getEdgeBlurSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getEdgeBlurSize()
    |> to_struct()
  end
  ...
  def getMaxArea([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getMaxArea()
    |> to_struct()
  end
  ...
  def getMaxEvolution([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getMaxEvolution()
    |> to_struct()
  end
  ...
  def getMaxVariation([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getMaxVariation()
    |> to_struct()
  end
  ...
  def getMinDiversity([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getMinDiversity()
    |> to_struct()
  end
  ...
  def getMinMargin([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getMinMargin()
    |> to_struct()
  end
  ...
  def getPass2Only([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_getPass2Only()
    |> to_struct()
  end
  ...
  @spec setAreaThreshold(Keyword.t()) :: any() | {:error, String.t()}
  def setAreaThreshold([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:areaThreshold])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_setAreaThreshold()
    |> to_struct()
  end
  ...
  def setDelta([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:delta])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_setDelta()
    |> to_struct()
  end
  ...
  @spec setEdgeBlurSize(Keyword.t()) :: any() | {:error, String.t()}
  def setEdgeBlurSize([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:edge_blur_size])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_setEdgeBlurSize()
    |> to_struct()
  end
  ...
  @spec setMaxArea(Keyword.t()) :: any() | {:error, String.t()}
  def setMaxArea([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:maxArea])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_setMaxArea()
    |> to_struct()
  end
  ...
  @spec setMaxEvolution(Keyword.t()) :: any() | {:error, String.t()}
  def setMaxEvolution([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:maxEvolution])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_setMaxEvolution()
    |> to_struct()
  end
  ...
  @spec setMaxVariation(Keyword.t()) :: any() | {:error, String.t()}
  def setMaxVariation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:maxVariation])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_setMaxVariation()
    |> to_struct()
  end
  ...
  @spec setMinDiversity(Keyword.t()) :: any() | {:error, String.t()}
  def setMinDiversity([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:minDiversity])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_setMinDiversity()
    |> to_struct()
  end
  ...
  @spec setMinMargin(Keyword.t()) :: any() | {:error, String.t()}
  def setMinMargin([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:min_margin])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_setMinMargin()
    |> to_struct()
  end
  ...
  @spec setPass2Only(Keyword.t()) :: any() | {:error, String.t()}
  def setPass2Only([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:f])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.mser_setPass2Only()
    |> to_struct()
  end
