defmodule Evision.ML.TrainData do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sampleWeights,:samples,:responses,:varType,:varIdx,:layout,:sampleIdx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_create_static()
    |> to_struct()
  end
  ...
  @spec getCatCount(Keyword.t()) :: any() | {:error, String.t()}
  def getCatCount([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vi])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getCatCount()
    |> to_struct()
  end
  ...
  def getCatMap([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getCatMap()
    |> to_struct()
  end
  ...
  def getCatOfs([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getCatOfs()
    |> to_struct()
  end
  ...
  def getClassLabels([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getClassLabels()
    |> to_struct()
  end
  ...
  def getDefaultSubstValues([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getDefaultSubstValues()
    |> to_struct()
  end
  ...
  def getLayout([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getLayout()
    |> to_struct()
  end
  ...
  def getMissing([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getMissing()
    |> to_struct()
  end
  ...
  def getNAllVars([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getNAllVars()
    |> to_struct()
  end
  ...
  def getNSamples([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getNSamples()
    |> to_struct()
  end
  ...
  def getNTestSamples([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getNTestSamples()
    |> to_struct()
  end
  ...
  def getNTrainSamples([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getNTrainSamples()
    |> to_struct()
  end
  ...
  def getNVars([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getNVars()
    |> to_struct()
  end
  ...
  @spec getNames(Keyword.t()) :: any() | {:error, String.t()}
  def getNames([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:names])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getNames()
    |> to_struct()
  end
  ...
  def getNormCatResponses([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getNormCatResponses()
    |> to_struct()
  end
  ...
  def getResponseType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getResponseType()
    |> to_struct()
  end
  ...
  def getResponses([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getResponses()
    |> to_struct()
  end
  ...
  @spec getSample(Keyword.t()) :: any() | {:error, String.t()}
  def getSample([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:varIdx,:buf,:sidx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getSample()
    |> to_struct()
  end
  ...
  def getSampleWeights([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getSampleWeights()
    |> to_struct()
  end
  ...
  def getSamples([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getSamples()
    |> to_struct()
  end
  ...
  @spec getSubMatrix(Keyword.t()) :: any() | {:error, String.t()}
  def getSubMatrix([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:layout,:matrix,:idx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getSubMatrix_static()
    |> to_struct()
  end
  ...
  @spec getSubVector(Keyword.t()) :: any() | {:error, String.t()}
  def getSubVector([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vec,:idx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getSubVector_static()
    |> to_struct()
  end
  ...
  def getTestNormCatResponses([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTestNormCatResponses()
    |> to_struct()
  end
  ...
  def getTestResponses([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTestResponses()
    |> to_struct()
  end
  ...
  def getTestSampleIdx([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTestSampleIdx()
    |> to_struct()
  end
  ...
  def getTestSampleWeights([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTestSampleWeights()
    |> to_struct()
  end
  ...
  def getTestSamples([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTestSamples()
    |> to_struct()
  end
  ...
  def getTrainNormCatResponses([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTrainNormCatResponses()
    |> to_struct()
  end
  ...
  def getTrainResponses([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTrainResponses()
    |> to_struct()
  end
  ...
  def getTrainSampleIdx([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTrainSampleIdx()
    |> to_struct()
  end
  ...
  def getTrainSampleWeights([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTrainSampleWeights()
    |> to_struct()
  end
  ...
  def getTrainSamples([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:layout,:compressVars,:compressSamples])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getTrainSamples()
    |> to_struct()
  end
  ...
  @spec getValues(Keyword.t()) :: any() | {:error, String.t()}
  def getValues([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vi,:values,:sidx])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getValues()
    |> to_struct()
  end
  ...
  def getVarIdx([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getVarIdx()
    |> to_struct()
  end
  ...
  def getVarSymbolFlags([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getVarSymbolFlags()
    |> to_struct()
  end
  ...
  def getVarType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_getVarType()
    |> to_struct()
  end
  ...
  @spec setTrainTestSplit(Keyword.t()) :: any() | {:error, String.t()}
  def setTrainTestSplit([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:shuffle,:count])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_setTrainTestSplit()
    |> to_struct()
  end
  ...
  @spec setTrainTestSplitRatio(Keyword.t()) :: any() | {:error, String.t()}
  def setTrainTestSplitRatio([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:shuffle,:ratio])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_setTrainTestSplitRatio()
    |> to_struct()
  end
  ...
  def shuffleTrainTest([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ml_ml_TrainData_shuffleTrainTest()
    |> to_struct()
  end
