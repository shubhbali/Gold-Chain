defmodule Evision.XFeatures2D.MSDDetector do
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.xfeatures2d_MSDDetector_compute()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:m_kNN,:m_th_saliency,:m_patch_radius,:m_compute_orientation,:m_nms_radius,:m_nms_scale_radius,:m_scale_factor,:m_n_scales,:m_search_area_radius])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_create_static()
    |> to_struct()
  end
  ...
  def defaultNorm([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_MSDDetector_defaultNorm()
    |> to_struct()
  end
  ...
  def descriptorSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_MSDDetector_descriptorSize()
    |> to_struct()
  end
  ...
  def descriptorType([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_MSDDetector_descriptorType()
    |> to_struct()
  end
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_MSDDetector_detect()
    |> to_struct()
  end
  ...
  def detectAndCompute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_MSDDetector_detectAndCompute()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_MSDDetector_empty()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getComputeOrientation(Keyword.t()) :: any() | {:error, String.t()}
  def getComputeOrientation([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getComputeOrientation()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getDefaultName()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getKNN(Keyword.t()) :: any() | {:error, String.t()}
  def getKNN([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getKNN()
    |> to_struct()
  end
  ...
  def getNScales([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getNScales()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getNmsRadius(Keyword.t()) :: any() | {:error, String.t()}
  def getNmsRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getNmsRadius()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getNmsScaleRadius(Keyword.t()) :: any() | {:error, String.t()}
  def getNmsScaleRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getNmsScaleRadius()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getPatchRadius(Keyword.t()) :: any() | {:error, String.t()}
  def getPatchRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getPatchRadius()
    |> to_struct()
  end
  ...
  def getScaleFactor([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getScaleFactor()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getSearchAreaRadius(Keyword.t()) :: any() | {:error, String.t()}
  def getSearchAreaRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getSearchAreaRadius()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getThSaliency(Keyword.t()) :: any() | {:error, String.t()}
  def getThSaliency([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_getThSaliency()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_MSDDetector_read()
    |> to_struct()
  end
  ...
  @spec setComputeOrientation(Keyword.t()) :: any() | {:error, String.t()}
  def setComputeOrientation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:compute_orientation])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_setComputeOrientation()
    |> to_struct()
  end
  ...
  @spec setKNN(Keyword.t()) :: any() | {:error, String.t()}
  def setKNN([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:kNN])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_setKNN()
    |> to_struct()
  end
  ...
  def setNScales([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:use_orientation])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_setNScales()
    |> to_struct()
  end
  ...
  @spec setNmsRadius(Keyword.t()) :: any() | {:error, String.t()}
  def setNmsRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:nms_radius])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_setNmsRadius()
    |> to_struct()
  end
  ...
  @spec setNmsScaleRadius(Keyword.t()) :: any() | {:error, String.t()}
  def setNmsScaleRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:nms_scale_radius])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_setNmsScaleRadius()
    |> to_struct()
  end
  ...
  @spec setPatchRadius(Keyword.t()) :: any() | {:error, String.t()}
  def setPatchRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:patch_radius])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_setPatchRadius()
    |> to_struct()
  end
  ...
  def setScaleFactor([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_setScaleFactor()
    |> to_struct()
  end
  ...
  @spec setSearchAreaRadius(Keyword.t()) :: any() | {:error, String.t()}
  def setSearchAreaRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:use_orientation])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_setSearchAreaRadius()
    |> to_struct()
  end
  ...
  @spec setThSaliency(Keyword.t()) :: any() | {:error, String.t()}
  def setThSaliency([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:th_saliency])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_MSDDetector_setThSaliency()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_MSDDetector_write()
    |> to_struct()
  end
