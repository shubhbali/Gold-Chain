defmodule Evision.StructuredLight.StructuredLightPattern do
  ...
  def clear([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.structured_light_StructuredLightPattern_clear()
    |> to_struct()
  end
  ...
  **Note**: All the images must be at the same resolution.
  ...
  def decode([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.structured_light_structured_light_StructuredLightPattern_decode()
    |> to_struct()
  end
  ...
  **Note**: All the images must be at the same resolution.
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.structured_light_StructuredLightPattern_empty()
    |> to_struct()
  end
  ...
  def generate([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.structured_light_structured_light_StructuredLightPattern_generate()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.structured_light_StructuredLightPattern_getDefaultName()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.structured_light_StructuredLightPattern_read()
    |> to_struct()
  end
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.structured_light_StructuredLightPattern_save()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.structured_light_StructuredLightPattern_write()
    |> to_struct()
  end
