defmodule Evision.ArUco.DetectorParameters do
  ...
  @spec detectorParameters(Keyword.t()) :: any() | {:error, String.t()}
  def detectorParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_DetectorParameters_DetectorParameters()
    |> to_struct()
  end
  ...
  @spec readDetectorParameters(Keyword.t()) :: any() | {:error, String.t()}
  def readDetectorParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:fn])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_DetectorParameters_readDetectorParameters()
    |> to_struct()
  end
  ...
  @spec writeDetectorParameters(Keyword.t()) :: any() | {:error, String.t()}
  def writeDetectorParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:fs,:name])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.aruco_aruco_DetectorParameters_writeDetectorParameters()
    |> to_struct()
  end
