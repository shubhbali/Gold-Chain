defmodule Evision.DNN.Model do
  ...
  @typedoc """
  Type that represents an `DNN.Model` struct.
  ...
  @doc false
  def to_struct({:ok, %{class: Evision.DNN.Model, ref: ref}}) do
    {:ok, %T{ref: ref}}
  end

  @doc false
  def to_struct(%{class: Evision.DNN.Model, ref: ref}) do
    %T{
      ref: ref
    }
  end
  ...
  """
  @spec model(Keyword.t()) :: any() | {:error, String.t()}
  def model([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:network,:model,:config])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_Model()
    |> to_struct()
  end
  ...
  ```
  """
  @spec model(binary(), [{:config, term()}] | nil) :: Evision.DNN.Model.t() | {:error, String.t()}
  ...
  def enableWinograd([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_enableWinograd()
    |> to_struct()
  end
  ...
  ```
  """
  @spec enableWinograd(Evision.DNN.Model.t(), boolean()) :: Evision.DNN.Model.t() | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.dnn_dnn_Model_enableWinograd(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def predict([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_predict()
    |> to_struct()
  end
  ...
  def setInputCrop([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_setInputCrop()
    |> to_struct()
  end
  ...
  def setInputMean([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_setInputMean()
    |> to_struct()
  end
  ...
  ```
  """
  @spec setInputMean(Evision.DNN.Model.t(), Evision.scalar()) :: Evision.DNN.Model.t() | {:error, String.t()}
  ...
  ```
  """
  @spec setInputParams(Evision.DNN.Model.t(), [{:crop, term()} | {:mean, term()} | {:scale, term()} | {:size, term()} | {:swapRB, term()}] | nil) :: Evision.DNN.Model.t() | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.dnn_dnn_Model_setInputParams(Evision.Internal.Structurise.from_struct(self), positional ++ Evision.Internal.Structurise.from_struct(opts || []))
     |> to_struct()
  end
  ...
  def setInputParams([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_setInputParams()
    |> to_struct()
  end
  @spec setInputParams(Evision.DNN.Model.t()) :: Evision.DNN.Model.t() | {:error, String.t()}
  ...
  def setInputScale([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_setInputScale()
    |> to_struct()
  end
  ...
  ```
  """
  @spec setInputScale(Evision.DNN.Model.t(), Evision.scalar()) :: Evision.DNN.Model.t() | {:error, String.t()}
  ...
  def setInputSize([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_setInputSize()
    |> to_struct()
  end
  ...
  **Note**: If shape of the new blob less than 0, then frame size not change.
  ...
  def setInputSwapRB([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_setInputSwapRB()
    |> to_struct()
  end
  ...
  def setOutputNames([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_setOutputNames()
    |> to_struct()
  end
  ...
  ```
  """
  @spec setOutputNames(Evision.DNN.Model.t(), list(binary())) :: Evision.DNN.Model.t() | {:error, String.t()}
  def setOutputNames(self, outNames) when is_list(outNames)
  do
    positional = [
      outNames: Evision.Internal.Structurise.from_struct(outNames)
    ]
    :evision_nif.dnn_dnn_Model_setOutputNames(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def setPreferableBackend([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_setPreferableBackend()
    |> to_struct()
  end
  ...
  ```
  """
  @spec setPreferableBackend(Evision.DNN.Model.t(), Evision.DNN.Backend.enum()) :: Evision.DNN.Model.t() | {:error, String.t()}
  ...
  def setPreferableTarget([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Model_setPreferableTarget()
    |> to_struct()
  end
  ...
  ```
  """
  @spec setPreferableTarget(Evision.DNN.Model.t(), Evision.DNN.Target.enum()) :: Evision.DNN.Model.t() | {:error, String.t()}
