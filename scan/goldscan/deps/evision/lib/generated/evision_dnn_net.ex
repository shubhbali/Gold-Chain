defmodule Evision.DNN.Net do
  ...
  def net([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_Net()
    |> to_struct()
  end
  ...
  @spec addLayer(Keyword.t()) :: any() | {:error, String.t()}
  def addLayer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:type,:dtype,:params,:name])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_addLayer()
    |> to_struct()
  end
  ...
  ```
  """
  @spec addLayer(Evision.DNN.Net.t(), binary(), binary(), integer(), Evision.DNN.LayerParams.t()) :: integer() | {:error, String.t()}
  def addLayer(self, name, type, dtype, params) when is_binary(name) and is_binary(type) and is_integer(dtype) and is_struct(params, Evision.DNN.LayerParams)
  do
    positional = [
    ...
    :evision_nif.dnn_dnn_Net_addLayer(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  @spec addLayerToPrev(Keyword.t()) :: any() | {:error, String.t()}
  def addLayerToPrev([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:type,:dtype,:params,:name])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_addLayerToPrev()
    |> to_struct()
  end
  ...
  ```
  """
  @spec addLayerToPrev(Evision.DNN.Net.t(), binary(), binary(), integer(), Evision.DNN.LayerParams.t()) :: integer() | {:error, String.t()}
  def addLayerToPrev(self, name, type, dtype, params) when is_binary(name) and is_binary(type) and is_integer(dtype) and is_struct(params, Evision.DNN.LayerParams)
  do
    positional = [
      name: Evision.Internal.Structurise.from_struct(name),
      type: Evision.Internal.Structurise.from_struct(type),
    ...
    :evision_nif.dnn_dnn_Net_addLayerToPrev(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  @spec connect(Keyword.t()) :: any() | {:error, String.t()}
  def connect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:outPin,:inpPin])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_connect()
    |> to_struct()
  end
  ...
  def dump([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_dump()
    |> to_struct()
  end
  ...
  def dumpToFile([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:path])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_dumpToFile()
    |> to_struct()
  end
  ...
  def dumpToPbtxt([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:path])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_dumpToPbtxt()
    |> to_struct()
  end
  ...
  def enableFusion([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:fusion])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_enableFusion()
    |> to_struct()
  end
  ...
  def enableWinograd([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_enableWinograd()
    |> to_struct()
  end
  ...
  def forwardAndRetrieve([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:outputBlobs,:outBlobNames])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_forwardAndRetrieve()
    |> to_struct()
  end
  ...
  def forwardAsync([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:outputName])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_forwardAsync()
    |> to_struct()
  end
  ...
  def getFLOPS([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:netInputShapes,:layerId,:netInputShape])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getFLOPS()
    |> to_struct()
  end
  ...
  def getInputDetails([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:scales,:zeropoints])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getInputDetails()
    |> to_struct()
  end
  ...
  def getLayer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:layerName,:layerId])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getLayer()
    |> to_struct()
  end
  ...
  def getLayerId([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:layer])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getLayerId()
    |> to_struct()
  end
  ...
  def getLayerNames([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getLayerNames()
    |> to_struct()
  end
  ...
  def getLayerTypes([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:layersTypes])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getLayerTypes()
    |> to_struct()
  end
  ...
  def getLayersCount([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:layerType])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getLayersCount()
    |> to_struct()
  end
  ...
  def getMemoryConsumption([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:blobs,:netInputShape,:netInputShapes,:layerId,:weights])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getMemoryConsumption()
    |> to_struct()
  end
  ...
  def getOutputDetails([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:scales,:zeropoints])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getOutputDetails()
    |> to_struct()
  end
  ...
  def getParam([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:layerName,:numParam,:layer])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getParam()
    |> to_struct()
  end
  ...
  def getPerfProfile([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:timings])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getPerfProfile()
    |> to_struct()
  end
  ...
  def getUnconnectedOutLayers([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getUnconnectedOutLayers()
    |> to_struct()
  end
  ...
  def getUnconnectedOutLayersNames([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_getUnconnectedOutLayersNames()
    |> to_struct()
  end
  ...
  def quantize([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:perChannel,:outputsDtype,:inputsDtype,:calibData])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_quantize()
    |> to_struct()
  end
  ...
  def readFromModelOptimizer([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:bufferWeights,:bin,:bufferModelConfig,:xml])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_readFromModelOptimizer_static()
    |> to_struct()
  end
  ...
  def setHalideScheduler([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:scheduler])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_setHalideScheduler()
    |> to_struct()
  end
  ...
  def setInput([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:blob,:name,:scalefactor,:mean])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_setInput()
    |> to_struct()
  end
  ...
  def setInputShape([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:shape,:inputName])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_setInputShape()
    |> to_struct()
  end
  ...
  def setInputsNames([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:inputBlobNames])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_setInputsNames()
    |> to_struct()
  end
  ...
  def setParam([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:layerName,:blob,:numParam,:layer])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_setParam()
    |> to_struct()
  end
  ...
  **Note**: If shape of the new blob differs from the previous shape,
  ...
  def setPreferableBackend([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_setPreferableBackend()
    |> to_struct()
  end
  ...
  def setPreferableTarget([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dnn_dnn_Net_setPreferableTarget()
    |> to_struct()
  end
