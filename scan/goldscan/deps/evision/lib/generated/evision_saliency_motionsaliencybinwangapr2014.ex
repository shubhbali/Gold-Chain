defmodule Evision.Saliency.MotionSaliencyBinWangApr2014 do
  ...
  def computeSaliency([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.saliency_saliency_MotionSaliencyBinWangApr2014_computeSaliency()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_MotionSaliencyBinWangApr2014_create_static()
    |> to_struct()
  end
  ...
  def getImageHeight([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_MotionSaliencyBinWangApr2014_getImageHeight()
    |> to_struct()
  end
  ...
  def getImageWidth([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_MotionSaliencyBinWangApr2014_getImageWidth()
    |> to_struct()
  end
  ...
  def init([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_MotionSaliencyBinWangApr2014_init()
    |> to_struct()
  end
  ...
  def setImageHeight([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_MotionSaliencyBinWangApr2014_setImageHeight()
    |> to_struct()
  end
  ...
  def setImageWidth([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_MotionSaliencyBinWangApr2014_setImageWidth()
    |> to_struct()
  end
  ...
  def setImagesize([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:H,:W])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.saliency_saliency_MotionSaliencyBinWangApr2014_setImagesize()
    |> to_struct()
  end
