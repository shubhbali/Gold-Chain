defmodule Evision.Utils do
  ...
  def copyMatAndDumpNamedArguments([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:params,:src,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_copyMatAndDumpNamedArguments()
    |> to_struct()
  end
  ...
  def dumpBool([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpBool()
    |> to_struct()
  end
  ...
  def dumpCString([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpCString()
    |> to_struct()
  end
  ...
  def dumpDouble([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpDouble()
    |> to_struct()
  end
  ...
  def dumpFloat([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpFloat()
    |> to_struct()
  end
  ...
  def dumpInputArray([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpInputArray()
    |> to_struct()
  end
  ...
  def dumpInputArrayOfArrays([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpInputArrayOfArrays()
    |> to_struct()
  end
  ...
  def dumpInputOutputArray([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpInputOutputArray()
    |> to_struct()
  end
  ...
  def dumpInputOutputArrayOfArrays([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpInputOutputArrayOfArrays()
    |> to_struct()
  end
  ...
  def dumpInt([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpInt()
    |> to_struct()
  end
  ...
  def dumpInt64([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpInt64()
    |> to_struct()
  end
  ...
  def dumpRange([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpRange()
    |> to_struct()
  end
  ...
  def dumpRect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpRect()
    |> to_struct()
  end
  ...
  def dumpRotatedRect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpRotatedRect()
    |> to_struct()
  end
  ...
  def dumpSizeT([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpSizeT()
    |> to_struct()
  end
  ...
  def dumpString([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpString()
    |> to_struct()
  end
  ...
  def dumpTermCriteria([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpTermCriteria()
    |> to_struct()
  end
  ...
  def dumpVec2i([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:value])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpVec2i()
    |> to_struct()
  end
  ...
  def dumpVectorOfDouble([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpVectorOfDouble()
    |> to_struct()
  end
  ...
  def dumpVectorOfInt([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpVectorOfInt()
    |> to_struct()
  end
  ...
  def dumpVectorOfRect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vec])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_dumpVectorOfRect()
    |> to_struct()
  end
  ...
  def generateVectorOfInt([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vec,:len])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_generateVectorOfInt()
    |> to_struct()
  end
  ...
  @spec generateVectorOfMat(Keyword.t()) :: any() | {:error, String.t()}
  def generateVectorOfMat([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:rows,:cols,:vec,:dtype,:len])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_generateVectorOfMat()
    |> to_struct()
  end
  ...
  def generateVectorOfRect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:vec,:len])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_generateVectorOfRect()
    |> to_struct()
  end
  ...
  def testAsyncArray([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_testAsyncArray()
    |> to_struct()
  end
  ...
  @spec testAsyncException(Keyword.t()) :: any() | {:error, String.t()}
  def testAsyncException([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_testAsyncException()
    |> to_struct()
  end
  ...
  def testOverloadResolution([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:point,:value,:rect])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_testOverloadResolution()
    |> to_struct()
  end
  ...
  def testOverwriteNativeMethod([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:argument])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_testOverwriteNativeMethod()
    |> to_struct()
  end
  ...
  @spec testRaiseGeneralException(Keyword.t()) :: any() | {:error, String.t()}
  def testRaiseGeneralException([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_testRaiseGeneralException()
    |> to_struct()
  end
  ...
  def testReservedKeywordConversion([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:lambda,:positional_argument,:from])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_testReservedKeywordConversion()
    |> to_struct()
  end
  ...
  @spec testRotatedRect(Keyword.t()) :: any() | {:error, String.t()}
  def testRotatedRect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:w,:angle,:y,:x,:h])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_testRotatedRect()
    |> to_struct()
  end
  ...
  @spec testRotatedRectVector(Keyword.t()) :: any() | {:error, String.t()}
  def testRotatedRectVector([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:w,:angle,:y,:x,:h])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.utils_testRotatedRectVector()
    |> to_struct()
  end
