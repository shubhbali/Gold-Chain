defmodule Evision.LineMod do
  ...
  ```
  """
  @spec colormap(Keyword.t()) :: any() | {:error, String.t()}
  def colormap([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:quantized,:dst])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_colormap()
    |> to_struct()
  end
  ...
  @spec drawFeatures(Keyword.t()) :: any() | {:error, String.t()}
  def drawFeatures([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:tl,:img,:size,:templates])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_drawFeatures()
    |> to_struct()
  end
  ...
  @spec getDefaultLINE(Keyword.t()) :: any() | {:error, String.t()}
  def getDefaultLINE([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_getDefaultLINE()
    |> to_struct()
  end
  ...
  @spec getDefaultLINEMOD(Keyword.t()) :: any() | {:error, String.t()}
  def getDefaultLINEMOD([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.linemod_getDefaultLINEMOD()
    |> to_struct()
  end
