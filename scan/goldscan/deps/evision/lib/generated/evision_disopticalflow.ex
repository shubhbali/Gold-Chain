defmodule Evision.DISOpticalFlow do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:preset])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_create_static()
    |> to_struct()
  end
  ...
  def getFinestScale([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getFinestScale()
    |> to_struct()
  end
  ...
  def getGradientDescentIterations([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getGradientDescentIterations()
    |> to_struct()
  end
  ...
  def getPatchSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getPatchSize()
    |> to_struct()
  end
  ...
  def getPatchStride([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getPatchStride()
    |> to_struct()
  end
  ...
  def getUseMeanNormalization([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getUseMeanNormalization()
    |> to_struct()
  end
  ...
  def getUseSpatialPropagation([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getUseSpatialPropagation()
    |> to_struct()
  end
  ...
  def getVariationalRefinementAlpha([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getVariationalRefinementAlpha()
    |> to_struct()
  end
  ...
  def getVariationalRefinementDelta([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getVariationalRefinementDelta()
    |> to_struct()
  end
  ...
  def getVariationalRefinementEpsilon([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getVariationalRefinementEpsilon()
    |> to_struct()
  end
  ...
  def getVariationalRefinementGamma([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getVariationalRefinementGamma()
    |> to_struct()
  end
  ...
  def getVariationalRefinementIterations([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_getVariationalRefinementIterations()
    |> to_struct()
  end
  ...
  @spec setFinestScale(Keyword.t()) :: any() | {:error, String.t()}
  def setFinestScale([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setFinestScale()
    |> to_struct()
  end
  ...
  @spec setGradientDescentIterations(Keyword.t()) :: any() | {:error, String.t()}
  def setGradientDescentIterations([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setGradientDescentIterations()
    |> to_struct()
  end
  ...
  def setPatchSize([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setPatchSize()
    |> to_struct()
  end
  ...
  @spec setPatchStride(Keyword.t()) :: any() | {:error, String.t()}
  def setPatchStride([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setPatchStride()
    |> to_struct()
  end
  ...
  @spec setUseMeanNormalization(Keyword.t()) :: any() | {:error, String.t()}
  def setUseMeanNormalization([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setUseMeanNormalization()
    |> to_struct()
  end
  ...
  @spec setUseSpatialPropagation(Keyword.t()) :: any() | {:error, String.t()}
  def setUseSpatialPropagation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setUseSpatialPropagation()
    |> to_struct()
  end
  ...
  @spec setVariationalRefinementAlpha(Keyword.t()) :: any() | {:error, String.t()}
  def setVariationalRefinementAlpha([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setVariationalRefinementAlpha()
    |> to_struct()
  end
  ...
  @spec setVariationalRefinementDelta(Keyword.t()) :: any() | {:error, String.t()}
  def setVariationalRefinementDelta([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setVariationalRefinementDelta()
    |> to_struct()
  end
  ...
  @spec setVariationalRefinementEpsilon(Keyword.t()) :: any() | {:error, String.t()}
  def setVariationalRefinementEpsilon([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setVariationalRefinementEpsilon()
    |> to_struct()
  end
  ...
  @spec setVariationalRefinementGamma(Keyword.t()) :: any() | {:error, String.t()}
  def setVariationalRefinementGamma([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setVariationalRefinementGamma()
    |> to_struct()
  end
  ...
  @spec setVariationalRefinementIterations(Keyword.t()) :: any() | {:error, String.t()}
  def setVariationalRefinementIterations([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:val])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.disOpticalFlow_setVariationalRefinementIterations()
    |> to_struct()
  end
