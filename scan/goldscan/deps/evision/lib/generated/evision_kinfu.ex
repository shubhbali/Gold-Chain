defmodule Evision.KinFu do
  ...
  def makeVolume([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_maxWeight,:_voxelSize,:_truncDist,:_truncateThreshold,:_resolution,:_raycastStepFactor,:_volumeType,:_pose])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.kinfu_makeVolume()
    |> to_struct()
  end
