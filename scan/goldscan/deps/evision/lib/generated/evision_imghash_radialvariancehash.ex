defmodule Evision.ImgHash.RadialVarianceHash do
  ...
  def clear([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.img_hash_RadialVarianceHash_clear()
    |> to_struct()
  end
  @spec clear(Evision.ImgHash.RadialVarianceHash.t()) :: Evision.ImgHash.RadialVarianceHash.t() | {:error, String.t()}
  def clear(self) do
    positional = [
    ]
    :evision_nif.img_hash_RadialVarianceHash_clear(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def compare([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_img_hash_RadialVarianceHash_compare()
    |> to_struct()
  end
  ...
  ```
  """
  @spec compare(Evision.ImgHash.RadialVarianceHash.t(), Evision.Mat.maybe_mat_in(), Evision.Mat.maybe_mat_in()) :: number() | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.img_hash_img_hash_RadialVarianceHash_compare(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  ```
  """
  @spec compute(Evision.ImgHash.RadialVarianceHash.t(), Evision.Mat.maybe_mat_in(), [{atom(), term()},...] | nil) :: Evision.Mat.t() | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.img_hash_img_hash_RadialVarianceHash_compute(Evision.Internal.Structurise.from_struct(self), positional ++ Evision.Internal.Structurise.from_struct(opts || []))
     |> to_struct()
  end
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_img_hash_RadialVarianceHash_compute()
    |> to_struct()
  end
  ...
  ```
  """
  @spec compute(Evision.ImgHash.RadialVarianceHash.t(), Evision.Mat.maybe_mat_in()) :: Evision.Mat.t() | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.img_hash_img_hash_RadialVarianceHash_compute(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sigma,:numOfAngleLine])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_img_hash_RadialVarianceHash_create_static()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_RadialVarianceHash_empty()
    |> to_struct()
  end
  @spec empty(Evision.ImgHash.RadialVarianceHash.t()) :: boolean() | {:error, String.t()}
  def empty(self) do
    positional = [
    ]
    :evision_nif.img_hash_RadialVarianceHash_empty(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_RadialVarianceHash_getDefaultName()
    |> to_struct()
  end
  @spec getDefaultName(Evision.ImgHash.RadialVarianceHash.t()) :: binary() | {:error, String.t()}
  def getDefaultName(self) do
    positional = [
    ]
    :evision_nif.img_hash_RadialVarianceHash_getDefaultName(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def getNumOfAngleLine([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_img_hash_RadialVarianceHash_getNumOfAngleLine()
    |> to_struct()
  end
  ...
  def getSigma([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_img_hash_RadialVarianceHash_getSigma()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_RadialVarianceHash_read()
    |> to_struct()
  end
  ...
  ```
  """
  @spec read(Evision.ImgHash.RadialVarianceHash.t(), Evision.FileNode.t()) :: Evision.ImgHash.RadialVarianceHash.t() | {:error, String.t()}
  def read(self, func) when is_struct(func, Evision.FileNode)
  do
    positional = [
      func: Evision.Internal.Structurise.from_struct(func)
    ]
    :evision_nif.img_hash_RadialVarianceHash_read(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_RadialVarianceHash_save()
    |> to_struct()
  end
  ...
  ```
  """
  @spec save(Evision.ImgHash.RadialVarianceHash.t(), binary()) :: Evision.ImgHash.RadialVarianceHash.t() | {:error, String.t()}
  def save(self, filename) when is_binary(filename)
  do
    positional = [
      filename: Evision.Internal.Structurise.from_struct(filename)
    ]
    :evision_nif.img_hash_RadialVarianceHash_save(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  @spec setNumOfAngleLine(Keyword.t()) :: any() | {:error, String.t()}
  def setNumOfAngleLine([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:value])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_img_hash_RadialVarianceHash_setNumOfAngleLine()
    |> to_struct()
  end
  ...
  def setSigma([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:value])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_img_hash_RadialVarianceHash_setSigma()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.img_hash_RadialVarianceHash_write()
    |> to_struct()
  end
  ...
  ```
  """
  @spec write(Evision.ImgHash.RadialVarianceHash.t(), Evision.FileStorage.t(), binary()) :: Evision.ImgHash.RadialVarianceHash.t() | {:error, String.t()}
  ...
  do
    ...
    :evision_nif.img_hash_RadialVarianceHash_write(Evision.Internal.Structurise.from_struct(self), positional)
    |> to_struct()
  end
  ...
  ```
  """
  @spec write(Evision.ImgHash.RadialVarianceHash.t(), Evision.FileStorage.t()) :: Evision.ImgHash.RadialVarianceHash.t() | {:error, String.t()}
