defmodule Evision.QRCodeDetector do
  ...
  @spec qrCodeDetector(Keyword.t()) :: any() | {:error, String.t()}
  def qrCodeDetector([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_QRCodeDetector()
    |> to_struct()
  end
  ...
  def decode([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_decode()
    |> to_struct()
  end
  ...
  @spec decodeCurved(Keyword.t()) :: any() | {:error, String.t()}
  def decodeCurved([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points,:straight_qrcode])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_decodeCurved()
    |> to_struct()
  end
  ...
  def decodeMulti([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_decodeMulti()
    |> to_struct()
  end
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_detect()
    |> to_struct()
  end
  ...
  def detectAndDecode([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points,:straight_code])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_detectAndDecode()
    |> to_struct()
  end
  ...
  @spec detectAndDecodeCurved(Keyword.t()) :: any() | {:error, String.t()}
  def detectAndDecodeCurved([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points,:straight_qrcode])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_detectAndDecodeCurved()
    |> to_struct()
  end
  ...
  def detectAndDecodeMulti([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:decoded_info,:img,:points,:straight_code])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_detectAndDecodeMulti()
    |> to_struct()
  end
  ...
  def detectMulti([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_detectMulti()
    |> to_struct()
  end
  ...
  @spec setEpsX(Keyword.t()) :: any() | {:error, String.t()}
  def setEpsX([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:epsX])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_setEpsX()
    |> to_struct()
  end
  ...
  @spec setEpsY(Keyword.t()) :: any() | {:error, String.t()}
  def setEpsY([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:epsY])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_setEpsY()
    |> to_struct()
  end
  ...
  @spec setUseAlignmentMarkers(Keyword.t()) :: any() | {:error, String.t()}
  def setUseAlignmentMarkers([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:useAlignmentMarkers])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetector_setUseAlignmentMarkers()
    |> to_struct()
  end
