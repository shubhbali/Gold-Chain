defmodule Evision.Face do
  ...
  @spec createFacemarkAAM(Keyword.t()) :: any() | {:error, String.t()}
  def createFacemarkAAM([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.face_createFacemarkAAM()
    |> to_struct()
  end
  ...
  @spec createFacemarkKazemi(Keyword.t()) :: any() | {:error, String.t()}
  def createFacemarkKazemi([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.face_createFacemarkKazemi()
    |> to_struct()
  end
  ...
  @spec createFacemarkLBF(Keyword.t()) :: any() | {:error, String.t()}
  def createFacemarkLBF([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.face_createFacemarkLBF()
    |> to_struct()
  end
  ...
  @spec drawFacemarks(Keyword.t()) :: any() | {:error, String.t()}
  def drawFacemarks([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:color,:points,:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.face_drawFacemarks()
    |> to_struct()
  end
  ...
  @spec getFacesHAAR(Keyword.t()) :: any() | {:error, String.t()}
  def getFacesHAAR([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:faces,:image,:face_cascade_name])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.face_getFacesHAAR()
    |> to_struct()
  end
  ...
  @spec loadDatasetList(Keyword.t()) :: any() | {:error, String.t()}
  def loadDatasetList([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:images,:imageList,:annotations,:annotationList])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.face_loadDatasetList()
    |> to_struct()
  end
  ...
  ```
  """
  @spec loadFacePoints(Keyword.t()) :: any() | {:error, String.t()}
  def loadFacePoints([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:points,:offset,:filename])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.face_loadFacePoints()
    |> to_struct()
  end
  ...
  @spec loadTrainingData(Keyword.t()) :: any() | {:error, String.t()}
  def loadTrainingData([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:images,:offset,:filename,:delim,:groundTruth,:trainimages,:imageList,:trainlandmarks,:facePoints])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.face_loadTrainingData()
    |> to_struct()
  end
