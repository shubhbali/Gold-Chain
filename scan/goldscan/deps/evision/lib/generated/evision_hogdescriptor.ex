defmodule Evision.HOGDescriptor do
  ...
  def hogDescriptor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_histogramNormType,:_derivAperture,:_cellSize,:_blockSize,:_L2HysThreshold,:_gammaCorrection,:_nlevels,:filename,:_winSigma,:_signedGradient,:_winSize,:_nbins,:_blockStride])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_HOGDescriptor()
    |> to_struct()
  end
  ...
  def checkDetectorSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_checkDetectorSize()
    |> to_struct()
  end
  ...
  def compute([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:padding,:img,:locations,:descriptors,:winStride])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_compute()
    |> to_struct()
  end
  ...
  @spec computeGradient(Keyword.t()) :: any() | {:error, String.t()}
  def computeGradient([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:grad,:paddingBR,:angleOfs,:paddingTL])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_computeGradient()
    |> to_struct()
  end
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:padding,:img,:searchLocations,:weights,:hitThreshold,:winStride,:foundLocations])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_detect()
    |> to_struct()
  end
  ...
  def detectMultiScale([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:padding,:img,:scale,:foundWeights,:hitThreshold,:groupThreshold,:winStride,:useMeanshiftGrouping,:foundLocations])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_detectMultiScale()
    |> to_struct()
  end
  ...
  @spec getDaimlerPeopleDetector(Keyword.t()) :: any() | {:error, String.t()}
  def getDaimlerPeopleDetector([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_getDaimlerPeopleDetector_static()
    |> to_struct()
  end
  ...
  def getDefaultPeopleDetector([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_getDefaultPeopleDetector_static()
    |> to_struct()
  end
  ...
  def getDescriptorSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_getDescriptorSize()
    |> to_struct()
  end
  ...
  def getWinSigma([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_getWinSigma()
    |> to_struct()
  end
  ...
  def load([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename,:objname])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_load()
    |> to_struct()
  end
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:filename,:objname])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_save()
    |> to_struct()
  end
  ...
  def setSVMDetector([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:svmdetector])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.hogDescriptor_setSVMDetector()
    |> to_struct()
  end
