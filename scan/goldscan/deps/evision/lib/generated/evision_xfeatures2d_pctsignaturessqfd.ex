defmodule Evision.XFeatures2D.PCTSignaturesSQFD do
  ...
  def clear([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.xfeatures2d_PCTSignaturesSQFD_clear()
    |> to_struct()
  end
  ...
  @spec computeQuadraticFormDistance(Keyword.t()) :: any() | {:error, String.t()}
  def computeQuadraticFormDistance([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_signature0,:_signature1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignaturesSQFD_computeQuadraticFormDistance()
    |> to_struct()
  end
  ...
  @spec computeQuadraticFormDistances(Keyword.t()) :: any() | {:error, String.t()}
  def computeQuadraticFormDistances([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:imageSignatures,:distances,:sourceSignature])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignaturesSQFD_computeQuadraticFormDistances()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:similarityParameter,:similarityFunction,:distanceFunction])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_xfeatures2d_PCTSignaturesSQFD_create_static()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignaturesSQFD_empty()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignaturesSQFD_getDefaultName()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignaturesSQFD_read()
    |> to_struct()
  end
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignaturesSQFD_save()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xfeatures2d_PCTSignaturesSQFD_write()
    |> to_struct()
  end
