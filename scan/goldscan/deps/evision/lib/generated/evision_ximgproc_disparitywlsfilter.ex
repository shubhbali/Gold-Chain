defmodule Evision.XImgProc.DisparityWLSFilter do
  ...
  def getConfidenceMap([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_getConfidenceMap()
    |> to_struct()
  end
  ...
  def getDepthDiscontinuityRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_getDepthDiscontinuityRadius()
    |> to_struct()
  end
  ...
  def getLRCthresh([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_getLRCthresh()
    |> to_struct()
  end
  ...
  def getLambda([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_getLambda()
    |> to_struct()
  end
  ...
  def getROI([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_getROI()
    |> to_struct()
  end
  ...
  def getSigmaColor([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_getSigmaColor()
    |> to_struct()
  end
  ...
  @spec setDepthDiscontinuityRadius(Keyword.t()) :: any() | {:error, String.t()}
  def setDepthDiscontinuityRadius([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_disc_radius])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_setDepthDiscontinuityRadius()
    |> to_struct()
  end
  ...
  @spec setLRCthresh(Keyword.t()) :: any() | {:error, String.t()}
  def setLRCthresh([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_LRC_thresh])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_setLRCthresh()
    |> to_struct()
  end
  ...
  def setLambda([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_lambda])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_setLambda()
    |> to_struct()
  end
  ...
  def setSigmaColor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:_sigma_color])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ximgproc_ximgproc_DisparityWLSFilter_setSigmaColor()
    |> to_struct()
  end
