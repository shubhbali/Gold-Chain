defmodule Evision.Detail.BundleAdjusterBase do
  ...
  ```
  """
  @spec confThresh(Keyword.t()) :: any() | {:error, String.t()}
  def confThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BundleAdjusterBase_confThresh()
    |> to_struct()
  end
  ...
  ```
  """
  @spec refinementMask(Keyword.t()) :: any() | {:error, String.t()}
  def refinementMask([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BundleAdjusterBase_refinementMask()
    |> to_struct()
  end
  ...
  @spec setConfThresh(Keyword.t()) :: any() | {:error, String.t()}
  def setConfThresh([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:conf_thresh])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BundleAdjusterBase_setConfThresh()
    |> to_struct()
  end
  ...
  @spec setRefinementMask(Keyword.t()) :: any() | {:error, String.t()}
  def setRefinementMask([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:mask])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BundleAdjusterBase_setRefinementMask()
    |> to_struct()
  end
  ...
  def setTermCriteria([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:term_criteria])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BundleAdjusterBase_setTermCriteria()
    |> to_struct()
  end
  ...
  ```
  """
  @spec termCriteria(Keyword.t()) :: any() | {:error, String.t()}
  def termCriteria([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_BundleAdjusterBase_termCriteria()
    |> to_struct()
  end
