defmodule Evision.XPhoto.TonemapDurand do
  ...
  def getContrast([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_TonemapDurand_getContrast()
    |> to_struct()
  end
  ...
  def getSaturation([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_TonemapDurand_getSaturation()
    |> to_struct()
  end
  ...
  def getSigmaColor([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_TonemapDurand_getSigmaColor()
    |> to_struct()
  end
  ...
  def getSigmaSpace([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_TonemapDurand_getSigmaSpace()
    |> to_struct()
  end
  ...
  def setContrast([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:contrast])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_TonemapDurand_setContrast()
    |> to_struct()
  end
  ...
  def setSaturation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:saturation])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_TonemapDurand_setSaturation()
    |> to_struct()
  end
  ...
  def setSigmaColor([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sigma_color])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_TonemapDurand_setSigmaColor()
    |> to_struct()
  end
  ...
  def setSigmaSpace([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sigma_space])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.xphoto_xphoto_TonemapDurand_setSigmaSpace()
    |> to_struct()
  end
