defmodule Evision.DynaFu.DynaFu do
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.dynafu_dynafu_DynaFu_create_static()
    |> to_struct()
  end
  ...
  def getCloud([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dynafu_dynafu_DynaFu_getCloud()
    |> to_struct()
  end
  ...
  def getNormals([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:points,:normals])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dynafu_dynafu_DynaFu_getNormals()
    |> to_struct()
  end
  ...
  def getPoints([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dynafu_dynafu_DynaFu_getPoints()
    |> to_struct()
  end
  ...
  def render([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dynafu_dynafu_DynaFu_render()
    |> to_struct()
  end
  ...
  def reset([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dynafu_dynafu_DynaFu_reset()
    |> to_struct()
  end
  ...
  def update([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.dynafu_dynafu_DynaFu_update()
    |> to_struct()
  end
