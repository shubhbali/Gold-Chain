defmodule Evision.Detail.ExposureCompensator do
  ...
  def apply([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    |> :evision_nif.detail_detail_ExposureCompensator_apply()
    |> to_struct()
  end
  ...
  def createDefault([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:type])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_ExposureCompensator_createDefault_static()
    |> to_struct()
  end
  ...
  def feed([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:images,:corners,:masks])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_ExposureCompensator_feed()
    |> to_struct()
  end
  ...
  def getMatGains([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_ExposureCompensator_getMatGains()
    |> to_struct()
  end
  ...
  ```
  """
  @spec getUpdateGain(Keyword.t()) :: any() | {:error, String.t()}
  def getUpdateGain([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_ExposureCompensator_getUpdateGain()
    |> to_struct()
  end
  ...
  def setMatGains([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:arg1])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_ExposureCompensator_setMatGains()
    |> to_struct()
  end
  ...
  @spec setUpdateGain(Keyword.t()) :: any() | {:error, String.t()}
  def setUpdateGain([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:b])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.detail_detail_ExposureCompensator_setUpdateGain()
    |> to_struct()
  end
