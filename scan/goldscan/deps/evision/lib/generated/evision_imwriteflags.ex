defmodule Evision.ImwriteFlags do
  ...
  @doc enum: true
  def cv_IMWRITE_JPEGXL_QUALITY, do: 640
  @doc enum: true
  def cv_IMWRITE_JPEGXL_EFFORT, do: 641
  @doc enum: true
  def cv_IMWRITE_JPEGXL_DISTANCE, do: 642
  @doc enum: true
  def cv_IMWRITE_JPEGXL_DECODING_SPEED, do: 643
  @doc enum: true
  def cv_IMWRITE_GIF_LOOP, do: 1024
  @doc enum: true
  def cv_IMWRITE_GIF_SPEED, do: 1025
  @doc enum: true
  def cv_IMWRITE_GIF_QUALITY, do: 1026
  @doc enum: true
  def cv_IMWRITE_GIF_DITHER, do: 1027
  @doc enum: true
  def cv_IMWRITE_GIF_TRANSPARENCY, do: 1028
  @doc enum: true
  def cv_IMWRITE_GIF_COLORTABLE, do: 1029
end
