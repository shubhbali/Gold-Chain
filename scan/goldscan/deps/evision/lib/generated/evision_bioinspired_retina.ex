defmodule Evision.Bioinspired.Retina do
  ...
  @spec activateContoursProcessing(Keyword.t()) :: any() | {:error, String.t()}
  def activateContoursProcessing([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:activate])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_activateContoursProcessing()
    |> to_struct()
  end
  ...
  @spec activateMovingContoursProcessing(Keyword.t()) :: any() | {:error, String.t()}
  def activateMovingContoursProcessing([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:activate])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_activateMovingContoursProcessing()
    |> to_struct()
  end
  ...
  @spec applyFastToneMapping(Keyword.t()) :: any() | {:error, String.t()}
  def applyFastToneMapping([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:outputToneMappedImage,:inputImage])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_applyFastToneMapping()
    |> to_struct()
  end
  ...
  def clear([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_Retina_clear()
    |> to_struct()
  end
  ...
  def clearBuffers([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_clearBuffers()
    |> to_struct()
  end
  ...
  def create([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:samplingStrength,:inputSize,:useRetinaLogSampling,:reductionFactor,:colorMode,:colorSamplingMethod])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_create_static()
    |> to_struct()
  end
  ...
  def empty([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_Retina_empty()
    |> to_struct()
  end
  ...
  def getDefaultName([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_Retina_getDefaultName()
    |> to_struct()
  end
  ...
  def getInputSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_getInputSize()
    |> to_struct()
  end
  ...
  def getMagno([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:retinaOutput_magno])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_getMagno()
    |> to_struct()
  end
  ...
  def getMagnoRAW([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:retinaOutput_magno])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_getMagnoRAW()
    |> to_struct()
  end
  ...
  def getOutputSize([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_getOutputSize()
    |> to_struct()
  end
  ...
  def getParvo([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:retinaOutput_parvo])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_getParvo()
    |> to_struct()
  end
  ...
  def getParvoRAW([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:retinaOutput_parvo])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_getParvoRAW()
    |> to_struct()
  end
  ...
  def printSetup([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_printSetup()
    |> to_struct()
  end
  ...
  def read([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_Retina_read()
    |> to_struct()
  end
  ...
  def run([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:inputImage])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_run()
    |> to_struct()
  end
  ...
  def save([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_Retina_save()
    |> to_struct()
  end
  ...
  def setColorSaturation([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:colorSaturationValue,:saturateColors])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_setColorSaturation()
    |> to_struct()
  end
  ...
  def setup([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:retinaParameterFile,:applyDefaultSetupOnFailure])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_setup()
    |> to_struct()
  end
  ...
  def setupIPLMagnoChannel([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:parasolCells_tau,:parasolCells_k,:V0CompressionParameter,:amacrinCellsTemporalCutFrequency,:localAdaptintegration_k,:localAdaptintegration_tau,:parasolCells_beta,:normaliseOutput])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_setupIPLMagnoChannel()
    |> to_struct()
  end
  ...
  def setupOPLandIPLParvoChannel([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:photoreceptorsSpatialConstant,:HcellsTemporalConstant,:horizontalCellsGain,:photoreceptorsLocalAdaptationSensitivity,:HcellsSpatialConstant,:ganglionCellsSensitivity,:colorMode,:photoreceptorsTemporalConstant,:normaliseOutput])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_setupOPLandIPLParvoChannel()
    |> to_struct()
  end
  ...
  def write([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:fs])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.bioinspired_bioinspired_Retina_write()
    |> to_struct()
  end
