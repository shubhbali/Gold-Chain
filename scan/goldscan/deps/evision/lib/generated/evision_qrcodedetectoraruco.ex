defmodule Evision.QRCodeDetectorAruco do
  ...
  def qrcodedetectoraruco([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:params])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_QRCodeDetectorAruco()
    |> to_struct()
  end
  ...
  def decode([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_decode()
    |> to_struct()
  end
  ...
  def decodeMulti([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_decodeMulti()
    |> to_struct()
  end
  ...
  def detect([{arg, _} | _] = named_args) when is_atom(arg) do
    ...
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_detect()
    |> to_struct()
  end
  ...
  def detectAndDecode([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points,:straight_code])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_detectAndDecode()
    |> to_struct()
  end
  ...
  def detectAndDecodeMulti([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:decoded_info,:img,:points,:straight_code])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_detectAndDecodeMulti()
    |> to_struct()
  end
  ...
  def detectMulti([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:img,:points])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_detectMulti()
    |> to_struct()
  end
  ...
  def getArucoParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_getArucoParameters()
    |> to_struct()
  end
  ...
  def getDetectorParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_getDetectorParameters()
    |> to_struct()
  end
  ...
  @spec setArucoParameters(Keyword.t()) :: any() | {:error, String.t()}
  def setArucoParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:params])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_setArucoParameters()
    |> to_struct()
  end
  ...
  def setDetectorParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:params])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.qrCodeDetectorAruco_setDetectorParameters()
    |> to_struct()
  end
