defmodule Evision.Segmentation.IntelligentScissorsMB do
  ...
  def intelligentScissorsMB([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.segmentation_segmentation_IntelligentScissorsMB_IntelligentScissorsMB()
    |> to_struct()
  end
  ...
  def applyImage([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:image])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.segmentation_segmentation_IntelligentScissorsMB_applyImage()
    |> to_struct()
  end
  ...
  def applyImageFeatures([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:gradient_direction,:non_edge,:image,:gradient_magnitude])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.segmentation_segmentation_IntelligentScissorsMB_applyImageFeatures()
    |> to_struct()
  end
  ...
  def buildMap([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:sourcePt])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.segmentation_segmentation_IntelligentScissorsMB_buildMap()
    |> to_struct()
  end
  ...
  **Note**: buildMap() must be called before this call
  ...
  def getContour([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:backward,:targetPt,:contour])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.segmentation_segmentation_IntelligentScissorsMB_getContour()
    |> to_struct()
  end
  ...
  **Note**: "Laplacian Zero-Crossing" feature extractor is used by default (following to original article)
  ...
  def setEdgeFeatureCannyParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:threshold1,:L2gradient,:threshold2,:apertureSize])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.segmentation_segmentation_IntelligentScissorsMB_setEdgeFeatureCannyParameters()
    |> to_struct()
  end
  ...
  **Note**: Canny edge detector is a bit slower, but provides better results (especially on color images): use setEdgeFeatureCannyParameters().
  ...
  ```
  """
  @spec setEdgeFeatureZeroCrossingParameters(Keyword.t()) :: any() | {:error, String.t()}
  def setEdgeFeatureZeroCrossingParameters([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:gradient_magnitude_min_value])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.segmentation_segmentation_IntelligentScissorsMB_setEdgeFeatureZeroCrossingParameters()
    |> to_struct()
  end
  ...
  **Note**: Thresholding should be used for images with irregular regions (to avoid stuck on parameters from high-contract areas, like embedded logos).
  ...
  def setGradientMagnitudeMaxLimit([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:gradient_magnitude_threshold_max])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.segmentation_segmentation_IntelligentScissorsMB_setGradientMagnitudeMaxLimit()
    |> to_struct()
  end
  ...
  def setWeights([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:weight_gradient_magnitude,:weight_non_edge,:weight_gradient_direction])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.segmentation_segmentation_IntelligentScissorsMB_setWeights()
    |> to_struct()
  end
