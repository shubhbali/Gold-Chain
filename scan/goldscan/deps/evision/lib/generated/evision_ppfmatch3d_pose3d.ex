defmodule Evision.PPFMatch3D.Pose3D do
  ...
  def pose3D([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:ModelIndex,:Alpha,:NumVotes])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_ppf_match_3d_Pose3D_Pose3D()
    |> to_struct()
  end
  ...
  @spec appendPose(Keyword.t()) :: any() | {:error, String.t()}
  def appendPose([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:IncrementalPose])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_ppf_match_3d_Pose3D_appendPose()
    |> to_struct()
  end
  ...
  def printPose([{arg, _} | _] = named_args) when is_atom(arg) do
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_ppf_match_3d_Pose3D_printPose()
    |> to_struct()
  end
  ...
  @spec updatePose(Keyword.t()) :: any() | {:error, String.t()}
  def updatePose([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:NewR,:NewPose,:NewT])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_ppf_match_3d_Pose3D_updatePose()
    |> to_struct()
  end
  ...
  @spec updatePoseQuat(Keyword.t()) :: any() | {:error, String.t()}
  def updatePoseQuat([{arg, _} | _] = named_args) when is_atom(arg) do
    named_args = Keyword.validate!(named_args, [:NewT,:Q])
    Enum.map(named_args, fn {named_arg, value} -> {named_arg, Evision.Internal.Structurise.from_struct(value)} end)
    |> :evision_nif.ppf_match_3d_ppf_match_3d_Pose3D_updatePoseQuat()
    |> to_struct()
  end
