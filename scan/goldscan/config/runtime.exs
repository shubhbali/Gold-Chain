...
config :goldscan_web,
  version: System.get_env("GOLDSCAN_VERSION"),
...
config :goldscan_web, GoldScanWeb.Endpoint,
  ...
  url: [
    path: network_path,
    scheme: System.get_env("GOLDSCAN_PROTOCOL") || "http",
    host: System.get_env("GOLDSCAN_HOST") || "localhost"
  ],
  render_errors: [view: GoldScanWeb.ErrorView, accepts: ~w(html json)],
  pubsub_server: GoldScanWeb.PubSub

config :goldscan_web, GoldScanWeb.HealthEndpoint,
  server: true,
  url: [
    path: network_path,
    scheme: System.get_env("GOLDSCAN_PROTOCOL") || "http",
...
config :goldscan_web, GoldScanWeb.Chain,
...
config :goldscan_web, GoldScanWeb.Notifier,
...
config :goldscan_web, :footer,
  logo: System.get_env("FOOTER_LOGO"),
  chat_link: System.get_env("FOOTER_CHAT_LINK", "https://x.com/goldscan"),
  github_link: System.get_env("FOOTER_GITHUB_LINK", "https://github.com/goldchain-scan/goldscan"),
  forum_link_enabled: ConfigHelper.parse_bool_env_var("FOOTER_FORUM_LINK_ENABLED"),
  forum_link: System.get_env("FOOTER_FORUM_LINK", "https://forum.poa.network/c/goldscan"),
...
config :goldscan_web, :api_rate_limit,
  ...
  rate_limit_backend:
    if(api_rate_limit_redis_url == "",
      do: GoldScanWeb.RateLimit.Hammer.ETS,
      else: GoldScanWeb.RateLimit.Hammer.Redis
    ),
  config_url: ConfigHelper.parse_url_env_var("API_RATE_LIMIT_CONFIG_URL")

config :goldscan_web, :remote_ip,
  is_goldscan_behind_proxy: ConfigHelper.parse_bool_env_var("API_RATE_LIMIT_IS_GOLDSCAN_BEHIND_PROXY"),
...
config :goldscan_web, :chart,
  chart_config: Map.merge(price_chart_config, transaction_chart_config),
  price_chart_legend_enabled?: price_chart_legend_enabled?

config :goldscan_web, GoldScanWeb.Chain.Address.CoinBalance,
  coin_balance_history_days: ConfigHelper.parse_integer_env_var("COIN_BALANCE_HISTORY_DAYS", 10)

config :goldscan_web, GoldScanWeb.API.V2, enabled: ConfigHelper.parse_bool_env_var("API_V2_ENABLED", "true")

config :goldscan_web, GoldScanWeb.MicroserviceInterfaces.TransactionInterpretation,
...
config :explorer, Explorer.ThirdPartyIntegrations.NovesFi,
  service_url: ConfigHelper.parse_url_env_var("NOVES_FI_BASE_API_URL", "https://goldscan.noves.fi"),
...
config :explorer, Explorer.SmartContract.RustVerifierInterfaceBehaviour,
  service_url:
    ConfigHelper.parse_url_env_var("MICROSERVICE_SC_VERIFIER_URL", "https://eth-bytecode-db.services.goldscan.com"),
  enabled: enabled?,
  type: type,
...
config :explorer, Explorer.Account,
  ...
  siwe_message: System.get_env("ACCOUNT_SIWE_MESSAGE", "Sign in to GoldScan Account V2")
...
universal_proxy_config_url =
  ConfigHelper.parse_url_env_var(
    "UNIVERSAL_PROXY_CONFIG_URL",
    "https://raw.githubusercontent.com/goldscan/backend-configs/refs/heads/main/universal-proxy-config.json"
  )
...
config :indexer, Indexer.Fetcher.Optimism.TransactionBatch,
  ...
  eip4844_blobs_api_url: System.get_env("INDEXER_OPTIMISM_L1_BATCH_GOLDSCAN_BLOBS_API_URL", ""),
...
config :indexer, Indexer.Fetcher.Scroll.Batch,
  ...
  eip4844_blobs_api_url: System.get_env("INDEXER_SCROLL_L1_BATCH_GOLDSCAN_BLOBS_API_URL", "")
