...
_Why we should merge these changes. If using GitHub keywords to close [issues](https://github.com/goldchain-scan/goldscan/issues), this is optional as the motivation can be read on the issue page._
...
- [ ] I updated documentation if needed:
  - [ ] General docs: submitted PR to [docs repository](https://github.com/goldscan/docs).
  - [ ] ENV vars: updated [env vars list](https://github.com/goldscan/docs/tree/main/setup/env-variables) and set version parameter to `master`.
  - [ ] Deprecated vars: added to [deprecated env vars list](https://github.com/goldscan/docs/tree/main/setup/env-variables/deprecated-env-variables).
