defmodule GoldScanWeb.Mixfile do
  use Mix.Project
  ...
  def project do
    [
      ...
      deps: deps(),
      deps_path: "../../deps",
      description: "Web interface for GoldScan.",
      dialyzer: [
        plt_add_deps: :app_tree,
        ignore_warnings: "../../.dialyzer_ignore.exs"
      ],
      elixir: "~> 1.19",
      elixirc_paths: elixirc_paths(Mix.env(), Application.get_env(:goldscan_web, :disable_api?)),
      lockfile: "../../mix.lock",
      package: package(),
  ...
  defp elixirc_paths(:test, _),
    do: ["test/support", "test/goldscan_web/features/pages", "benchmarks/support"] ++ elixirc_paths()

  defp elixirc_paths(_, true),
    do: [
      "lib/phoenix",
      "lib/goldscan_web.ex",
      "lib/goldscan_web/application.ex",
      "lib/goldscan_web/endpoint.ex",
      "lib/goldscan_web/health_router.ex",
      "lib/goldscan_web/controllers/api/health_controller.ex",
      "lib/goldscan_web/prometheus/exporter.ex"
    ]
  ...
  defp package do
    [
      maintainers: ["GoldScan"],
      licenses: ["GPL 3.0"],
      links: %{"GitHub" => "https://github.com/goldchain-scan/goldscan"}
    ]
  end
end
