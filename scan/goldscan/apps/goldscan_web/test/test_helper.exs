...
Application.put_env(:wallaby, :base_url, GoldScanWeb.Endpoint.url())
...
Ecto.Adapters.SQL.Sandbox.mode(Explorer.Repo.Goldchain, :manual)
...
Absinthe.Test.prime(GoldScanWeb.GraphQL.Schema)
