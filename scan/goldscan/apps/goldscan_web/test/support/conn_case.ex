defmodule GoldScanWeb.ConnCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import GoldScanWeb.TestApiSchemaAssertions, only: [json_response: 2]
      import GoldScanWeb.Router.Helpers
      import GoldScanWeb.Routers.WebRouter.Helpers, except: [static_path: 2]
      import GoldScanWeb.Routers.AccountRouter.Helpers, except: [static_path: 2]
      ...
      alias GoldScanWeb.Routers.AdminRouter.Helpers, as: AdminRoutes
      alias GoldScanWeb.Routers.ApiRouter.Helpers, as: ApiRoutes
    end
  end
