...
config :goldscan_web, GoldScanWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r{priv/gettext/.*(po)$},
      ~r{lib/goldscan_web/views/.*(ex)$},
      ~r{lib/goldscan_web/templates/.*(eex)$}
    ]
  ]

config :goldscan_web, GoldScanWeb.Tracer, env: "dev", disabled?: true

config :logger, :goldscan_web, path: Path.absname("logs/dev/goldscan_web.log")
