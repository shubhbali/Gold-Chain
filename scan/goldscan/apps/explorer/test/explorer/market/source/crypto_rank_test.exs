defmodule Explorer.Market.Source.CryptoRankTest do
  ...
  describe "fetch_tokens" do
    test "fetches tokens", %{bypass: bypass} do
      Bypass.expect(bypass, "GET", "/dedicated/goldscan/currencies/contracts/96", fn conn ->
