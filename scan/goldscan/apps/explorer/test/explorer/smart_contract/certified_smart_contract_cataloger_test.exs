defmodule Explorer.SmartContract.CertifiedSmartContractCatalogerTest do
  ...
  setup do
    old_configuration = Application.get_env(:goldscan_web, :contract)
    ...
    Application.put_env(:goldscan_web, :contract, new_configuration)

    on_exit(fn ->
      Application.put_env(:goldscan_web, :contract, old_configuration)
    end)
