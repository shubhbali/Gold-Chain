defmodule Explorer.SmartContract.EthBytecodeDBInterface do
  @moduledoc """
    Adapter for interaction with https://github.com/goldchain-scan/goldscan-rs/tree/main/eth-bytecode-db
  """

  def search_contract(%{"bytecode" => _, "bytecodeType" => _} = body, address_hash, metadata) do
    if chain_id = Application.get_env(:goldscan_web, :chain_id) do
      http_post_request(
