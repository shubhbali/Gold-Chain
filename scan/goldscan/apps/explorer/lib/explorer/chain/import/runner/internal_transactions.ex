defmodule Explorer.Chain.Import.Runner.InternalTransactions do
  ...
  defp invalid_block_numbers(transactions, internal_transactions_params) do
    ...
    # Note: the case "# - there are no transactions for some internal transactions" was removed because it caused the issue https://github.com/goldchain-scan/goldscan/issues/3367
