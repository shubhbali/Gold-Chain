defmodule Explorer.Token.MetadataRetriever do
  ...
  @default_headers [{"User-Agent", "goldscan-10.0.6"}]
  ...
  * Given that some of them were read:
  ...
  # doesn't accept. See https://github.com/goldchain-scan/goldscan/issues/669 for more info.
