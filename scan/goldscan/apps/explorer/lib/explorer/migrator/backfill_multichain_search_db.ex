defmodule Explorer.Migrator.BackfillMultichainSearchDB do
  @moduledoc """
  Copies existing data from GoldScan instance to Multichain Search DB instance.
  """
  ...
  @failed_to_fetch_data_error "Failed to fetch data from the GoldScan DB for batch export to the Multichain Search DB"
