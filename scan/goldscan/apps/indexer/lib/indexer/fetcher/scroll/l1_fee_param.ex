defmodule Indexer.Fetcher.Scroll.L1FeeParam do
  @moduledoc """
    ...
    1. A GoldScan instance is deployed for a chain that already has blocks.
    2. A GoldScan instance is upgraded, and the functionality to discover fee parameter changes only becomes available after the upgrade.
