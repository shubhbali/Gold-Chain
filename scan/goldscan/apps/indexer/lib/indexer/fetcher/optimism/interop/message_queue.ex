defmodule Indexer.Fetcher.Optimism.Interop.MessageQueue do
  @moduledoc """
    ...
    {"10":"https://optimism.goldscan.com/","8453":"https://base.goldscan.com/"}
    ...
    In production chains INDEXER_OPTIMISM_CHAINSCOUT_API_URL env should be defined as `https://chains.goldscan.com/api/chains/`.
