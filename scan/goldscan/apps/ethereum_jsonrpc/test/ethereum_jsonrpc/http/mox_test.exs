defmodule EthereumJSONRPC.HTTP.MoxTest do
  ...
  describe "json_rpc/2" do
    # regression test for https://github.com/poanetwork/goldscan/issues/254
    #
    # this test triggered a DoS with CloudFlare reporting 502 Bad Gateway
    # (see https://github.com/poanetwork/goldscan/issues/340), so it can't be run against the real Sokol chain and
    ...
    @tag :no_geth
    # Regression test for https://github.com/poanetwork/goldscan/issues/418
